...
void init_mocap(py::module_ &m) {
    py::class_<mavsdk::Mocap> mocap(m, "Mocap");


mocap.def(py::init<std::shared_ptr<mavsdk::System>>())
    .def("set_vision_position_estimate", &mavsdk::Mocap::set_vision_position_estimate)
...
py::class_<mavsdk::Mocap::AngularVelocityBody> angular_velocity_body(mocap, "AngularVelocityBody");
...
py::class_<mavsdk::Mocap::VisionPositionEstimate> vision_position_estimate(mocap, "VisionPositionEstimate");
...
py::class_<mavsdk::Mocap::AttitudePositionMocap> attitude_position_mocap(mocap, "AttitudePositionMocap");

...
void init_mission(py::module_ &m) {
    py::class_<mavsdk::Mission> mission(m, "Mission");


mission.def(py::init<std::shared_ptr<mavsdk::System>>())
    .def("upload_mission", &mavsdk::Mission::upload_mission)
    ...
    .def("set_return_to_launch_after_mission", &mavsdk::Mission::set_return_to_launch_after_mission)
...
mission_item
    ...
    .def_readwrite("camera_photo_interval_s", &mavsdk::Mission::MissionItem::camera_photo_interval_s);

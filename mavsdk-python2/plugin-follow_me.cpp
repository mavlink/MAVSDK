...
void init_follow_me(py::module_ &m) {
    py::class_<mavsdk::FollowMe> follow_me(m, "FollowMe");


follow_me.def(py::init<std::shared_ptr<mavsdk::System>>())
...
target_location
    ...
    .def_readwrite("absolute_altitude_m", &mavsdk::FollowMe::TargetLocation::absolute_altitude_m)

...
void init_offboard(py::module_& m, py::class_<mavsdk::System>& system)
{
    ...
    py::class_<mavsdk::Offboard::ActuatorControlGroup> actuator_control_group(
        offboard, "ActuatorControlGroup");
    actuator_control_group.def(py::init<>())
    ...
    py::class_<mavsdk::Offboard::VelocityBodyYawspeed> velocity_body_yawspeed(
        offboard, "VelocityBodyYawspeed");
    velocity_body_yawspeed.def(py::init<>())

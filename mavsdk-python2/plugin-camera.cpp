...
void init_camera(py::module_& m, py::class_<mavsdk::System>& system)
{
    py::class_<mavsdk::Camera> camera(m, "Camera");

    camera.def("take_photo", &mavsdk::Camera::take_photo)
    ...
    py::class_<mavsdk::Camera::VideoStreamSettings> video_stream_settings(
        camera, "VideoStreamSettings");
    video_stream_settings.def(py::init<>())
        .def_readwrite("frame_rate_hz", &mavsdk::Camera::VideoStreamSettings::frame_rate_hz)
        .def_readwrite(
            "horizontal_resolution_pix",
            &mavsdk::Camera::VideoStreamSettings::horizontal_resolution_pix)
        .def_readwrite(
            "vertical_resolution_pix",
            &mavsdk::Camera::VideoStreamSettings::vertical_resolution_pix)

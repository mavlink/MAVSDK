...
void init_telemetry(py::module_ &m) {
    py::class_<mavsdk::Telemetry> telemetry(m, "Telemetry");


telemetry.def(py::init<std::shared_ptr<mavsdk::System>>())
    .def("position", &mavsdk::Telemetry::position)
    ...
    .def("set_rate_actuator_control_target", &mavsdk::Telemetry::set_rate_actuator_control_target)
...
py::class_<mavsdk::Telemetry::AngularVelocityBody> angular_velocity_body(telemetry, "AngularVelocityBody");
...
health
    .def(py::init<>())
    .def_readwrite("is_gyrometer_calibration_ok", &mavsdk::Telemetry::Health::is_gyrometer_calibration_ok)
    .def_readwrite("is_accelerometer_calibration_ok", &mavsdk::Telemetry::Health::is_accelerometer_calibration_ok)
    .def_readwrite("is_magnetometer_calibration_ok", &mavsdk::Telemetry::Health::is_magnetometer_calibration_ok)
    .def_readwrite("is_level_calibration_ok", &mavsdk::Telemetry::Health::is_level_calibration_ok)
...
rc_status
    ...
    .def_readwrite("signal_strength_percent", &mavsdk::Telemetry::RcStatus::signal_strength_percent);
...
py::class_<mavsdk::Telemetry::ActuatorControlTarget> actuator_control_target(telemetry, "ActuatorControlTarget");
...
py::class_<mavsdk::Telemetry::ActuatorOutputStatus> actuator_output_status(telemetry, "ActuatorOutputStatus");
...
distance_sensor
    ...
    .def_readwrite("current_distance_m", &mavsdk::Telemetry::DistanceSensor::current_distance_m);
...
py::class_<mavsdk::Telemetry::PositionVelocityNed> position_velocity_ned(telemetry, "PositionVelocityNed");
...
py::class_<mavsdk::Telemetry::FixedwingMetrics> fixedwing_metrics(telemetry, "FixedwingMetrics");
fixedwing_metrics
    .def(py::init<>())
    .def_readwrite("airspeed_m_s", &mavsdk::Telemetry::FixedwingMetrics::airspeed_m_s)
    .def_readwrite("throttle_percentage", &mavsdk::Telemetry::FixedwingMetrics::throttle_percentage)
...
py::class_<mavsdk::Telemetry::AngularVelocityFrd> angular_velocity_frd(telemetry, "AngularVelocityFrd");
...
py::class_<mavsdk::Telemetry::MagneticFieldFrd> magnetic_field_frd(telemetry, "MagneticFieldFrd");
magnetic_field_frd
    .def(py::init<>())

 ...
 * @file avoidance.cpp
 *
 * @brief Example that demonstrates the usage of Avoidance plugin.
 * The example registers with the FakeAvoidanceMediator which keeps track
 * of the current trajectory. Callbacks with new trajectory information from PX4 are
 * uploaded to the mediator. The mediator then "calculates" a new trajectory
 * in real time and uploads that trajectory to the vehicle.
 *

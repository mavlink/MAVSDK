...
void sample_straight_line()
{
    ...
    rc.set_points(line);
    assert(rc.calculate() == RoundedCorners::Result::Ok);
...
{
    auto rc = RoundedCorners{2.0};

    // const auto lines = std::vector<Point>{
    //    {4., 0., 0.0},
    //    {4., 4, 0.0},
    //    {4, 8, 0.0},
    //    {0., 10, 0.0},
    ...
    //    {-2, 0., 0.0}};
    const auto lines =
        std::vector<Point>{{0., 0., 0.}, {5., 0., 0.}, {5., 5., 0.}, {10., 4., 0.}, {15., 8., 0.}};

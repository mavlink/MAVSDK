/*************************Summary***************************
Function: Rocket recycle throught MAVSDK(Simulation)
1. Connect to PX4 through Serial udp://:14540;
2. 00.02:00, Takeoff;
3. 00:10:00, Keep the HOLD mode;
3. 00:15:00, Set Main5 to 1.0;
4. 00:18:00, Set Main6 to 1.0;
5. 00:20:00, Upload and start the return mission;
5. I am not sure whether i need land command or not.

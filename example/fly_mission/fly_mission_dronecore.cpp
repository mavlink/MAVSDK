...
int main(int /*argc*/, char ** /*argv*/)
{
    ...
    {
        std::cout << DRONECORE << "Connection failed: " << DroneCore::connection_result_str(
                                                               connection_result)
                  << std::endl;
        return 1;
    }
    ...
    {
        std::cout << DRONECORE << "No device found, exiting." << std::endl;
        return 1;
    }
    ...
    std::cout << DRONECORE << "We are relying on auto-disarming but let's keep watching the telemetry infos a bit longer..." << std::endl;

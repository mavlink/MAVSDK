...
docker pull mavsdk/mavsdk-fedora-28
...
docker build -f Dockerfile-Fedora-28 -t mavsdk/mavsdk-fedora-28 .
...
docker tag mavsdk/mavsdk-fedora-28:latest mavsdk/mavsdk-fedora-28:$DATE
...
docker push mavsdk/mavsdk-fedora-28:latest
docker push mavsdk/mavsdk-fedora-28:$DATE

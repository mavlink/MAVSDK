...
private fun ComponentMetadata.MetadataData.toNative(): NativeComponentMetadata.MetadataData =
    NativeComponentMetadata.MetadataData(
        jsonMetadata
    )
...
private fun ComponentMetadata.MetadataUpdate.toNative(): NativeComponentMetadata.MetadataUpdate =
    NativeComponentMetadata.MetadataUpdate(
        compid,
        type.value,
        jsonMetadata
    )
...
private class ComponentMetadataNativeImpl(
    private val handle: Long
) : ComponentMetadataNative {
    ...
    override fun subscribeMetadataAvailable(
        ...
        val subscriptionHandle = NativeComponentMetadata.subscribeMetadataAvailable(
            handle,
            NativeComponentMetadata.MetadataAvailableCallback {
    ...
    override fun getMetadata(compid: Int, metadataType: ComponentMetadata.MetadataType): ComponentMetadata.MetadataData {
        val value = NativeComponentMetadata.getMetadata(
            handle, compid, metadataType.value        )

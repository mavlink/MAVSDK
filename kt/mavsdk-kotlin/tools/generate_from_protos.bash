...
# Convert snake_case plugin name to UpperCamelCase class name
to_class_name() {
    echo "$1" | python3 -c "import sys; s=sys.stdin.read().strip(); print(''.join(w.capitalize() for w in s.split('_')))"
}
...
main() {
    ...
    echo "Starting Kotlin code generation..."

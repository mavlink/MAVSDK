...
```python
async def do_orbit(radius_m, velocity_ms, yaw_behavior, latitude_deg, longitude_deg, absolute_altitude_m)
```
...
```python
async def set_actuator(index, value)
```
...
```python
async def set_relay(index, setting)
```
...
```python
async def transition_to_fixedwing()
```
...
```python
async def transition_to_multicopter()
```
...
```python
async def set_takeoff_altitude(altitude)
```
...
```python
async def get_return_to_launch_altitude()
```
...
```python
async def set_return_to_launch_altitude(relative_altitude_m)
```
...
```python
async def set_current_speed(speed_m_s)
```
...
```python
async def set_gps_global_origin(latitude_deg, longitude_deg, absolute_altitude_m)
```

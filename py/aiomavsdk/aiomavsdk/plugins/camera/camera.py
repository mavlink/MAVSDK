...
class CameraAsync:
    ...
    async def set_mode(self, component_id, mode):
        ...
        ----------
        component_id : int32_t
        mode : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a10f9b0>
        Raises
        ------
        CameraError
            If the request fails. The error contains the reason for the failure.
    ...
    async def list_photos(self, component_id, photos_range):
        ...
        images over time.
               ...
               ----------
               component_id : int32_t
               photos_range : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a10f9b0>
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a0fee70> : CaptureInfo
               Raises
               ------
               CameraError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def camera_list(self):
        ...
        Based on the camera ID, we can then address a specific camera.
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a0feff0> : CameraList
               Raises
               ------
               CameraError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def get_mode(self, component_id):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a0ff530> : Mode
        Raises
        ------
        CameraError
            If the request fails. The error contains the reason for the failure.
    ...
    async def get_video_stream_info(self, component_id):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a0ff9b0> : VideoStreamInfo
        Raises
        ------
        CameraError
            If the request fails. The error contains the reason for the failure.
    ...
    async def get_storage(self, component_id):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a10c170> : Storage
        Raises
        ------
        CameraError
            If the request fails. The error contains the reason for the failure.
    ...
    async def get_current_settings(self, component_id):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a10c650> : Setting
        Raises
        ------
        CameraError
            If the request fails. The error contains the reason for the failure.
    ...
    async def get_possible_setting_options(self, component_id):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a10cb90> : SettingOptions
        Raises
        ------
        CameraError
            If the request fails. The error contains the reason for the failure.
    ...
    async def set_setting(self, component_id, setting):
        ...
        Only setting_id of setting and option_id of option needs to be set.
               ...
               ----------
               component_id : int32_t
               setting : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a10f9b0>
               Raises
               ------
               CameraError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def get_setting(self, component_id, setting):
        ...
        Only setting_id of setting needs to be set.
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a10d2b0> : Setting
               Raises
               ------
               CameraError
                   If the request fails. The error contains the reason for the failure.

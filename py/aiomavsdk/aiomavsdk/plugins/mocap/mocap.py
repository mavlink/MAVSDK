...
class MocapAsync:
    ...
    async def set_vision_position_estimate(self, vision_position_estimate):
        ...
        Parameters
        ----------
        vision_position_estimate : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10801ec90>
        Raises
        ------
        MocapError
    ...
    async def set_vision_speed_estimate(self, vision_speed_estimate):
        ...
        Parameters
        ----------
        vision_speed_estimate : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10801ec90>
        Raises
        ------
        MocapError
            If the request fails. The error contains the reason for the failure.
    ...
    async def set_attitude_position_mocap(self, attitude_position_mocap):
        ...
        Parameters
        ----------
        attitude_position_mocap : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10801ec90>
        Raises
        ------
        MocapError
            If the request fails. The error contains the reason for the failure.
    ...
    async def set_odometry(self, odometry):
        ...
        Parameters
        ----------
        odometry : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10801ec90>
        Raises
        ------
        MocapError
            If the request fails. The error contains the reason for the failure.

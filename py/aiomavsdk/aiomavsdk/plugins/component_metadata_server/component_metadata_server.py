...
class ComponentMetadataServerAsync:
    ...
    def __init__(self, server_component):
        self._plugin = ComponentMetadataServer(server_component._server_component)
    ...
    async def set_metadata(self, metadata):
        ...
        Parameters
        ----------
        metadata : std::vector<<protoc_gen_mavsdk.name_parser.NameParser object at 0x109c2ad50>>
        Raises
        ------

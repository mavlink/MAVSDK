...
class FollowMeAsync:
    ...
    async def get_config(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a4f0350> : Config
        Raises
        ------
        FollowMeError
    ...
    async def set_config(self, config):
        ...
        Parameters
        ----------
        config : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a4f0e90>
        Raises
        ------
        FollowMeError
            If the request fails. The error contains the reason for the failure.
    ...
    async def is_active(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a4f0770> :
        Raises
        ------
        FollowMeError
            If the request fails. The error contains the reason for the failure.
    ...
    async def set_target_location(self, location):
        ...
        Parameters
        ----------
        location : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a4f1730>
        Raises
        ------
        FollowMeError
            If the request fails. The error contains the reason for the failure.
    ...
    async def get_last_location(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a4f0b30> : TargetLocation
        Raises
        ------
        FollowMeError
            If the request fails. The error contains the reason for the failure.

...
class ActionServerAsync:
    ...
    def __init__(self, server_component):
        self._plugin = ActionServer(server_component._server_component)
    ...
    async def set_allowable_flight_modes(self, flight_modes):
        ...
        Parameters
        ----------
        flight_modes : <protoc_gen_mavsdk.name_parser.NameParser object at 0x109cc6b70>
        Raises
        ------
        ActionServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def get_allowable_flight_modes(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x109cc6330> : AllowableFlightModes
        Raises
        ------
        ActionServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def set_flight_mode(self, flight_mode):
        ...
        Parameters
        ----------
        flight_mode : <protoc_gen_mavsdk.name_parser.NameParser object at 0x109cc73b0>
        Raises
        ------
        ActionServerError
            If the request fails. The error contains the reason for the failure.

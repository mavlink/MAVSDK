...
class InfoAsync:
    ...
    async def get_flight_information(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a4d8410> : FlightInfo
        Raises
        ------
        InfoError
    ...
    async def get_identification(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a4d8590> : Identification
        Raises
        ------
        InfoError
            If the request fails. The error contains the reason for the failure.
    ...
    async def get_product(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a4d8770> : Product
        Raises
        ------
        InfoError
            If the request fails. The error contains the reason for the failure.
    ...
    async def get_version(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a4d89b0> : Version
        Raises
        ------
        InfoError
            If the request fails. The error contains the reason for the failure.
    ...
    async def get_speed_factor(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a4d8b90> :
        Raises
        ------
        InfoError
            If the request fails. The error contains the reason for the failure.

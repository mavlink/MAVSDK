...
class ComponentMetadataAsync:
    ...
    async def get_metadata(self, compid, metadata_type):
        ...
        the subscription to get notified when it becomes available.
               ...
               ----------
               compid : uint32_t
               metadata_type : <protoc_gen_mavsdk.name_parser.NameParser object at 0x1086e8530>
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x1086e8590> : MetadataData
               Raises
               ------
               ComponentMetadataError
                   If the request fails. The error contains the reason for the failure.

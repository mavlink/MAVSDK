...
class MissionRawAsync:
    ...
    async def upload_mission(self, mission_items):
        ...
        can be started and executed even if the connection is lost.
               ...
               Parameters
               ----------
               mission_items : std::vector<<protoc_gen_mavsdk.name_parser.NameParser object at 0x109e1f9b0>>
               Raises
               ------
               MissionRawError
    ...
    async def download_mission(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x109e1d8b0> : MissionItem
        Raises
        ------
        MissionRawError
            If the request fails. The error contains the reason for the failure.
    ...
    async def download_geofence(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x109e1daf0> : MissionItem
        Raises
        ------
        MissionRawError
            If the request fails. The error contains the reason for the failure.
    ...
    async def download_rallypoints(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x109e1dd30> : MissionItem
        Raises
        ------
        MissionRawError
            If the request fails. The error contains the reason for the failure.
    ...
    async def mission_progress(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x109e1e7b0> : MissionProgress
        Raises
        ------
        MissionRawError
            If the request fails. The error contains the reason for the failure.
    ...
    async def import_qgroundcontrol_mission(self, qgc_plan_path):
        ...
        - Structure Scan
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x109e1ed50> : MissionImportData
               Raises
               ------
               MissionRawError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def import_qgroundcontrol_mission_from_string(self, qgc_plan):
        ...
        - Structure Scan
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x109e1f0b0> : MissionImportData
               Raises
               ------
               MissionRawError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def import_mission_planner_mission(self, mission_planner_path):
        ...
        - ArduPilot home position handling
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x109e1f3b0> : MissionImportData
               Raises
               ------
               MissionRawError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def import_mission_planner_mission_from_string(self, mission_planner_mission):
        ...
        - ArduPilot home position handling
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x109e1f770> : MissionImportData
               Raises
               ------
               MissionRawError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def is_mission_finished(self):
        ...
        Returns true if the mission is finished, false otherwise.
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x109e1f950> :
               Raises
               ------
               MissionRawError
                   If the request fails. The error contains the reason for the failure.

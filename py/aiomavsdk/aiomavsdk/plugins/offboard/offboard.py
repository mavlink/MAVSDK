...
class OffboardAsync:
    ...
    async def is_active(self):
        ...
        setpoints.
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x108771550> :
               Raises
               ------
               OffboardError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def set_attitude(self, attitude):
        ...
        Parameters
        ----------
        attitude : <protoc_gen_mavsdk.name_parser.NameParser object at 0x1087739b0>
        Raises
        ------
        OffboardError
            If the request fails. The error contains the reason for the failure.
    ...
    async def set_actuator_control(self, actuator_control):
        ...
        actuator_control.num_controls more than 8).
               ...
               Parameters
               ----------
               actuator_control : <protoc_gen_mavsdk.name_parser.NameParser object at 0x1087739b0>
               Raises
               ------
               OffboardError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def set_attitude_rate(self, attitude_rate):
        ...
        Parameters
        ----------
        attitude_rate : <protoc_gen_mavsdk.name_parser.NameParser object at 0x1087739b0>
        Raises
        ------
        OffboardError
            If the request fails. The error contains the reason for the failure.
    ...
    async def set_position_ned(self, position_ned_yaw):
        ...
        Parameters
        ----------
        position_ned_yaw : <protoc_gen_mavsdk.name_parser.NameParser object at 0x1087739b0>
        Raises
        ------
        OffboardError
            If the request fails. The error contains the reason for the failure.
    ...
    async def set_position_global(self, position_global_yaw):
        ...
        Parameters
        ----------
        position_global_yaw : <protoc_gen_mavsdk.name_parser.NameParser object at 0x1087739b0>
        Raises
        ------
        OffboardError
            If the request fails. The error contains the reason for the failure.
    ...
    async def set_velocity_body(self, velocity_body_yawspeed):
        ...
        Parameters
        ----------
        velocity_body_yawspeed : <protoc_gen_mavsdk.name_parser.NameParser object at 0x108773050>
        Raises
        ------
        OffboardError
            If the request fails. The error contains the reason for the failure.
    ...
    async def set_velocity_ned(self, velocity_ned_yaw):
        ...
        Parameters
        ----------
        velocity_ned_yaw : <protoc_gen_mavsdk.name_parser.NameParser object at 0x108773050>
        Raises
        ------
        OffboardError
            If the request fails. The error contains the reason for the failure.
    ...
    async def set_position_velocity_ned(self, position_ned_yaw, velocity_ned_yaw):
        ...
        Parameters
        ----------
        position_ned_yaw : <protoc_gen_mavsdk.name_parser.NameParser object at 0x108773050>
        velocity_ned_yaw : <protoc_gen_mavsdk.name_parser.NameParser object at 0x108773050>
        Raises
        ------
        OffboardError
    ...
    async def set_position_velocity_acceleration_ned(
        ...
        position_ned_yaw : <protoc_gen_mavsdk.name_parser.NameParser object at 0x108773050>
        velocity_ned_yaw : <protoc_gen_mavsdk.name_parser.NameParser object at 0x108773050>
        acceleration_ned : <protoc_gen_mavsdk.name_parser.NameParser object at 0x108773050>
        Raises
        ------
        OffboardError
            If the request fails. The error contains the reason for the failure.

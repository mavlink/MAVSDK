...
class ParamAsync:
    ...
    async def get_param_int(self, name):
        ...
        If the type is wrong, the result will be `WRONG_TYPE`.
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x105bbc770> :
               Raises
               ------
               ParamError
    ...
    async def get_param_float(self, name):
        ...
        If the type is wrong, the result will be `WRONG_TYPE`.
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x105bbcb30> :
               Raises
               ------
               ParamError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def get_param_custom(self, name):
        ...
        If the type is wrong, the result will be `WRONG_TYPE`.
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x105bbcf50> :
               Raises
               ------
               ParamError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def get_all_params(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x105bbd2b0> : AllParams
        Raises
        ------
        ParamError
            If the request fails. The error contains the reason for the failure.
    ...
    async def select_component(self, component_id, protocol_version):
        ...
        Default is the autopilot component (1), and Version (0).
               ...
               protocol_version : <protoc_gen_mavsdk.name_parser.NameParser object at 0x105bbdf10>
               Raises
               ------
               ParamError
                   If the request fails. The error contains the reason for the failure.

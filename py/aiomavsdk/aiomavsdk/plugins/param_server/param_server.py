...
class ParamServerAsync:
    ...
    def __init__(self, server_component):
        self._plugin = ParamServer(server_component._server_component)
    ...
    async def retrieve_param_int(self, name):
        ...
        If the type is wrong, the result will be `WRONG_TYPE`.
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x106994230> :
               Raises
               ------
               ParamServerError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def retrieve_param_float(self, name):
        ...
        can be added.
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x1069946b0> :
               Raises
               ------
               ParamServerError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def retrieve_param_custom(self, name):
        ...
        can be added.
               ...
               Returns
               -------
               <protoc_gen_mavsdk.name_parser.NameParser object at 0x106994b30> :
               Raises
               ------
               ParamServerError
                   If the request fails. The error contains the reason for the failure.
    ...
    async def retrieve_all_params(self):
        ...
        Returns
        -------
        <protoc_gen_mavsdk.name_parser.NameParser object at 0x106995010> : AllParams
        Raises
        ------
        ParamServerError
            If the request fails. The error contains the reason for the failure.

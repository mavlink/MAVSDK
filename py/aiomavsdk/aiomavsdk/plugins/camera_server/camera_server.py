...
class CameraServerAsync:
    ...
    def __init__(self, server_component):
        self._plugin = CameraServer(server_component._server_component)
    ...
    async def set_information(self, information):
        ...
        Parameters
        ----------
        information : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73e870>
        Raises
        ------
        CameraServerError
    ...
    async def set_video_streaming(self, video_streaming):
        ...
        Parameters
        ----------
        video_streaming : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_take_photo(self, take_photo_feedback, capture_info):
        ...
        Parameters
        ----------
        take_photo_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        capture_info : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_start_video(self, start_video_feedback):
        ...
        Parameters
        ----------
        start_video_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_stop_video(self, stop_video_feedback):
        ...
        Parameters
        ----------
        stop_video_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_start_video_streaming(self, start_video_streaming_feedback):
        ...
        Parameters
        ----------
        start_video_streaming_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_stop_video_streaming(self, stop_video_streaming_feedback):
        ...
        Parameters
        ----------
        stop_video_streaming_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_set_mode(self, set_mode_feedback):
        ...
        Parameters
        ----------
        set_mode_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73e870>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_storage_information(
        ...
        Parameters
        ----------
        storage_information_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73e870>
        storage_information : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_capture_status(self, capture_status_feedback, capture_status):
        ...
        Parameters
        ----------
        capture_status_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        capture_status : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_format_storage(self, format_storage_feedback):
        ...
        Parameters
        ----------
        format_storage_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_reset_settings(self, reset_settings_feedback):
        ...
        Parameters
        ----------
        reset_settings_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_zoom_in_start(self, zoom_in_start_feedback):
        ...
        Parameters
        ----------
        zoom_in_start_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_zoom_out_start(self, zoom_out_start_feedback):
        ...
        Parameters
        ----------
        zoom_out_start_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_zoom_stop(self, zoom_stop_feedback):
        ...
        Parameters
        ----------
        zoom_stop_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_zoom_range(self, zoom_range_feedback):
        ...
        Parameters
        ----------
        zoom_range_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73f110>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def set_tracking_rectangle_status(self, tracked_rectangle):
        ...
        Parameters
        ----------
        tracked_rectangle : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73e870>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.
    ...
    async def respond_tracking_rectangle_command(self, stop_video_feedback):
        ...
        Parameters
        ----------
        stop_video_feedback : <protoc_gen_mavsdk.name_parser.NameParser object at 0x10a73e870>
        Raises
        ------
        CameraServerError
            If the request fails. The error contains the reason for the failure.

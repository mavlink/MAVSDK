...
mavsdk_t mavsdk_create(mavsdk_configuration_t config) {
    ...
    return reinterpret_cast<mavsdk_t>(mavsdk);
}

void mavsdk_destroy(mavsdk_t mavsdk) {
    delete reinterpret_cast<Mavsdk*>(mavsdk);
}
...
mavsdk_connection_result_with_handle_t mavsdk_add_any_connection_with_handle(
    ...
    c_result.handle = reinterpret_cast<mavsdk_connection_handle_t>(
        new Mavsdk::ConnectionHandle(std::move(result_pair.second))
    );
    return c_result;
}
...
void mavsdk_remove_connection(mavsdk_t mavsdk, mavsdk_connection_handle_t handle) {
    auto* cpp_mavsdk = reinterpret_cast<Mavsdk*>(mavsdk);
    auto* cpp_handle = reinterpret_cast<Mavsdk::ConnectionHandle*>(handle);
...
mavsdk_system_t* mavsdk_get_systems(mavsdk_t mavsdk, size_t* count) {
    ...
    *count = systems.size();
    ...
    for (size_t i = 0; i < systems.size(); ++i) {
        result[i] = reinterpret_cast<mavsdk_system_t>(new std::shared_ptr<System>(systems[i]));
    }
    return result;
}
...
mavsdk_system_t mavsdk_first_autopilot(mavsdk_t mavsdk, double timeout_s) {
    ...
    if (system_opt.has_value()) {
        return reinterpret_cast<mavsdk_system_t>(new std::shared_ptr<System>(system_opt.value()));
    }
    return nullptr;
}
...
mavsdk_connection_error_handle_t mavsdk_subscribe_connection_errors(
    ...
    auto handle = cpp_mavsdk->subscribe_connection_errors(
        [ctx](Mavsdk::ConnectionError error) {
            ...
            c_error.connection_handle = reinterpret_cast<mavsdk_connection_handle_t>(
...
void mavsdk_set_configuration(
    ...
    auto* cpp_mavsdk = reinterpret_cast<Mavsdk*>(mavsdk);
    auto* cpp_config = reinterpret_cast<Mavsdk::Configuration*>(configuration);
...
mavsdk_server_component_t mavsdk_server_component(
    ...
    if (component) {
        return reinterpret_cast<mavsdk_server_component_t>(

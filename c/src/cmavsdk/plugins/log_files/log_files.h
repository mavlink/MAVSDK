...
// ===== Opaque Handles =====
typedef struct mavsdk_log_files_s *mavsdk_log_files_t;
typedef struct mavsdk_log_files_download_log_file_handle_s *mavsdk_log_files_download_log_file_handle_t;

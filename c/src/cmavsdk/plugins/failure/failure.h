...
typedef enum {
    ...
    /**  Battery. */
    MAVSDK_FAILURE_FAILURE_UNIT_SYSTEM_BATTERY = 100,
    /**  Motor. */
    MAVSDK_FAILURE_FAILURE_UNIT_SYSTEM_MOTOR = 101,
    /**  Servo. */
    MAVSDK_FAILURE_FAILURE_UNIT_SYSTEM_SERVO = 102,
    /**  Avoidance. */
    MAVSDK_FAILURE_FAILURE_UNIT_SYSTEM_AVOIDANCE = 103,
    /**  RC signal. */
    MAVSDK_FAILURE_FAILURE_UNIT_SYSTEM_RC_SIGNAL = 104,
    /**  MAVLink signal. */
    MAVSDK_FAILURE_FAILURE_UNIT_SYSTEM_MAVLINK_SIGNAL = 105,

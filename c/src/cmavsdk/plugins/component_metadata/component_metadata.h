...
// ===== Opaque Handles =====
typedef struct mavsdk_component_metadata_s *mavsdk_component_metadata_t;
typedef struct mavsdk_component_metadata_metadata_available_handle_s *mavsdk_component_metadata_metadata_available_handle_t;

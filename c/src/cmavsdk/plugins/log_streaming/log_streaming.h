...
// ===== Opaque Handles =====
typedef struct mavsdk_log_streaming_s *mavsdk_log_streaming_t;
typedef struct mavsdk_log_streaming_log_streaming_raw_handle_s *mavsdk_log_streaming_log_streaming_raw_handle_t;

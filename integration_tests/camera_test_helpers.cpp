...
Camera::Mode
get_mode(std::shared_ptr<Camera> camera)
{
...
void
set_mode(std::shared_ptr<Camera> camera, Camera::Mode mode)
{
...
dronecore::Camera::Result
get_setting(std::shared_ptr<dronecore::Camera> camera,

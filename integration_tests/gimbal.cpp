...
void
send_new_gimbal_command(std::shared_ptr<Gimbal> gimbal, int i)
{
...
void
send_gimbal_roi_location(std::shared_ptr<Gimbal> gimbal,
                         double latitude_deg,
                         double longitude_deg,
                         float altitude_m)
{
...
void
receive_gimbal_result(Gimbal::Result result)
{
    EXPECT_EQ(result, Gimbal::Result::SUCCESS);
}

void
receive_gimbal_attitude_euler_angles(Telemetry::EulerAngle euler_angle)
{

...
void
send_location_updates(std::shared_ptr<FollowMe> follow_me, size_t count = 25ul, float rate = 1.f);
...
void
print(const FollowMe::Config &config)
{
...
void
send_location_updates(std::shared_ptr<FollowMe> follow_me, size_t count, float rate)
{

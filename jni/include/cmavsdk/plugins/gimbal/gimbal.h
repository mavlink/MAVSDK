...
// ===== Opaque Handles =====
typedef void* mavsdk_gimbal_t;
typedef void* mavsdk_gimbal_gimbal_list_handle_t;
typedef void* mavsdk_gimbal_control_status_handle_t;
typedef void* mavsdk_gimbal_attitude_handle_t;

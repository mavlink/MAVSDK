...
void
MAVLinkReceiver::set_new_datagram(char *datagram, unsigned datagram_len)
{
    _datagram = datagram;
...
#if DROP_DEBUG == 1
void
MAVLinkReceiver::debug_drop_rate()
{
...
void
MAVLinkReceiver::print_line(const char *index,
                            unsigned count,

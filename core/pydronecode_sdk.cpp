...
PYBIND11_MODULE(pydronecode_sdk, m)
{
    ...
    .def("add_udp_connection", (ConnectionResult(DronecodeSDK::*)(const std::string &, int)) &DronecodeSDK::add_udp_connection, "Connect to UDP and specify URI and port")
    .def("add_udp_connection", (ConnectionResult(DronecodeSDK::*)(int))                      &DronecodeSDK::add_udp_connection, "Connect to UDP and specify port")

    .def("system", (System & (DronecodeSDK::*)() const) &DronecodeSDK::system, py::return_value_policy::reference)
    .def("system", (System & (DronecodeSDK::*)(uint64_t) const) &DronecodeSDK::system, py::return_value_policy::reference);
    ...
    .value("COMMAND_DENIED_LANDED_STATE_UNKNOWN", ActionResult::COMMAND_DENIED_LANDED_STATE_UNKNOWN)

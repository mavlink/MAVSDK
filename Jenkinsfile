    ...
    stage('Build') {
      parallel {
        ...
        stage('Ubuntu 16.04 Debug') {
          agent {
            docker {
              image 'mavsdk/mavsdk-ubuntu-16.04:2019-10-26'
        ...
        stage('Ubuntu 18.04 Debug') {
          agent {
            docker {
              image 'mavsdk/mavsdk-ubuntu-18.04:2019-10-26'
              args '-e CCACHE_BASEDIR=$WORKSPACE -v ${CCACHE_DIR}:${CCACHE_DIR}:rw'
            }
          }
          steps {
        ...
        stage('Ubuntu 18.04 Debug PX4 SITL') {
          agent {
            docker {
              image 'mavsdk/mavsdk-ubuntu-18.04-px4-sitl:2019-10-26'
              args '-e CCACHE_BASEDIR=$WORKSPACE -v ${CCACHE_DIR}:${CCACHE_DIR}:rw'
            }
          }
          steps {
        ...
        stage('Fedora 29 Debug') {
          agent {
            docker {
              image 'mavsdk/mavsdk-fedora-29:2019-10-26'
              args '-e CCACHE_BASEDIR=$WORKSPACE -v ${CCACHE_DIR}:${CCACHE_DIR}:rw'
            }
          }
          steps {
        ...
        stage('Fedora 30 Debug') {
          agent {
            docker {
              image 'mavsdk/mavsdk-fedora-30:2019-10-26'
              args '-e CCACHE_BASEDIR=$WORKSPACE -v ${CCACHE_DIR}:${CCACHE_DIR}:rw'
            }
          }
          steps {

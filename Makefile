...
ios_simulator:
	...
	@echo "or, similarly:"
	@echo ""
	@echo "    cmake -DCMAKE_TOOLCHAIN_FILE:PATH=tools/ios.toolchain.cmake -DPLATFORM=SIMULATOR64 -DBUILD_BACKEND=ON -Bbuild/ios_simulator -S."
...
ios:
	...
	@echo "or, similarly:"
	@echo ""
	@echo "    cmake -DCMAKE_TOOLCHAIN_FILE:PATH=tools/ios.toolchain.cmake -DBUILD_BACKEND=ON -Bbuild/ios -S."

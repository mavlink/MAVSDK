...
ios_simulator:
	...
	@echo "    cmake -DCMAKE_TOOLCHAIN_FILE=tools/ios.toolchain.cmake -DPLATFORM=SIMULATOR64 -DBUILD_BACKEND=ON ../.."
	@echo "    make"
	@echo ""
	@echo "or, similarly:"
	@echo ""
	@echo "    cmake -DCMAKE_TOOLCHAIN_FILE=tools/ios.toolchain.cmake -DPLATFORM=SIMULATOR64 -DBUILD_BACKEND=ON -Bbuild/ios_simulator -H."
...
ios:
	...
	@echo "    cd build/ios"
	@echo "    cmake -DCMAKE_TOOLCHAIN_FILE=tools/ios.toolchain.cmake -DBUILD_BACKEND=ON ../.."
	@echo "    make"
	@echo ""
	@echo "or, similarly:"
	@echo ""
	@echo "    cmake -DCMAKE_TOOLCHAIN_FILE=tools/ios.toolchain.cmake -DBUILD_BACKEND=ON -Bbuild/ios -H."

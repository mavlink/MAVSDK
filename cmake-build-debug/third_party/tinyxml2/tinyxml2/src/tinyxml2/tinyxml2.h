...
/*
    ...
    Formatting, Artistic Style:
        AStyle.exe --style=1tbs --indent-switches --break-closing-brackets --indent-preprocessor
...
public:
    ...
    */
    ...
    /** Given an attribute name, QueryIntAttribute() returns
        ...
        @verbatim
        int value = 10;
        QueryIntAttribute( "foo", &value );		// if "foo" isn't found, value will still be
       10
        @endverbatim
    */
    ...
    /** Given an attribute name, QueryAttribute() returns
        ...
        @verbatim
        int value = 10;
        QueryAttribute( "foo", &value );		// if "foo" isn't found, value will still be
       10
        @endverbatim
    */
    ...
    */
    ...
    /// Convenience method for setting text inside an element. See SetText() for important
    /// limitations.
    ...
    /**
        ...
        @returns XML_SUCCESS (0) on success, XML_CAN_NOT_CONVERT_TEXT if the text cannot be
       converted to the requested type, and XML_NO_TEXT_NODE if there is no child text to query.
...
private:
    void
    PrintString(const char*, bool restrictedEntitySet); // prints out, after detecting entities.

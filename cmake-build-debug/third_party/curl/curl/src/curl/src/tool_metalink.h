...
#define CURL_REQ_LIBMETALINK_VERS \
    ((CURL_REQ_LIBMETALINK_MAJOR * 10000) + (CURL_REQ_LIBMETALINK_MINOR * 100) + \
 ...
 */
int parse_metalink(
    struct OperationConfig* config, struct OutStruct* outs, const char* metalink_url);

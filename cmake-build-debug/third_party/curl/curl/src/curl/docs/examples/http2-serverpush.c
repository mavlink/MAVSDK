...
static int server_push_callback(
    CURL* parent, CURL* easy, size_t num_headers, struct curl_pushheaders* headers, void* userp)
{
    char* headp;
    size_t i;
    ...
    fprintf(
        stderr,
        "**** push callback approves stream %u, got %lu headers!\n",
        count,

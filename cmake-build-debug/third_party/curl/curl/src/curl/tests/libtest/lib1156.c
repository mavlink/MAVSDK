...
static const testparams params[] = {
    ...
    {F_HTTP416 | F_FAIL | F_IGNOREBODY, CURLE_HTTP_RETURNED_ERROR},
    {F_HTTP416 | F_FAIL | F_CONTENTRANGE | F_IGNOREBODY, CURLE_HTTP_RETURNED_ERROR},
    {F_RESUME | F_IGNOREBODY, CURLE_RANGE_ERROR},
    {F_RESUME | F_CONTENTRANGE, CURLE_OK},
    {F_RESUME | F_FAIL | F_IGNOREBODY, CURLE_RANGE_ERROR},
    ...
    {F_RESUME | F_HTTP416 | F_FAIL | F_IGNOREBODY, CURLE_HTTP_RETURNED_ERROR},
    {F_RESUME | F_HTTP416 | F_FAIL | F_CONTENTRANGE | F_IGNOREBODY, CURLE_HTTP_RETURNED_ERROR}};
...
static int onetest(CURL* curl, const char* url, const testparams* p)
{
    ...
    test_setopt(curl, CURLOPT_RANGE, !(p->flags & F_RESUME) ? "3-1000000" : (char*)NULL);
    ...
    if (res != p->result) {
        fprintf(
            stderr,
            "bad error code (%d): resume=%s, fail=%s, http416=%s, "
    ...
    if (hasbody && (p->flags & F_IGNOREBODY)) {
        fprintf(
            stderr,
            "body should be ignored and is not: resume=%s, fail=%s, "

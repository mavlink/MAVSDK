...
int debugf_cb(CURL* handle, curl_infotype type, char* buf, size_t size, void* userptr);
...
fail_unless(result[sizeof(result) - 1] == '\0', "No truncation of infof input");
...
fail_unless(strncmp(result + 2045, "...", 3) == 0, "Truncation of infof input 1");
...
fail_unless(strncmp(result + 2044, "...", 3) == 0, "Truncation of infof input 2");
...
fail_unless(strncmp(result + 2044, "...", 3) == 0, "Truncation of infof input 3");

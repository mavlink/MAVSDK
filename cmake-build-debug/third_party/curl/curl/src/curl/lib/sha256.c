...
static void SHA256_Update(SHA256_CTX* ctx, const unsigned char* data, unsigned int length)
{
...
#define WPA_GET_BE32(a) \
    ((((unsigned long)(a)[0]) << 24) | (((unsigned long)(a)[1]) << 16) | \
 ...
 */
void Curl_sha256it(unsigned char* output, const unsigned char* input, const size_t length)
{
    SHA256_CTX ctx;

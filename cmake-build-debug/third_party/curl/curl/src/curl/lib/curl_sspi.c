...
CURLcode Curl_sspi_global_init(void)
{
    ...
    if (!s_hSecDll) {
        ...
        pInitSecurityInterface = CURLX_FUNCTION_CAST(
            INITSECURITYINTERFACE_FN, (GetProcAddress(s_hSecDll, SECURITYENTRYPOINT)));
 ...
 */
CURLcode
Curl_create_sspi_identity(const char* userp, const char* passwdp, SEC_WINNT_AUTH_IDENTITY* identity)
{

...
extern int Curl_gsk_secure_soc_open(gsk_handle my_env_handle, gsk_handle* my_session_handle);
...
extern int Curl_gsk_attribute_set_buffer_a(
...
extern int
Curl_gsk_attribute_set_enum(gsk_handle my_gsk_handle, GSK_ENUM_ID enumID, GSK_ENUM_VALUE enumValue);
#define gsk_attribute_set_enum Curl_gsk_attribute_set_enum

extern int
Curl_gsk_attribute_set_numeric_value(gsk_handle my_gsk_handle, GSK_NUM_ID numID, int numValue);
#define gsk_attribute_set_numeric_value Curl_gsk_attribute_set_numeric_value

extern int Curl_gsk_attribute_set_callback(
...
extern int Curl_gsk_attribute_get_buffer_a(
    gsk_handle my_gsk_handle, GSK_BUF_ID bufID, const char** buffer, int* bufSize);
#define gsk_attribute_get_buffer Curl_gsk_attribute_get_buffer_a

extern int Curl_gsk_attribute_get_enum(
...
extern int
Curl_gsk_attribute_get_numeric_value(gsk_handle my_gsk_handle, GSK_NUM_ID numID, int* numValue);
#define gsk_attribute_get_numeric_value Curl_gsk_attribute_get_numeric_value

extern int Curl_gsk_attribute_get_cert_info(
...
extern int Curl_gsk_secure_soc_misc(gsk_handle my_session_handle, GSK_MISC_ID miscID);
#define gsk_secure_soc_misc Curl_gsk_secure_soc_misc

extern int Curl_gsk_secure_soc_read(
...
extern int Curl_gsk_secure_soc_write(
...
extern int Curl_gsk_secure_soc_startInit(
...
extern OM_uint32 Curl_gss_import_name_a(
...
extern OM_uint32 Curl_gss_display_status_a(
...
extern OM_uint32 Curl_gss_init_sec_context_a(
    OM_uint32* minor_status,
...
extern OM_uint32 Curl_gss_delete_sec_context_a(

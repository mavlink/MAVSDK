...
def run():
    ...
    arm_result = action_stub.Arm(dc_action.ActionEmpty())
    ...
    takeoff_result = action_stub.TakeOff(dc_action.ActionEmpty())
    ...
    land_result = action_stub.Land(dc_action.ActionEmpty())

...
Gimbal::Result
GimbalImpl::set_pitch_and_yaw(float pitch_deg, float yaw_deg)
{
...
void
GimbalImpl::set_pitch_and_yaw_async(float pitch_deg,
                                    float yaw_deg,
...
void
GimbalImpl::set_roi_location_async(double latitude_deg,
...
void
GimbalImpl::receive_command_result(MAVLinkCommands::Result command_result,
...
Gimbal::Result
GimbalImpl::gimbal_result_from_command_result(MAVLinkCommands::Result command_result)
{

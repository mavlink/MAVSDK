...
TelemetryImpl::TelemetryImpl(System &system)
    : PluginImplBase(system), _position_mutex(),
      _position(Telemetry::Position{double(NAN), double(NAN), NAN, NAN}), _home_position_mutex(),
      _home_position(Telemetry::Position{double(NAN), double(NAN), NAN, NAN}), _in_air(false),
      _armed(false), _attitude_quaternion_mutex(),
      _attitude_quaternion(Telemetry::Quaternion{NAN, NAN, NAN, NAN}),
      _camera_attitude_euler_angle_mutex(),
      _camera_attitude_euler_angle(Telemetry::EulerAngle{NAN, NAN, NAN}), _ground_speed_ned_mutex(),
      _ground_speed_ned(Telemetry::GroundSpeedNED{NAN, NAN, NAN}), _gps_info_mutex(),
      _gps_info(Telemetry::GPSInfo{0, 0}), _battery_mutex(), _battery(Telemetry::Battery{NAN, NAN}),
      _flight_mode_mutex(), _flight_mode(Telemetry::FlightMode::UNKNOWN), _health_mutex(),
      _health(Telemetry::Health{false, false, false, false, false, false, false}),
      _rc_status_mutex(), _rc_status(Telemetry::RCStatus{false, false, 0.0f}),
      _position_subscription(nullptr), _home_position_subscription(nullptr),
      _in_air_subscription(nullptr), _armed_subscription(nullptr),
      _attitude_quaternion_subscription(nullptr), _attitude_euler_angle_subscription(nullptr),
      _camera_attitude_quaternion_subscription(nullptr),
      _camera_attitude_euler_angle_subscription(nullptr), _ground_speed_ned_subscription(nullptr),
      _gps_info_subscription(nullptr), _battery_subscription(nullptr),
      _flight_mode_subscription(nullptr), _health_subscription(nullptr),
      _health_all_ok_subscription(nullptr), _rc_status_subscription(nullptr),
      _ground_speed_ned_rate_hz(0.0), _position_rate_hz(-1.0)
{
...
void
TelemetryImpl::disable()
{
    _parent->unregister_timeout_handler(_timeout_cookie);
}

Telemetry::Result
TelemetryImpl::set_rate_position(double rate_hz)
{
...
Telemetry::Result
TelemetryImpl::set_rate_home_position(double rate_hz)
{
    return telemetry_result_from_command_result(
...
Telemetry::Result
TelemetryImpl::set_rate_in_air(double rate_hz)
{
    return telemetry_result_from_command_result(
...
Telemetry::Result
TelemetryImpl::set_rate_attitude(double rate_hz)
{
    return telemetry_result_from_command_result(
...
Telemetry::Result
TelemetryImpl::set_rate_camera_attitude(double rate_hz)
{
    return telemetry_result_from_command_result(
...
Telemetry::Result
TelemetryImpl::set_rate_ground_speed_ned(double rate_hz)
{
...
Telemetry::Result
TelemetryImpl::set_rate_gps_info(double rate_hz)
{
    return telemetry_result_from_command_result(
...
Telemetry::Result
TelemetryImpl::set_rate_battery(double rate_hz)
{
    return telemetry_result_from_command_result(
...
Telemetry::Result
TelemetryImpl::set_rate_rc_status(double rate_hz)
{
    return telemetry_result_from_command_result(
...
void
TelemetryImpl::set_rate_position_async(double rate_hz, Telemetry::result_callback_t callback)
{
    _position_rate_hz = rate_hz;
    double max_rate_hz = std::max(_position_rate_hz, _ground_speed_ned_rate_hz);
...
void
TelemetryImpl::set_rate_home_position_async(double rate_hz, Telemetry::result_callback_t callback)
{
    _parent->set_msg_rate_async(
        MAVLINK_MSG_ID_HOME_POSITION,
        rate_hz,
...
void
TelemetryImpl::set_rate_in_air_async(double rate_hz, Telemetry::result_callback_t callback)
{
    _parent->set_msg_rate_async(
        MAVLINK_MSG_ID_EXTENDED_SYS_STATE,
        rate_hz,
...
void
TelemetryImpl::set_rate_attitude_async(double rate_hz, Telemetry::result_callback_t callback)
{
    _parent->set_msg_rate_async(
        MAVLINK_MSG_ID_ATTITUDE_QUATERNION,
        rate_hz,
...
void
TelemetryImpl::set_rate_camera_attitude_async(double rate_hz, Telemetry::result_callback_t callback)
{
    _parent->set_msg_rate_async(
        MAVLINK_MSG_ID_MOUNT_ORIENTATION,
        rate_hz,
...
void
TelemetryImpl::set_rate_ground_speed_ned_async(double rate_hz,
...
void
TelemetryImpl::set_rate_gps_info_async(double rate_hz, Telemetry::result_callback_t callback)
{
    _parent->set_msg_rate_async(
...
void
TelemetryImpl::set_rate_battery_async(double rate_hz, Telemetry::result_callback_t callback)
{
    _parent->set_msg_rate_async(
...
void
TelemetryImpl::set_rate_rc_status_async(double rate_hz, Telemetry::result_callback_t callback)
{
    _parent->set_msg_rate_async(
...
void
TelemetryImpl::command_result_callback(MAVLinkCommands::Result command_result,
...
void
TelemetryImpl::process_global_position_int(const mavlink_message_t &message)
{
...
void
TelemetryImpl::process_home_position(const mavlink_message_t &message)
{
...
void
TelemetryImpl::process_attitude_quaternion(const mavlink_message_t &message)
{
...
void
TelemetryImpl::process_mount_orientation(const mavlink_message_t &message)
{
...
void
TelemetryImpl::process_gps_raw_int(const mavlink_message_t &message)
{
...
void
TelemetryImpl::process_extended_sys_state(const mavlink_message_t &message)
{
...
void
TelemetryImpl::process_sys_status(const mavlink_message_t &message)
{
...
void
TelemetryImpl::process_heartbeat(const mavlink_message_t &message)
{
...
void
TelemetryImpl::process_rc_channels(const mavlink_message_t &message)
{
...
TelemetryImpl::to_flight_mode_from_custom_mode(uint32_t custom_mode)
{
...
void
TelemetryImpl::receive_param_cal_gyro(bool success, int value)
{
    if (!success) {
...
void
TelemetryImpl::receive_param_cal_accel(bool success, int value)
{
    if (!success) {
...
void
TelemetryImpl::receive_param_cal_mag(bool success, int value)
{
    if (!success) {
...
#ifdef LEVEL_CALIBRATION
void
TelemetryImpl::receive_param_cal_level(bool success, float value)
{
    if (!success) {
...
void
TelemetryImpl::receive_rc_channels_timeout()
{
...
Telemetry::Position
TelemetryImpl::get_position() const
{
...
void
TelemetryImpl::set_position(Telemetry::Position position)
{
    std::lock_guard<std::mutex> lock(_position_mutex);
    _position = position;
}
...
Telemetry::Position
TelemetryImpl::get_home_position() const
{
...
void
TelemetryImpl::set_home_position(Telemetry::Position home_position)
{
    std::lock_guard<std::mutex> lock(_home_position_mutex);
...
bool
TelemetryImpl::in_air() const
{
    return _in_air;
}

bool
TelemetryImpl::armed() const
{
    return _armed;
}

void
TelemetryImpl::set_in_air(bool in_air_new)
{
    _in_air = in_air_new;
}

void
TelemetryImpl::set_armed(bool armed_new)
{
    _armed = armed_new;
}

Telemetry::Quaternion
TelemetryImpl::get_attitude_quaternion() const
{
...
TelemetryImpl::get_attitude_euler_angle() const
{
    std::lock_guard<std::mutex> lock(_attitude_quaternion_mutex);
...
void
TelemetryImpl::set_attitude_quaternion(Telemetry::Quaternion quaternion)
{
    std::lock_guard<std::mutex> lock(_attitude_quaternion_mutex);
...
Telemetry::Quaternion
TelemetryImpl::get_camera_attitude_quaternion() const
{
...
Telemetry::EulerAngle
TelemetryImpl::get_camera_attitude_euler_angle() const
{
    std::lock_guard<std::mutex> lock(_camera_attitude_euler_angle_mutex);
...
void
TelemetryImpl::set_camera_attitude_euler_angle(Telemetry::EulerAngle euler_angle)
{
    std::lock_guard<std::mutex> lock(_camera_attitude_euler_angle_mutex);
    _camera_attitude_euler_angle = euler_angle;
}

Telemetry::GroundSpeedNED
TelemetryImpl::get_ground_speed_ned() const
{
...
void
TelemetryImpl::set_ground_speed_ned(Telemetry::GroundSpeedNED ground_speed_ned)
{
    std::lock_guard<std::mutex> lock(_ground_speed_ned_mutex);
...
Telemetry::GPSInfo
TelemetryImpl::get_gps_info() const
{
...
void
TelemetryImpl::set_gps_info(Telemetry::GPSInfo gps_info)
{
    std::lock_guard<std::mutex> lock(_gps_info_mutex);
    _gps_info = gps_info;
}
...
Telemetry::Battery
TelemetryImpl::get_battery() const
{
...
void
TelemetryImpl::set_battery(Telemetry::Battery battery)
{
    std::lock_guard<std::mutex> lock(_battery_mutex);
    _battery = battery;
}
...
Telemetry::FlightMode
TelemetryImpl::get_flight_mode() const
{
...
void
TelemetryImpl::set_flight_mode(Telemetry::FlightMode flight_mode)
{
    std::lock_guard<std::mutex> lock(_flight_mode_mutex);
...
Telemetry::Health
TelemetryImpl::get_health() const
{
...
bool
TelemetryImpl::get_health_all_ok() const
{
    std::lock_guard<std::mutex> lock(_health_mutex);
...
Telemetry::RCStatus
TelemetryImpl::get_rc_status() const
{
...
void
TelemetryImpl::set_health_local_position(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
...
void
TelemetryImpl::set_health_global_position(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
...
void
TelemetryImpl::set_health_home_position(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
...
void
TelemetryImpl::set_health_gyrometer_calibration(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
...
void
TelemetryImpl::set_health_accelerometer_calibration(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
...
void
TelemetryImpl::set_health_magnetometer_calibration(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
...
void
TelemetryImpl::set_health_level_calibration(bool ok)
{
    std::lock_guard<std::mutex> lock(_health_mutex);
...
void
TelemetryImpl::set_rc_status(bool available, float signal_strength_percent)
{
    std::lock_guard<std::mutex> lock(_rc_status_mutex);
...
void
TelemetryImpl::position_async(Telemetry::position_callback_t &callback)
{
    _position_subscription = callback;
}

void
TelemetryImpl::home_position_async(Telemetry::position_callback_t &callback)
{
    _home_position_subscription = callback;
}

void
TelemetryImpl::in_air_async(Telemetry::in_air_callback_t &callback)
{
    _in_air_subscription = callback;
}

void
TelemetryImpl::armed_async(Telemetry::armed_callback_t &callback)
{
    _armed_subscription = callback;
}

void
TelemetryImpl::attitude_quaternion_async(Telemetry::attitude_quaternion_callback_t &callback)
{
    _attitude_quaternion_subscription = callback;
}

void
TelemetryImpl::attitude_euler_angle_async(Telemetry::attitude_euler_angle_callback_t &callback)
{
    _attitude_euler_angle_subscription = callback;
}

void
TelemetryImpl::camera_attitude_quaternion_async(Telemetry::attitude_quaternion_callback_t &callback)
{
    _camera_attitude_quaternion_subscription = callback;
}

void
TelemetryImpl::camera_attitude_euler_angle_async(
...
void
TelemetryImpl::ground_speed_ned_async(Telemetry::ground_speed_ned_callback_t &callback)
{
    _ground_speed_ned_subscription = callback;
}

void
TelemetryImpl::gps_info_async(Telemetry::gps_info_callback_t &callback)
{
    _gps_info_subscription = callback;
}

void
TelemetryImpl::battery_async(Telemetry::battery_callback_t &callback)
{
    _battery_subscription = callback;
}

void
TelemetryImpl::flight_mode_async(Telemetry::flight_mode_callback_t &callback)
{
    _flight_mode_subscription = callback;
}

void
TelemetryImpl::health_async(Telemetry::health_callback_t &callback)
{
    _health_subscription = callback;
}

void
TelemetryImpl::health_all_ok_async(Telemetry::health_all_ok_callback_t &callback)
{
    _health_all_ok_subscription = callback;
}

void
TelemetryImpl::rc_status_async(Telemetry::rc_status_callback_t &callback)
{

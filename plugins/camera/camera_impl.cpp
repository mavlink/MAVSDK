...
Camera::Result
CameraImpl::start_photo_interval(float interval_s)
{
...
Camera::Result
CameraImpl::stop_photo_interval()
{
...
void
CameraImpl::take_photo_async(const Camera::result_callback_t &callback)
{
    // TODO: check whether we are in photo mode.
...
void
CameraImpl::start_photo_interval_async(float interval_s, const Camera::result_callback_t &callback)
{
    if (!interval_valid(interval_s)) {
        if (callback) {
...
void
CameraImpl::stop_photo_interval_async(const Camera::result_callback_t &callback)
{
    auto cmd_stop_photo_interval = make_command_stop_photo();
...
void
CameraImpl::start_video_async(const Camera::result_callback_t &callback)
{
    // TODO: check whether video capture is already in progress.
    // TODO: check whether we are in video mode.
...
void
CameraImpl::stop_video_async(const Camera::result_callback_t &callback)
{
    auto cmd_stop_video = make_command_stop_video();
...
void
CameraImpl::set_video_stream_settings(const Camera::VideoStreamSettings &settings)
{
...
Camera::Result
CameraImpl::start_video_streaming()
{
...
Camera::Result
CameraImpl::stop_video_streaming()
{
...
void
CameraImpl::set_mode_async(Camera::Mode mode, const Camera::mode_callback_t &callback)
{
    float mavlink_mode;
    switch (mode) {
...
void
CameraImpl::get_mode_async(Camera::mode_callback_t callback)
{
...
bool
CameraImpl::interval_valid(float interval_s)
{
...
void
CameraImpl::get_status_async(Camera::get_status_callback_t callback)
{
    if (callback == nullptr) {
...
void
CameraImpl::receive_camera_capture_status_result(MAVLinkCommands::Result result)
{
    std::lock_guard<std::mutex> lock(_status.mutex);
...
void
CameraImpl::capture_info_async(Camera::capture_info_callback_t callback)
{
...
void
CameraImpl::process_camera_capture_status(const mavlink_message_t &message)
{
...
void
CameraImpl::process_storage_information(const mavlink_message_t &message)
{
...
void
CameraImpl::process_camera_image_captured(const mavlink_message_t &message)
{
...
void
CameraImpl::process_camera_settings(const mavlink_message_t &message)
{
    std::lock_guard<std::mutex> lock(_get_mode.mutex);
...
void
CameraImpl::process_camera_information(const mavlink_message_t &message)
{
...
void
CameraImpl::process_video_information(const mavlink_message_t &message)
{
...
void
CameraImpl::status_timeout_happened()
{
    std::lock_guard<std::mutex> lock(_status.mutex);
...
void
CameraImpl::receive_command_result(MAVLinkCommands::Result command_result,
...
void
CameraImpl::receive_storage_information_result(MAVLinkCommands::Result result)
{
    std::lock_guard<std::mutex> lock(_status.mutex);
    if (_status.callback == nullptr) {
        // We're not expecting this message, let's ignore it.
...
void
CameraImpl::receive_set_mode_command_result(MAVLinkCommands::Result command_result,
...
void
CameraImpl::receive_get_mode_command_result(MAVLinkCommands::Result command_result)
{
    Camera::Result camera_result = camera_result_from_command_result(command_result);
...
void
CameraImpl::get_mode_timeout_happened()
{
    std::lock_guard<std::mutex> lock(_get_mode.mutex);
...
void
CameraImpl::load_definition_file(const std::string &uri)
{
...
bool
CameraImpl::get_possible_settings(std::vector<std::string> &settings)
{
    settings.clear();
...
bool
CameraImpl::get_possible_options(const std::string &setting_name, std::vector<std::string> &options)
{
    options.clear();
...
void
CameraImpl::set_option_async(const std::string &setting,
...
void
CameraImpl::get_option_async(const std::string &setting,
...
bool
CameraImpl::get_setting_str(const std::string &setting_name, std::string &description)
{
    if (!_camera_definition) {
        return false;
    }
...
bool
CameraImpl::get_option_str(const std::string &setting_name,

...
bool
CameraDefinition::load_file(const std::string &filepath)
{
...
bool
CameraDefinition::load_string(const std::string &content)
{
...
std::string
CameraDefinition::get_model() const
{
    return _model;
}

std::string
CameraDefinition::get_vendor() const
{
    return _vendor;
}

bool
CameraDefinition::parse_xml()
{
...
void
CameraDefinition::assume_default_settings()
{
...
bool
CameraDefinition::get_all_settings(std::map<std::string, MAVLinkParameters::ParamValue> &settings)
{
    settings.clear();
...
bool
CameraDefinition::get_possible_settings(
...
bool
CameraDefinition::set_setting(const std::string &name, const MAVLinkParameters::ParamValue &value)
{
...
bool
CameraDefinition::get_setting(const std::string &name, MAVLinkParameters::ParamValue &value)
{
...
bool
CameraDefinition::get_option_value(const std::string &param_name,
...
bool
CameraDefinition::get_all_options(const std::string &name,
...
bool
CameraDefinition::get_possible_options(const std::string &name,
                                       std::vector<MAVLinkParameters::ParamValue> &values)
{
    values.clear();
...
bool
CameraDefinition::get_unknown_params(std::vector<std::string> &params)
{
    params.clear();
...
void
CameraDefinition::set_all_params_unknown()
{
...
bool
CameraDefinition::get_setting_str(const std::string &name, std::string &description)
{
    description.clear();
...
bool
CameraDefinition::get_option_str(const std::string &setting_name,

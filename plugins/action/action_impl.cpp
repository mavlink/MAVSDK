...
ActionResult
ActionImpl::return_to_launch() const
{
...
ActionResult
ActionImpl::transition_to_fixedwing() const
{
...
void
ActionImpl::transition_to_fixedwing_async(const Action::result_callback_t &callback)
{
    if (!_vtol_transition_support_known) {
        if (callback) {
...
ActionResult
ActionImpl::transition_to_multicopter() const
{
    if (!_vtol_transition_support_known) {
        return ActionResult::VTOL_TRANSITION_SUPPORT_UNKNOWN;
    }
...
void
ActionImpl::transition_to_multicopter_async(const Action::result_callback_t &callback)
{
    if (!_vtol_transition_support_known) {
        if (callback) {
            callback(ActionResult::VTOL_TRANSITION_SUPPORT_UNKNOWN);
...
void
ActionImpl::arm_async(const Action::result_callback_t &callback)
{
    ActionResult ret = arming_allowed();
    if (ret != ActionResult::SUCCESS) {
        if (callback) {
...
void
ActionImpl::arm_async_continued(MAVLinkCommands::Result previous_result,
...
void
ActionImpl::disarm_async(const Action::result_callback_t &callback)
{
    ActionResult ret = disarming_allowed();
    if (ret != ActionResult::SUCCESS) {
        if (callback) {
...
void
ActionImpl::kill_async(const Action::result_callback_t &callback)
{
    MAVLinkCommands::CommandLong command{};
...
void
ActionImpl::takeoff_async(const Action::result_callback_t &callback)
{
    ActionResult ret = taking_off_allowed();
    if (ret != ActionResult::SUCCESS) {
        if (callback) {
...
void
ActionImpl::takeoff_async_continued(MAVLinkCommands::Result previous_result,
                                    const Action::result_callback_t &callback)
{
    if (previous_result != MAVLinkCommands::Result::SUCCESS) {
        command_result_callback(previous_result, callback);
...
void
ActionImpl::land_async(const Action::result_callback_t &callback)
{
    MAVLinkCommands::CommandLong command{};
...
void
ActionImpl::return_to_launch_async(const Action::result_callback_t &callback)
{
    _parent->set_flight_mode_async(MAVLinkSystem::FlightMode::RETURN_TO_LAUNCH,
                                   std::bind(&ActionImpl::command_result_callback, _1, callback));
}

ActionResult
ActionImpl::arming_allowed() const
{
...
ActionResult
ActionImpl::taking_off_allowed() const
{
    if (!_in_air_state_known) {
        return ActionResult::COMMAND_DENIED_LANDED_STATE_UNKNOWN;
    }
...
ActionResult
ActionImpl::disarming_allowed() const
{
    if (!_in_air_state_known) {
        return ActionResult::COMMAND_DENIED_LANDED_STATE_UNKNOWN;
    }
...
void
ActionImpl::process_extended_sys_state(const mavlink_message_t &message)
{
...
void
ActionImpl::loiter_before_takeoff_async(const Action::result_callback_t &callback)
{
...
void
ActionImpl::loiter_before_arm_async(const Action::result_callback_t &callback)
{
    _parent->set_flight_mode_async(MAVLinkSystem::FlightMode::HOLD,
                                   std::bind(&ActionImpl::arm_async_continued, this, _1, callback));
}

void
ActionImpl::set_takeoff_altitude(float relative_altitude_m)
{
...
void
ActionImpl::receive_takeoff_alt_param(bool success, float new_relative_altitude_m)
{
    if (success) {
...
float
ActionImpl::get_takeoff_altitude_m() const
{
    return _relative_takeoff_altitude_m;
}

void
ActionImpl::set_max_speed(float speed_m_s)
{
    // TODO: add retries
    // const int retries = 3;
    _parent->set_param_float_async(
        "MPC_XY_CRUISE",
        speed_m_s,
        std::bind(&ActionImpl::receive_max_speed_result, this, _1, speed_m_s));
}

void
ActionImpl::receive_max_speed_result(bool success, float new_speed_m_s)
{
    if (!success) {
...
float
ActionImpl::get_max_speed_m_s() const
{
...
void
ActionImpl::command_result_callback(MAVLinkCommands::Result command_result,
                                    const Action::result_callback_t &callback)
{

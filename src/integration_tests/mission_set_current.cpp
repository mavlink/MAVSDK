...
TEST_F(SitlTest, MissionSetCurrent)
{
    ...
    mission_plan.mission_items.push_back(
        add_waypoint(home.latitude_deg + 0.00051181, home.longitude_deg + 0.000025082, 10));
    mission_plan.mission_items.push_back(
        add_waypoint(home.latitude_deg + 0.000491311, home.longitude_deg - 0.000851228, 10));
    mission_plan.mission_items.push_back(
        add_waypoint(home.latitude_deg - 0.000017057, home.longitude_deg - 0.000829769, 10));

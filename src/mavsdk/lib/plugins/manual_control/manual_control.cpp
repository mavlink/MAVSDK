...
ManualControl::ManualControl(System& system) : PluginBase(), _impl{std::make_unique<ManualControlImpl>(system)} {}

ManualControl::ManualControl(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<ManualControlImpl>(system)} {}
...
ManualControl::Result ManualControl::set_manual_control_input(float x, float y, float z, float r) const
{

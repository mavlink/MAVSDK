...
MissionRawServer::MissionRawServer(System& system) : PluginBase(), _impl{std::make_unique<MissionRawServerImpl>(system)} {}

MissionRawServer::MissionRawServer(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<MissionRawServerImpl>(system)} {}

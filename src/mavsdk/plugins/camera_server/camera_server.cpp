...
CameraServer::CameraServer(System& system) : PluginBase(), _impl{std::make_unique<CameraServerImpl>(system)} {}

CameraServer::CameraServer(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<CameraServerImpl>(system)} {}

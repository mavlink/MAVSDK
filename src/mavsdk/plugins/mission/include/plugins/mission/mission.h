...
public:
    ...
    /**
     * @brief Progress data coming from mission upload, in percent.
     */
    struct ProgressData {
    ...
    /**
     * @brief Progress data coming from mission download, in percent, or the mission itself (if the transfer succeeds).
     */
    struct ProgressDataOrMission {
        
        bool has_progress{false}; /**< @brief Whether this ProgressData contains a 'progress' status or not */
        float progress{float(NAN)}; /**< @brief Progress (percentage) */
        bool has_mission_plan{}; /**< @brief Whether this ProgressData contains a 'mission_plan' or not */
     ...
     * @return Result of request.
     */
    std::pair<Result, Mission::ProgressData> subscribe_upload_mission_with_progress(MissionPlan mission_plan) const;
    ...
    */
     ...
     * @return Result of request.
     */
    std::pair<Result, Mission::ProgressData> subscribe_download_mission_with_progress() const;

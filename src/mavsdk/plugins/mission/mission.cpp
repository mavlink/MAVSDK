...
std::pair<Mission::Result, Mission::ProgressData> Mission::subscribe_upload_mission_with_progress(MissionPlan mission_plan) const
{
    return _impl->subscribe_upload_mission_with_progress(mission_plan);
}
...
std::pair<Mission::Result, Mission::ProgressData> Mission::subscribe_download_mission_with_progress() const
{
    return _impl->subscribe_download_mission_with_progress();
}
...
bool operator==(const Mission::ProgressDataOrMission& lhs, const Mission::ProgressDataOrMission& rhs)
{
    return
        ...
        ((std::isnan(rhs.progress) && std::isnan(lhs.progress)) || rhs.progress == lhs.progress) &&
        (rhs.has_mission_plan == lhs.has_mission_plan) &&
...
std::ostream& operator<<(std::ostream& str, Mission::ProgressDataOrMission const& progress_data_or_mission)
{
    ...
    str << "    has_mission_plan: " << progress_data_or_mission.has_mission_plan << '\n';

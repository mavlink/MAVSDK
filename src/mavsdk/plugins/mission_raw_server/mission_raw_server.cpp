...
MissionRawServer::incoming_mission() const
{
...
MissionRawServer::current_item_changed() const
{
...
uint32_t
MissionRawServer::clear_all() const
{
...
bool operator==(const MissionRawServer::MissionProgress& lhs, const MissionRawServer::MissionProgress& rhs)
{
    return
        (rhs.current == lhs.current) &&
        (rhs.total == lhs.total);
...
std::ostream& operator<<(std::ostream& str, MissionRawServer::MissionProgress const& mission_progress)
{
    str << std::setprecision(15);

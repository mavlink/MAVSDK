...
ActionServer::ActionServer(System& system) : PluginBase(), _impl{std::make_unique<ActionServerImpl>(system)} {}

ActionServer::ActionServer(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<ActionServerImpl>(system)} {}

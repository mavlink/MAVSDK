...
ActionServer::ActionServer(std::shared_ptr<ServerComponent> server_component) : ServerPluginBase(), _impl{std::make_unique<ActionServerImpl>(server_component)} {}
...
ActionServer::FlightModeChangeHandle ActionServer::subscribe_flight_mode_change(const FlightModeChangeCallback& callback)
{
...
ActionServer::Result ActionServer::set_allowable_flight_modes(AllowableFlightModes flight_modes) const
{
...
bool operator==(const ActionServer::AllowableFlightModes& lhs, const ActionServer::AllowableFlightModes& rhs)
{
    return
        (rhs.can_auto_mode == lhs.can_auto_mode) &&
        (rhs.can_guided_mode == lhs.can_guided_mode) &&
        (rhs.can_stabilize_mode == lhs.can_stabilize_mode);
}

std::ostream& operator<<(std::ostream& str, ActionServer::AllowableFlightModes const& allowable_flight_modes)
{

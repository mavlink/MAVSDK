...
ComponentInformationServer::ComponentInformationServer(std::shared_ptr<ServerComponent> server_component) : ServerPluginBase(), _impl{std::make_unique<ComponentInformationServerImpl>(server_component)} {}
...
ComponentInformationServer::Result ComponentInformationServer::provide_float_param(FloatParam param) const
{
...
ComponentInformationServer::FloatParamHandle ComponentInformationServer::subscribe_float_param(const FloatParamCallback& callback)
{
...
bool operator==(const ComponentInformationServer::FloatParam& lhs, const ComponentInformationServer::FloatParam& rhs)
{
    return
        (rhs.name == lhs.name) &&
...
std::ostream& operator<<(std::ostream& str, ComponentInformationServer::FloatParam const& float_param)
{
...
bool operator==(const ComponentInformationServer::FloatParamUpdate& lhs, const ComponentInformationServer::FloatParamUpdate& rhs)
{
    return
        (rhs.name == lhs.name) &&
...
std::ostream& operator<<(std::ostream& str, ComponentInformationServer::FloatParamUpdate const& float_param_update)
{
    str << std::setprecision(15);

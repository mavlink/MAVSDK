...
TrackingServer::TrackingServer(std::shared_ptr<ServerComponent> server_component) : ServerPluginBase(), _impl{std::make_unique<TrackingServerImpl>(server_component)} {}
...
TrackingServer::TrackingPointCommandHandle TrackingServer::subscribe_tracking_point_command(const TrackingPointCommandCallback& callback)
{
...
TrackingServer::TrackingRectangleCommandHandle TrackingServer::subscribe_tracking_rectangle_command(const TrackingRectangleCommandCallback& callback)
{
...
TrackingServer::TrackingOffCommandHandle TrackingServer::subscribe_tracking_off_command(const TrackingOffCommandCallback& callback)
{
...
TrackingServer::Result TrackingServer::respond_tracking_point_command(CommandAnswer command_answer) const
{
...
TrackingServer::Result TrackingServer::respond_tracking_rectangle_command(CommandAnswer command_answer) const
{
...
TrackingServer::Result TrackingServer::respond_tracking_off_command(CommandAnswer command_answer) const
{
...
bool operator==(const TrackingServer::TrackRectangle& lhs, const TrackingServer::TrackRectangle& rhs)
{
    return

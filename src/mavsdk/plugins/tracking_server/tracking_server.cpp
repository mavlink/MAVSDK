...
TrackingServer::TrackingServer(System& system) : PluginBase(), _impl{std::make_unique<TrackingServerImpl>(system)} {}

TrackingServer::TrackingServer(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<TrackingServerImpl>(system)} {}

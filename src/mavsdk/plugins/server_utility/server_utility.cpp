...
ServerUtility::ServerUtility(System& system) : PluginBase(), _impl{std::make_unique<ServerUtilityImpl>(system)} {}

ServerUtility::ServerUtility(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<ServerUtilityImpl>(system)} {}

...
public:
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::VtolState const& vtol_state);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::StatusTextType const& status_text_type);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::LandedState const& landed_state);
     ...
     */
    friend bool operator==(const TelemetryServer::Position& lhs, const TelemetryServer::Position& rhs);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::Heading& lhs, const TelemetryServer::Heading& rhs);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::Quaternion& lhs, const TelemetryServer::Quaternion& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::Quaternion const& quaternion);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::EulerAngle& lhs, const TelemetryServer::EulerAngle& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::EulerAngle const& euler_angle);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::AngularVelocityBody& lhs, const TelemetryServer::AngularVelocityBody& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::AngularVelocityBody const& angular_velocity_body);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::GpsInfo& lhs, const TelemetryServer::GpsInfo& rhs);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::Battery& lhs, const TelemetryServer::Battery& rhs);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::RcStatus& lhs, const TelemetryServer::RcStatus& rhs);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::CellularStatus& lhs, const TelemetryServer::CellularStatus& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::CellularStatus const& cellular_status);
    ...
    struct ModemInfo {
        ...
        std::string iccid{}; /**< @briefIntegrated Circuit Card Identification Number of SIM Card */
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::ModemInfo& lhs, const TelemetryServer::ModemInfo& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::ModemInfo const& modem_info);
    ...
    struct OnboardComputerStatus {
        ...
        uint32_t uptime{}; /**< @brief */
        uint32_t type{}; /**< @brief */
        std::vector<uint32_t> cpu_cores{}; /**< @brief */
        std::vector<uint32_t> cpu_combined{}; /**< @brief */
        std::vector<uint32_t> gpu_cores{}; /**< @brief */
        std::vector<uint32_t> gpu_combined{}; /**< @brief */
        uint32_t temperature_board{}; /**< @brief */
        std::vector<uint32_t> temperature_core{}; /**< @brief */
        std::vector<uint32_t> fan_speed{}; /**< @brief */
        uint32_t ram_usage{}; /**< @brief */
        uint32_t ram_total{}; /**< @brief */
        std::vector<uint32_t> storage_type{}; /**< @brief */
        std::vector<uint32_t> storage_usage{}; /**< @brief */
        std::vector<uint32_t> storage_total{}; /**< @brief */
        std::vector<uint32_t> link_type{}; /**< @brief */
        std::vector<uint32_t> link_tx_rate{}; /**< @brief */
        std::vector<uint32_t> link_rx_rate{}; /**< @brief */
        std::vector<uint32_t> link_tx_max{}; /**< @brief */
        std::vector<uint32_t> link_rx_max{}; /**< @brief */
    };

    /**
     * @brief Equal operator to compare two `TelemetryServer::OnboardComputerStatus` objects.
     *
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::OnboardComputerStatus& lhs, const TelemetryServer::OnboardComputerStatus& rhs);

    /**
     * @brief Stream operator to print information about a `TelemetryServer::OnboardComputerStatus`.
     *
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::OnboardComputerStatus const& onboard_computer_status);
     ...
     * @brief 
     */
    struct ComponentInfoBasic {
        
        uint32_t time_boot_ms{}; /**< @brief */
        uint64_t capabilities{}; /**< @brief */
        std::string vendor_name{}; /**< @brief */
        std::string model_name{}; /**< @brief */
        std::string software_version{}; /**< @brief */
        std::string hardware_version{}; /**< @brief */
        std::string serial_number{}; /**< @brief */
    };

    /**
     * @brief Equal operator to compare two `TelemetryServer::ComponentInfoBasic` objects.
     *
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::ComponentInfoBasic& lhs, const TelemetryServer::ComponentInfoBasic& rhs);

    /**
     * @brief Stream operator to print information about a `TelemetryServer::ComponentInfoBasic`.
     *
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::ComponentInfoBasic const& component_info_basic);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::StatusText& lhs, const TelemetryServer::StatusText& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::StatusText const& status_text);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::ActuatorControlTarget& lhs, const TelemetryServer::ActuatorControlTarget& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::ActuatorControlTarget const& actuator_control_target);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::ActuatorOutputStatus& lhs, const TelemetryServer::ActuatorOutputStatus& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::ActuatorOutputStatus const& actuator_output_status);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::Covariance& lhs, const TelemetryServer::Covariance& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::Covariance const& covariance);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::VelocityBody& lhs, const TelemetryServer::VelocityBody& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::VelocityBody const& velocity_body);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::PositionBody& lhs, const TelemetryServer::PositionBody& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::PositionBody const& position_body);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::Odometry::MavFrame const& mav_frame);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::Odometry& lhs, const TelemetryServer::Odometry& rhs);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::DistanceSensor& lhs, const TelemetryServer::DistanceSensor& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::DistanceSensor const& distance_sensor);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::ScaledPressure& lhs, const TelemetryServer::ScaledPressure& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::ScaledPressure const& scaled_pressure);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::PositionNed& lhs, const TelemetryServer::PositionNed& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::PositionNed const& position_ned);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::VelocityNed& lhs, const TelemetryServer::VelocityNed& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::VelocityNed const& velocity_ned);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::PositionVelocityNed& lhs, const TelemetryServer::PositionVelocityNed& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::PositionVelocityNed const& position_velocity_ned);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::GroundTruth& lhs, const TelemetryServer::GroundTruth& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::GroundTruth const& ground_truth);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::FixedwingMetrics& lhs, const TelemetryServer::FixedwingMetrics& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::FixedwingMetrics const& fixedwing_metrics);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::AccelerationFrd& lhs, const TelemetryServer::AccelerationFrd& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::AccelerationFrd const& acceleration_frd);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::AngularVelocityFrd& lhs, const TelemetryServer::AngularVelocityFrd& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::AngularVelocityFrd const& angular_velocity_frd);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::MagneticFieldFrd& lhs, const TelemetryServer::MagneticFieldFrd& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::MagneticFieldFrd const& magnetic_field_frd);
     ...
     * @return Result of request.
     */
    Result publish_sys_status(Battery battery, bool rc_receiver_status, bool gyro_status, bool accel_status, bool mag_status, bool gps_status) const;
    ...
    /**
     * @brief Publish to 'obc_status' updates.
     *
     * This function is blocking.
     *
     * @return Result of request.
     */
    Result publish_onboard_computer_status(OnboardComputerStatus obc_status) const;
    ...
    /**
     * @brief Publish to 'component_info_basic' updates.
     *
     * This function is blocking.
     *
     * @return Result of request.
     */
    Result publish_component_info_basic(ComponentInfoBasic component_info_basic) const;

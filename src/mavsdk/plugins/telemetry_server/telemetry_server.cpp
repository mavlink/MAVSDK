...
using ModemInfo = TelemetryServer::ModemInfo;
using OnboardComputerStatus = TelemetryServer::OnboardComputerStatus;
using ComponentInfoBasic = TelemetryServer::ComponentInfoBasic;
...
TelemetryServer::TelemetryServer(std::shared_ptr<ServerComponent> server_component) : ServerPluginBase(), _impl{std::make_unique<TelemetryServerImpl>(server_component)} {}
...
TelemetryServer::Result TelemetryServer::publish_position(Position position, VelocityNed velocity_ned, Heading heading) const
{
...
TelemetryServer::Result TelemetryServer::publish_sys_status(Battery battery, bool rc_receiver_status, bool gyro_status, bool accel_status, bool mag_status, bool gps_status) const
{
    return _impl->publish_sys_status(battery, rc_receiver_status, gyro_status, accel_status, mag_status, gps_status);
}
...
TelemetryServer::Result TelemetryServer::publish_extended_sys_state(VtolState vtol_state, LandedState landed_state) const
{
...
TelemetryServer::Result TelemetryServer::publish_cellular_status(CellularStatus cellular_status) const
{
...
TelemetryServer::Result TelemetryServer::publish_modem_info(ModemInfo modem_info) const
{
    return _impl->publish_modem_info(modem_info);
}
...
TelemetryServer::Result TelemetryServer::publish_onboard_computer_status(OnboardComputerStatus obc_status) const
{
    return _impl->publish_onboard_computer_status(obc_status);
}
...
TelemetryServer::Result TelemetryServer::publish_component_info_basic(ComponentInfoBasic component_info_basic) const
{
    return _impl->publish_component_info_basic(component_info_basic);
}
...
TelemetryServer::Result TelemetryServer::publish_position_velocity_ned(PositionVelocityNed position_velocity_ned) const
{
...
bool operator==(const TelemetryServer::AngularVelocityBody& lhs, const TelemetryServer::AngularVelocityBody& rhs)
{
    return
...
std::ostream& operator<<(std::ostream& str, TelemetryServer::AngularVelocityBody const& angular_velocity_body)
{
    str << std::setprecision(15);
...
bool operator==(const TelemetryServer::CellularStatus& lhs, const TelemetryServer::CellularStatus& rhs)
{
    return
        (rhs.status == lhs.status) &&
        (rhs.failure_reason == lhs.failure_reason) &&
        (rhs.type == lhs.type) &&
        (rhs.quality == lhs.quality) &&
        (rhs.mcc == lhs.mcc) &&
        (rhs.mnc == lhs.mnc) &&
        (rhs.lac == lhs.lac) &&
        (rhs.band_number == lhs.band_number) &&
        ((std::isnan(rhs.band_frequency) && std::isnan(lhs.band_frequency)) || rhs.band_frequency == lhs.band_frequency) &&
        (rhs.channel_number == lhs.channel_number) &&
        ((std::isnan(rhs.rx_level) && std::isnan(lhs.rx_level)) || rhs.rx_level == lhs.rx_level) &&
        ((std::isnan(rhs.tx_level) && std::isnan(lhs.tx_level)) || rhs.tx_level == lhs.tx_level) &&
        ((std::isnan(rhs.rx_quality) && std::isnan(lhs.rx_quality)) || rhs.rx_quality == lhs.rx_quality) &&
        (rhs.link_tx_rate == lhs.link_tx_rate) &&
        (rhs.link_rx_rate == lhs.link_rx_rate) &&
        (rhs.bit_error_rate == lhs.bit_error_rate) &&
        (rhs.instance_number == lhs.instance_number) &&
        (rhs.cell_tower_id == lhs.cell_tower_id);
}
...
bool operator==(const TelemetryServer::ModemInfo& lhs, const TelemetryServer::ModemInfo& rhs)
{
    return
        (rhs.instance_number == lhs.instance_number) &&
        (rhs.imei == lhs.imei) &&
        (rhs.imsi == lhs.imsi) &&
        (rhs.modem_id == lhs.modem_id) &&
        (rhs.iccid == lhs.iccid) &&
        (rhs.firmware_version == lhs.firmware_version) &&
        (rhs.modem_model_name == lhs.modem_model_name);
}

std::ostream& operator<<(std::ostream& str, TelemetryServer::ModemInfo const& modem_info)
{
    str << std::setprecision(15);
    str << "modem_info:" << '\n'
        << "{\n";
...
bool operator==(const TelemetryServer::OnboardComputerStatus& lhs, const TelemetryServer::OnboardComputerStatus& rhs)
{
    return
        (rhs.time_usec == lhs.time_usec) &&
        (rhs.uptime == lhs.uptime) &&
        (rhs.type == lhs.type) &&
        (rhs.cpu_cores == lhs.cpu_cores) &&
        (rhs.cpu_combined == lhs.cpu_combined) &&
        (rhs.gpu_cores == lhs.gpu_cores) &&
        (rhs.gpu_combined == lhs.gpu_combined) &&
        (rhs.temperature_board == lhs.temperature_board) &&
        (rhs.temperature_core == lhs.temperature_core) &&
        (rhs.fan_speed == lhs.fan_speed) &&
        (rhs.ram_usage == lhs.ram_usage) &&
        (rhs.ram_total == lhs.ram_total) &&
        (rhs.storage_type == lhs.storage_type) &&
        (rhs.storage_usage == lhs.storage_usage) &&
        (rhs.storage_total == lhs.storage_total) &&
        (rhs.link_type == lhs.link_type) &&
        (rhs.link_tx_rate == lhs.link_tx_rate) &&
        (rhs.link_rx_rate == lhs.link_rx_rate) &&
        (rhs.link_tx_max == lhs.link_tx_max) &&
        (rhs.link_rx_max == lhs.link_rx_max);
}

std::ostream& operator<<(std::ostream& str, TelemetryServer::OnboardComputerStatus const& onboard_computer_status)
{
    str << std::setprecision(15);
    str << "onboard_computer_status:" << '\n'
        << "{\n";
    str << "    time_usec: " << onboard_computer_status.time_usec << '\n';
    str << "    uptime: " << onboard_computer_status.uptime << '\n';
    str << "    type: " << onboard_computer_status.type << '\n';
    str << "    cpu_cores: [";
    for (auto it = onboard_computer_status.cpu_cores.begin(); it != onboard_computer_status.cpu_cores.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.cpu_cores.end() ? ", " : "]\n");
    }
    str << "    cpu_combined: [";
    for (auto it = onboard_computer_status.cpu_combined.begin(); it != onboard_computer_status.cpu_combined.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.cpu_combined.end() ? ", " : "]\n");
    }
    str << "    gpu_cores: [";
    for (auto it = onboard_computer_status.gpu_cores.begin(); it != onboard_computer_status.gpu_cores.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.gpu_cores.end() ? ", " : "]\n");
    }
    str << "    gpu_combined: [";
    for (auto it = onboard_computer_status.gpu_combined.begin(); it != onboard_computer_status.gpu_combined.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.gpu_combined.end() ? ", " : "]\n");
    }
    str << "    temperature_board: " << onboard_computer_status.temperature_board << '\n';
    str << "    temperature_core: [";
    for (auto it = onboard_computer_status.temperature_core.begin(); it != onboard_computer_status.temperature_core.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.temperature_core.end() ? ", " : "]\n");
    }
    str << "    fan_speed: [";
    for (auto it = onboard_computer_status.fan_speed.begin(); it != onboard_computer_status.fan_speed.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.fan_speed.end() ? ", " : "]\n");
    }
    str << "    ram_usage: " << onboard_computer_status.ram_usage << '\n';
    str << "    ram_total: " << onboard_computer_status.ram_total << '\n';
    str << "    storage_type: [";
    for (auto it = onboard_computer_status.storage_type.begin(); it != onboard_computer_status.storage_type.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.storage_type.end() ? ", " : "]\n");
    }
    str << "    storage_usage: [";
    for (auto it = onboard_computer_status.storage_usage.begin(); it != onboard_computer_status.storage_usage.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.storage_usage.end() ? ", " : "]\n");
    }
    str << "    storage_total: [";
    for (auto it = onboard_computer_status.storage_total.begin(); it != onboard_computer_status.storage_total.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.storage_total.end() ? ", " : "]\n");
    }
    str << "    link_type: [";
    for (auto it = onboard_computer_status.link_type.begin(); it != onboard_computer_status.link_type.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.link_type.end() ? ", " : "]\n");
    }
    str << "    link_tx_rate: [";
    for (auto it = onboard_computer_status.link_tx_rate.begin(); it != onboard_computer_status.link_tx_rate.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.link_tx_rate.end() ? ", " : "]\n");
    }
    str << "    link_rx_rate: [";
    for (auto it = onboard_computer_status.link_rx_rate.begin(); it != onboard_computer_status.link_rx_rate.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.link_rx_rate.end() ? ", " : "]\n");
    }
    str << "    link_tx_max: [";
    for (auto it = onboard_computer_status.link_tx_max.begin(); it != onboard_computer_status.link_tx_max.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.link_tx_max.end() ? ", " : "]\n");
    }
    str << "    link_rx_max: [";
    for (auto it = onboard_computer_status.link_rx_max.begin(); it != onboard_computer_status.link_rx_max.end(); ++it) {
        str << *it;
        str << (it + 1 != onboard_computer_status.link_rx_max.end() ? ", " : "]\n");
    }
    str << '}';
    return str;
}
...
bool operator==(const TelemetryServer::ComponentInfoBasic& lhs, const TelemetryServer::ComponentInfoBasic& rhs)
{
    return
        ...
        (rhs.software_version == lhs.software_version) &&
        (rhs.hardware_version == lhs.hardware_version) &&
        (rhs.serial_number == lhs.serial_number);
}

std::ostream& operator<<(std::ostream& str, TelemetryServer::ComponentInfoBasic const& component_info_basic)
{
    str << std::setprecision(15);
    str << "component_info_basic:" << '\n'
        << "{\n";
    str << "    time_boot_ms: " << component_info_basic.time_boot_ms << '\n';
    str << "    capabilities: " << component_info_basic.capabilities << '\n';
    str << "    vendor_name: " << component_info_basic.vendor_name << '\n';
    str << "    model_name: " << component_info_basic.model_name << '\n';
    str << "    software_version: " << component_info_basic.software_version << '\n';
    str << "    hardware_version: " << component_info_basic.hardware_version << '\n';
    str << "    serial_number: " << component_info_basic.serial_number << '\n';
    str << '}';
    return str;
}
...
bool operator==(const TelemetryServer::ActuatorControlTarget& lhs, const TelemetryServer::ActuatorControlTarget& rhs)
{
    return
        (rhs.group == lhs.group) &&
...
std::ostream& operator<<(std::ostream& str, TelemetryServer::ActuatorControlTarget const& actuator_control_target)
{
    str << std::setprecision(15);
...
bool operator==(const TelemetryServer::ActuatorOutputStatus& lhs, const TelemetryServer::ActuatorOutputStatus& rhs)
{
    return
...
std::ostream& operator<<(std::ostream& str, TelemetryServer::ActuatorOutputStatus const& actuator_output_status)
{
    str << std::setprecision(15);
...
bool operator==(const TelemetryServer::DistanceSensor& lhs, const TelemetryServer::DistanceSensor& rhs)
{
    return
...
bool operator==(const TelemetryServer::ScaledPressure& lhs, const TelemetryServer::ScaledPressure& rhs)
{
    return
        (rhs.timestamp_us == lhs.timestamp_us) &&
...
bool operator==(const TelemetryServer::PositionVelocityNed& lhs, const TelemetryServer::PositionVelocityNed& rhs)
{
    return
...
std::ostream& operator<<(std::ostream& str, TelemetryServer::PositionVelocityNed const& position_velocity_ned)
{
    str << std::setprecision(15);
...
bool operator==(const TelemetryServer::FixedwingMetrics& lhs, const TelemetryServer::FixedwingMetrics& rhs)
{
    return
...
std::ostream& operator<<(std::ostream& str, TelemetryServer::FixedwingMetrics const& fixedwing_metrics)
{
    str << std::setprecision(15);
...
bool operator==(const TelemetryServer::AccelerationFrd& lhs, const TelemetryServer::AccelerationFrd& rhs)
{
    return
...
std::ostream& operator<<(std::ostream& str, TelemetryServer::AccelerationFrd const& acceleration_frd)
{
    str << std::setprecision(15);
...
bool operator==(const TelemetryServer::AngularVelocityFrd& lhs, const TelemetryServer::AngularVelocityFrd& rhs)
{
    return
...
std::ostream& operator<<(std::ostream& str, TelemetryServer::AngularVelocityFrd const& angular_velocity_frd)
{
    str << std::setprecision(15);
...
bool operator==(const TelemetryServer::MagneticFieldFrd& lhs, const TelemetryServer::MagneticFieldFrd& rhs)
{
    return
...
std::ostream& operator<<(std::ostream& str, TelemetryServer::MagneticFieldFrd const& magnetic_field_frd)
{
    str << std::setprecision(15);

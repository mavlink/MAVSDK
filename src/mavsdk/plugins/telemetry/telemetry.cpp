...
using OnboardComputerStatus = Telemetry::OnboardComputerStatus;
using ComponentInfoBasic = Telemetry::ComponentInfoBasic;
...
Telemetry::CellularStatusHandle Telemetry::subscribe_cellular_status(const CellularStatusCallback& callback)
{
...
Telemetry::CellularStatus
Telemetry::cellular_status() const
{
...
Telemetry::OnboardComputerStatusHandle Telemetry::subscribe_onboard_computer_status(const OnboardComputerStatusCallback& callback)
{
    return _impl->subscribe_onboard_computer_status(callback);
}

void Telemetry::unsubscribe_onboard_computer_status(OnboardComputerStatusHandle handle)
{
    _impl->unsubscribe_onboard_computer_status(handle);
}
...
Telemetry::OnboardComputerStatus
Telemetry::onboard_computer_status() const
{
    return _impl->onboard_computer_status();
}



    
Telemetry::ComponentInfoBasicHandle Telemetry::subscribe_component_info_basic(const ComponentInfoBasicCallback& callback)
{
    return _impl->subscribe_component_info_basic(callback);
}

void Telemetry::unsubscribe_component_info_basic(ComponentInfoBasicHandle handle)
{
    _impl->unsubscribe_component_info_basic(handle);
}
...
Telemetry::ComponentInfoBasic
Telemetry::component_info_basic() const
{
    return _impl->component_info_basic();
}
...
void Telemetry::set_rate_onboard_computer_status_async(double rate_hz, const ResultCallback callback)
{
    _impl->set_rate_onboard_computer_status_async(rate_hz, callback);
}



Telemetry::Result Telemetry::set_rate_onboard_computer_status(double rate_hz) const
{
    return _impl->set_rate_onboard_computer_status(rate_hz);
}



void Telemetry::set_rate_component_info_basic_async(double rate_hz, const ResultCallback callback)
{
    _impl->set_rate_component_info_basic_async(rate_hz, callback);
}



Telemetry::Result Telemetry::set_rate_component_info_basic(double rate_hz) const
{
    return _impl->set_rate_component_info_basic(rate_hz);
}
...
bool operator==(const Telemetry::OnboardComputerStatus& lhs, const Telemetry::OnboardComputerStatus& rhs)
{
    return
...
std::ostream& operator<<(std::ostream& str, Telemetry::OnboardComputerStatus const& onboard_computer_status)
{
    str << std::setprecision(15);
...
bool operator==(const Telemetry::ComponentInfoBasic& lhs, const Telemetry::ComponentInfoBasic& rhs)
{
    return
...
std::ostream& operator<<(std::ostream& str, Telemetry::ComponentInfoBasic const& component_info_basic)
{
    str << std::setprecision(15);

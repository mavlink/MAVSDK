...
Offboard::Offboard(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<OffboardImpl>(system)} {}
...
Offboard::Result Offboard::set_position_velocity_acceleration_ned(PositionNedYaw position_ned_yaw, VelocityNedYaw velocity_ned_yaw, AccelerationNed acceleration_ned) const
{
    return _impl->set_position_velocity_acceleration_ned(position_ned_yaw, velocity_ned_yaw, acceleration_ned);
}
...
std::ostream& operator<<(std::ostream& str, Offboard::PositionGlobalYaw::AltitudeType const& altitude_type)
{
...
{
    return
        ((std::isnan(rhs.north_m_s2) && std::isnan(lhs.north_m_s2)) || rhs.north_m_s2 == lhs.north_m_s2) &&
        ((std::isnan(rhs.east_m_s2) && std::isnan(lhs.east_m_s2)) || rhs.east_m_s2 == lhs.east_m_s2) &&

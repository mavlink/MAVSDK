...
void TransponderImpl::process_transponder(const mavlink_message_t& message)
{
    ...
    adsbVehicle.altitude_m = local_adsb_vehicle.altitude * 1e-3f;
    ...
    adsbVehicle.altitude_type = local_adsb_vehicle.altitude_type == ADSB_ALTITUDE_TYPE_PRESSURE_QNH ?
        Transponder::AdsbAltitudeType::PressureQnh : Transponder::AdsbAltitudeType::Geometric;

...
public:
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, Transponder::AdsbAltitudeType const& adsb_altitude_type);
    ...
    struct AdsbVehicle {
        ...
        float altitude_m{}; /**< @brief Altitude ASL (above sea level) in metres */

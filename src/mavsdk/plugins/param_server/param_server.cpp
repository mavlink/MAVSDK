...
ParamServer::ChangedParamIntHandle ParamServer::subscribe_changed_param_int(const ChangedParamIntCallback& callback)
{
...
ParamServer::ChangedParamFloatHandle ParamServer::subscribe_changed_param_float(const ChangedParamFloatCallback& callback)
{
...
ParamServer::ChangedParamCustomHandle ParamServer::subscribe_changed_param_custom(const ChangedParamCustomCallback& callback)
{

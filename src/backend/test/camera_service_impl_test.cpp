...
CameraServiceImplTest::createArbitraryRPCVideoStreamInfo() const
{
    auto rpc_info = std::make_unique<mavsdk::rpc::camera::VideoStreamInfo>(
        mavsdk::rpc::camera::VideoStreamInfo());
...
{
    auto rpc_info =
        std::make_unique<mavsdk::rpc::camera::CaptureInfo>(mavsdk::rpc::camera::CaptureInfo());
    ...
    const double lat, const double lng, const float abs_alt, const float rel_alt) const
{
    auto expected_position =
        std::make_unique<mavsdk::rpc::camera::Position>(mavsdk::rpc::camera::Position());
...
{
    auto quaternion =
        std::make_unique<mavsdk::rpc::camera::Quaternion>(mavsdk::rpc::camera::Quaternion());
...
{
    auto euler_angle =
        std::make_unique<mavsdk::rpc::camera::EulerAngle>(mavsdk::rpc::camera::EulerAngle());
...
std::unique_ptr<mavsdk::rpc::camera::Setting> CameraServiceImplTest::createRPCSetting(
    ...
    const std::string& option_description)
{
    auto setting = std::make_unique<mavsdk::rpc::camera::Setting>(mavsdk::rpc::camera::Setting());
    setting->set_setting_id(setting_id);
    setting->set_setting_description(setting_description);

    auto option = std::make_unique<mavsdk::rpc::camera::Option>(mavsdk::rpc::camera::Option());

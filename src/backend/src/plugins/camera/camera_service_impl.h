...
public:
    ...
    {
        std::unique_ptr<rpc::camera::VideoStreamSettings> rpc_obj(new rpc::camera::VideoStreamSettings());
    ...
    static rpc::camera::VideoStreamInfo::Status translateToRpcStatus(const mavsdk::Camera::VideoStreamInfo::Status& status)
    {
        switch (status) {
            default:
    ...
    static mavsdk::Camera::VideoStreamInfo::Status translateFromRpcStatus(const rpc::camera::VideoStreamInfo::Status status)
    {
        switch (status) {
            default:
                LogErr() << "Unknown status enum value: " << static_cast<int>(status);

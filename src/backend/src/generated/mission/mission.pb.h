...
inline void ImportQgroundcontrolMissionRequest::_internal_set_qgc_plan_path(const std::string& value) {
  ...
  qgc_plan_path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void ImportQgroundcontrolMissionRequest::set_qgc_plan_path(const char* value) {
  ...
  qgc_plan_path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void ImportQgroundcontrolMissionRequest::set_qgc_plan_path(const char* value,
  ...
  qgc_plan_path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
...
inline std::string* ImportQgroundcontrolMissionRequest::_internal_mutable_qgc_plan_path() {
  ...
  return qgc_plan_path_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}

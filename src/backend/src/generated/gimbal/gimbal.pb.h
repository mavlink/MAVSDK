...
#ifndef PROTOBUF_INCLUDED_gimbal_2fgimbal_2eproto
#define PROTOBUF_INCLUDED_gimbal_2fgimbal_2eproto
...
enum GimbalResult_Result {
  GimbalResult_Result_SUCCESS = 0,
  GimbalResult_Result_ERROR = 1,
  GimbalResult_Result_TIMEOUT = 2,
  GimbalResult_Result_UNKNOWN = 1000,
  GimbalResult_Result_GimbalResult_Result_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  GimbalResult_Result_GimbalResult_Result_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
bool GimbalResult_Result_IsValid(int value);
const GimbalResult_Result GimbalResult_Result_Result_MIN = GimbalResult_Result_SUCCESS;
const GimbalResult_Result GimbalResult_Result_Result_MAX = GimbalResult_Result_UNKNOWN;
const int GimbalResult_Result_Result_ARRAYSIZE = GimbalResult_Result_Result_MAX + 1;
...
inline const ::std::string& GimbalResult_Result_Name(GimbalResult_Result value) {
  return ::google::protobuf::internal::NameOfEnum(
    GimbalResult_Result_descriptor(), value);
}
...
enum GimbalMode {
  YAW_FOLLOW = 0,
  YAW_LOCK = 1,
  GimbalMode_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  GimbalMode_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
bool GimbalMode_IsValid(int value);
const GimbalMode GimbalMode_MIN = YAW_FOLLOW;
const GimbalMode GimbalMode_MAX = YAW_LOCK;
...
class SetPitchAndYawRequest :
 ...
 public:
  ...
  void Swap(SetPitchAndYawRequest* other);
  ...
  SetPitchAndYawRequest* New(::google::protobuf::Arena* arena) const final {
  ...
  static const int kPitchDegFieldNumber = 1;
  float pitch_deg() const;
  void set_pitch_deg(float value);

  // float yaw_deg = 2;
  void clear_yaw_deg();
  static const int kYawDegFieldNumber = 2;
  float yaw_deg() const;
...
class SetPitchAndYawResponse :
 ...
 public:
  ...
  void Swap(SetPitchAndYawResponse* other);
  ...
  SetPitchAndYawResponse* New(::google::protobuf::Arena* arena) const final {
  ...
  static const int kGimbalResultFieldNumber = 1;
...
class SetModeRequest :
 ...
 public:
  ...
  static const int kGimbalModeFieldNumber = 1;
...
class GimbalResult :
 ...
 public:
  ...
  GimbalResult* New(::google::protobuf::Arena* arena) const final {
...
inline void SetPitchAndYawResponse::set_allocated_gimbal_result(::mavsdk::rpc::gimbal::GimbalResult* gimbal_result) {
  ...
  if (gimbal_result) {
    ...
    if (message_arena != submessage_arena) {
      gimbal_result = ::google::protobuf::internal::GetOwnedMessage(
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_gimbal_2fgimbal_2eproto

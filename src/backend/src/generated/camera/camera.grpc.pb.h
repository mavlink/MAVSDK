 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    // rpc GetInformation(GetInformationRequest) returns(GetInformationResponse) { option (mavsdk.options.async_type) = SYNC; }
    //
    //

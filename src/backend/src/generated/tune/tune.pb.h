...
inline bool TuneResult_Result_Parse(
    const std::string& name, TuneResult_Result* value) {
...
inline bool SongElement_Parse(
    const std::string& name, SongElement* value) {
...
inline void PlayTuneResponse::clear_tune_result() {
  if (GetArenaNoVirtual() == nullptr && tune_result_ != nullptr) {
    delete tune_result_;
  }
...
inline ::mavsdk::rpc::tune::TuneResult* PlayTuneResponse::_internal_mutable_tune_result() {
  ...
  if (tune_result_ == nullptr) {
    auto* p = CreateMaybeMessage<::mavsdk::rpc::tune::TuneResult>(GetArenaNoVirtual());
    tune_result_ = p;
  }
  return tune_result_;
}
...
inline void TuneResult::set_result_str(const char* value, size_t size) {

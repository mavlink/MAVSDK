...
inline bool ManualControlResult_Result_Parse(
    const std::string& name, ManualControlResult_Result* value) {
...
inline ::mavsdk::rpc::manual_control::ManualControlResult* StartPositionControlResponse::_internal_mutable_manual_control_result() {
  ...
  if (manual_control_result_ == nullptr) {
    auto* p = CreateMaybeMessage<::mavsdk::rpc::manual_control::ManualControlResult>(GetArenaNoVirtual());
...
inline void ManualControlResult::set_result_str(const char* value, size_t size) {

...
inline bool FailureResult_Result_Parse(
    const std::string& name, FailureResult_Result* value) {
...
inline bool FailureUnit_Parse(
    const std::string& name, FailureUnit* value) {
...
inline ::mavsdk::rpc::failure::FailureResult* InjectResponse::_internal_mutable_failure_result() {
  ...
  if (failure_result_ == nullptr) {
    auto* p = CreateMaybeMessage<::mavsdk::rpc::failure::FailureResult>(GetArenaNoVirtual());
    failure_result_ = p;
  }
...
inline void FailureResult::set_result_str(const char* value, size_t size) {

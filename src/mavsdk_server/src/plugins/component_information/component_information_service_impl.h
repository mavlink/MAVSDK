...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/component_information/component_information.proto)
...
template<typename ComponentInformation = ComponentInformation, typename LazyPlugin = LazyPlugin<ComponentInformation>>

class ComponentInformationServiceImpl final : public rpc::component_information::ComponentInformationService::Service {
public:
    ...
    void fillResponseWithResult(ResponseType* response, mavsdk::ComponentInformation::Result& result) const
    {
        auto rpc_result = translateToRpcResult(result);

        auto* rpc_component_information_result = new rpc::component_information::ComponentInformationResult();
    ...
    static std::unique_ptr<rpc::component_information::FloatParam> translateToRpcFloatParam(const mavsdk::ComponentInformation::FloatParam &float_param)
    {
    ...
    static mavsdk::ComponentInformation::FloatParam translateFromRpcFloatParam(const rpc::component_information::FloatParam& float_param)
    {
    ...
    static std::unique_ptr<rpc::component_information::FloatParamUpdate> translateToRpcFloatParamUpdate(const mavsdk::ComponentInformation::FloatParamUpdate &float_param_update)
    {
    ...
    static mavsdk::ComponentInformation::FloatParamUpdate translateFromRpcFloatParamUpdate(const rpc::component_information::FloatParamUpdate& float_param_update)
    {
    ...
    static rpc::component_information::ComponentInformationResult::Result translateToRpcResult(const mavsdk::ComponentInformation::Result& result)
    {
        switch (result) {
            default:
            ...
            case mavsdk::ComponentInformation::Result::NoSystem:
                return rpc::component_information::ComponentInformationResult_Result_RESULT_NO_SYSTEM;
        }
    }

    static mavsdk::ComponentInformation::Result translateFromRpcResult(const rpc::component_information::ComponentInformationResult::Result result)
    {
        switch (result) {
            default:
                LogErr() << "Unknown result enum value: " << static_cast<int>(result);
    ...
    grpc::Status SubscribeFloatParam(grpc::ServerContext* /* context */, const mavsdk::rpc::component_information::SubscribeFloatParamRequest* /* request */, grpc::ServerWriter<rpc::component_information::FloatParamResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::ComponentInformation::FloatParamHandle handle = _lazy_plugin.maybe_plugin()->subscribe_float_param(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::ComponentInformation::FloatParamUpdate float_param) {

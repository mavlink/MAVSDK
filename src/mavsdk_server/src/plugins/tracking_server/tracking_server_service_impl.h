...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/tracking_server/tracking_server.proto)
...
template<typename TrackingServer = TrackingServer, typename LazyServerPlugin = LazyServerPlugin<TrackingServer>>

class TrackingServerServiceImpl final : public rpc::tracking_server::TrackingServerService::Service {
public:
    ...
    void fillResponseWithResult(ResponseType* response, mavsdk::TrackingServer::Result& result) const
    {
    ...
    static rpc::tracking_server::CommandAnswer translateToRpcCommandAnswer(const mavsdk::TrackingServer::CommandAnswer& command_answer)
    {
    ...
    static mavsdk::TrackingServer::CommandAnswer translateFromRpcCommandAnswer(const rpc::tracking_server::CommandAnswer command_answer)
    {
        switch (command_answer) {
            default:
                LogErr() << "Unknown command_answer enum value: " << static_cast<int>(command_answer);
    ...
    static std::unique_ptr<rpc::tracking_server::TrackPoint> translateToRpcTrackPoint(const mavsdk::TrackingServer::TrackPoint &track_point)
    {
    ...
    static mavsdk::TrackingServer::TrackPoint translateFromRpcTrackPoint(const rpc::tracking_server::TrackPoint& track_point)
    {
    ...
    static std::unique_ptr<rpc::tracking_server::TrackRectangle> translateToRpcTrackRectangle(const mavsdk::TrackingServer::TrackRectangle &track_rectangle)
    {
    ...
    static mavsdk::TrackingServer::TrackRectangle translateFromRpcTrackRectangle(const rpc::tracking_server::TrackRectangle& track_rectangle)
    {
    ...
    static rpc::tracking_server::TrackingServerResult::Result translateToRpcResult(const mavsdk::TrackingServer::Result& result)
    {
        switch (result) {
            default:
    ...
    static mavsdk::TrackingServer::Result translateFromRpcResult(const rpc::tracking_server::TrackingServerResult::Result result)
    {
        switch (result) {
            default:
                LogErr() << "Unknown result enum value: " << static_cast<int>(result);
        ...
        rpc::tracking_server::SetTrackingPointStatusResponse* /* response */) override
    {
        ...
        _lazy_plugin.maybe_plugin()->set_tracking_point_status(translateFromRpcTrackPoint(request->tracked_point()));
    ...
    grpc::Status SubscribeTrackingPointCommand(grpc::ServerContext* /* context */, const mavsdk::rpc::tracking_server::SubscribeTrackingPointCommandRequest* /* request */, grpc::ServerWriter<rpc::tracking_server::TrackingPointCommandResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::TrackingServer::TrackingPointCommandHandle handle = _lazy_plugin.maybe_plugin()->subscribe_tracking_point_command(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::TrackingServer::TrackPoint tracking_point_command) {
    ...
    grpc::Status SubscribeTrackingRectangleCommand(grpc::ServerContext* /* context */, const mavsdk::rpc::tracking_server::SubscribeTrackingRectangleCommandRequest* /* request */, grpc::ServerWriter<rpc::tracking_server::TrackingRectangleCommandResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::TrackingServer::TrackingRectangleCommandHandle handle = _lazy_plugin.maybe_plugin()->subscribe_tracking_rectangle_command(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::TrackingServer::TrackRectangle tracking_rectangle_command) {
    ...
    grpc::Status SubscribeTrackingOffCommand(grpc::ServerContext* /* context */, const mavsdk::rpc::tracking_server::SubscribeTrackingOffCommandRequest* /* request */, grpc::ServerWriter<rpc::tracking_server::TrackingOffCommandResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::TrackingServer::TrackingOffCommandHandle handle = _lazy_plugin.maybe_plugin()->subscribe_tracking_off_command(
        ...
        rpc::tracking_server::RespondTrackingPointCommandResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_tracking_point_command(translateFromRpcCommandAnswer(request->command_answer()));
        ...
        rpc::tracking_server::RespondTrackingRectangleCommandResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_tracking_rectangle_command(translateFromRpcCommandAnswer(request->command_answer()));
        ...
        rpc::tracking_server::RespondTrackingOffCommandResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_tracking_off_command(translateFromRpcCommandAnswer(request->command_answer()));

...
template<typename TrackingServer = TrackingServer>
...
public:
        ...
        rpc::tracking_server::SetTrackingPointStatusResponse* /* response */) override
    {
        ...
        _tracking_server.set_tracking_point_status(translateFromRpcTrackPoint(request->tracked_point()));
        ...
        rpc::tracking_server::SetTrackingRectangleStatusResponse* /* response */) override
    {
        ...
        _tracking_server.set_tracking_rectangle_status(translateFromRpcTrackRectangle(request->tracked_rectangle()));
    ...
    grpc::Status SubscribeTrackingPointCommand(grpc::ServerContext* /* context */, const mavsdk::rpc::tracking_server::SubscribeTrackingPointCommandRequest* /* request */, grpc::ServerWriter<rpc::tracking_server::TrackingPointCommandResponse>* writer) override
    {
        ...
        _tracking_server.subscribe_tracking_point_command(
            [this, &writer, &stream_closed_promise, is_finished, &subscribe_mutex](const mavsdk::TrackingServer::TrackPoint tracking_point_command) {
    ...
    grpc::Status SubscribeTrackingRectangleCommand(grpc::ServerContext* /* context */, const mavsdk::rpc::tracking_server::SubscribeTrackingRectangleCommandRequest* /* request */, grpc::ServerWriter<rpc::tracking_server::TrackingRectangleCommandResponse>* writer) override
    {
        ...
        _tracking_server.subscribe_tracking_rectangle_command(
            [this, &writer, &stream_closed_promise, is_finished, &subscribe_mutex](const mavsdk::TrackingServer::TrackRectangle tracking_rectangle_command) {
    ...
    grpc::Status SubscribeTrackingOffCommand(grpc::ServerContext* /* context */, const mavsdk::rpc::tracking_server::SubscribeTrackingOffCommandRequest* /* request */, grpc::ServerWriter<rpc::tracking_server::TrackingOffCommandResponse>* writer) override
    {
        ...
        _tracking_server.subscribe_tracking_off_command(
            [this, &writer, &stream_closed_promise, is_finished, &subscribe_mutex](const int32_t tracking_off_command) {
        ...
        rpc::tracking_server::RespondTrackingPointCommandResponse* response) override
    {
        ...
        auto result = _tracking_server.respond_tracking_point_command(translateFromRpcCommandAnswer(request->command_answer()));
        ...
        rpc::tracking_server::RespondTrackingRectangleCommandResponse* response) override
    {
        ...
        auto result = _tracking_server.respond_tracking_rectangle_command(translateFromRpcCommandAnswer(request->command_answer()));
        ...
        rpc::tracking_server::RespondTrackingOffCommandResponse* response) override
    {
        ...
        auto result = _tracking_server.respond_tracking_off_command(translateFromRpcCommandAnswer(request->command_answer()));

...
template<typename ComponentInformationServer = ComponentInformationServer, typename LazyServerPlugin = LazyServerPlugin<ComponentInformationServer>>
...
public:
    ...
    grpc::Status SubscribeFloatParam(grpc::ServerContext* /* context */, const mavsdk::rpc::component_information_server::SubscribeFloatParamRequest* /* request */, grpc::ServerWriter<rpc::component_information_server::FloatParamResponse>* writer) override
    {
        ...
        const mavsdk::ComponentInformationServer::FloatParamHandle handle = _lazy_plugin.maybe_plugin()->subscribe_float_param(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::ComponentInformationServer::FloatParamUpdate float_param) {

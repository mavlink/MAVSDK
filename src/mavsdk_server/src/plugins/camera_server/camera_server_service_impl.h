...
public:
    ...
    static rpc::camera_server::TakePhotoFeedback translateToRpcTakePhotoFeedback(const mavsdk::CameraServer::TakePhotoFeedback& take_photo_feedback)
    {
        switch (take_photo_feedback) {
            default:
                LogErr() << "Unknown take_photo_feedback enum value: " << static_cast<int>(take_photo_feedback);
            // FALLTHROUGH
    ...
    static mavsdk::CameraServer::TakePhotoFeedback translateFromRpcTakePhotoFeedback(const rpc::camera_server::TakePhotoFeedback take_photo_feedback)
    {
        switch (take_photo_feedback) {
            default:
                LogErr() << "Unknown take_photo_feedback enum value: " << static_cast<int>(take_photo_feedback);
        ...
        rpc::camera_server::RespondTakePhotoResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_take_photo(translateFromRpcTakePhotoFeedback(request->take_photo_feedback()), translateFromRpcCaptureInfo(request->capture_info()));

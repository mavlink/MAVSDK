...
template<typename TelemetryServer = TelemetryServer, typename LazyPlugin = LazyPlugin<TelemetryServer>>
...
public:
    ...
    static rpc::telemetry_server::FlightMode translateToRpcFlightMode(const mavsdk::TelemetryServer::FlightMode& flight_mode)
    {
        switch (flight_mode) {
            default:
    ...
    static mavsdk::TelemetryServer::FlightMode translateFromRpcFlightMode(const rpc::telemetry_server::FlightMode flight_mode)
    {
        switch (flight_mode) {
            default:
                LogErr() << "Unknown flight_mode enum value: " << static_cast<int>(flight_mode);
    ...
    static std::unique_ptr<rpc::telemetry_server::Health> translateToRpcHealth(const mavsdk::TelemetryServer::Health &health)
    {
    ...
    static mavsdk::TelemetryServer::Health translateFromRpcHealth(const rpc::telemetry_server::Health& health)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::GpsGlobalOrigin> translateToRpcGpsGlobalOrigin(const mavsdk::TelemetryServer::GpsGlobalOrigin &gps_global_origin)
    {
        auto rpc_obj = std::make_unique<rpc::telemetry_server::GpsGlobalOrigin>();
    ...
    static mavsdk::TelemetryServer::GpsGlobalOrigin translateFromRpcGpsGlobalOrigin(const rpc::telemetry_server::GpsGlobalOrigin& gps_global_origin)
    {
        mavsdk::TelemetryServer::GpsGlobalOrigin obj;
        ...
        rpc::telemetry_server::PublishPositionResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_position(translateFromRpcPosition(request->position()), translateFromRpcVelocityNed(request->velocity_ned()));
        ...
        rpc::telemetry_server::PublishFlightModeResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_flight_mode(translateFromRpcFlightMode(request->flight_mode()));
    ...
    grpc::Status PublishHealth(
        grpc::ServerContext* /* context */,
        const rpc::telemetry_server::PublishHealthRequest* request,
        rpc::telemetry_server::PublishHealthResponse* response) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        if (request == nullptr) {
            LogWarn() << "PublishHealth sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        auto result = _lazy_plugin.maybe_plugin()->publish_health(translateFromRpcHealth(request->health()));
    ...
    grpc::Status PublishHealthAllOk(
        grpc::ServerContext* /* context */,
        const rpc::telemetry_server::PublishHealthAllOkRequest* request,
        rpc::telemetry_server::PublishHealthAllOkResponse* response) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        if (request == nullptr) {
            LogWarn() << "PublishHealthAllOk sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        auto result = _lazy_plugin.maybe_plugin()->publish_health_all_ok(request->is_health_all_ok());
    ...
    grpc::Status GetGpsGlobalOrigin(
        grpc::ServerContext* /* context */,
        const rpc::telemetry_server::GetGpsGlobalOriginRequest* /* request */,
        rpc::telemetry_server::GetGpsGlobalOriginResponse* response) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {

...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/telemetry_server/telemetry_server.proto)
...
template<typename TelemetryServer = TelemetryServer, typename LazyServerPlugin = LazyServerPlugin<TelemetryServer>>

class TelemetryServerServiceImpl final : public rpc::telemetry_server::TelemetryServerService::Service {
public:
    ...
    void fillResponseWithResult(ResponseType* response, mavsdk::TelemetryServer::Result& result) const
    {
    ...
    static rpc::telemetry_server::FixType translateToRpcFixType(const mavsdk::TelemetryServer::FixType& fix_type)
    {
        switch (fix_type) {
            default:
    ...
    static mavsdk::TelemetryServer::FixType translateFromRpcFixType(const rpc::telemetry_server::FixType fix_type)
    {
        switch (fix_type) {
            default:
                LogErr() << "Unknown fix_type enum value: " << static_cast<int>(fix_type);
    ...
    static rpc::telemetry_server::VtolState translateToRpcVtolState(const mavsdk::TelemetryServer::VtolState& vtol_state)
    {
        switch (vtol_state) {
            default:
    ...
    static mavsdk::TelemetryServer::VtolState translateFromRpcVtolState(const rpc::telemetry_server::VtolState vtol_state)
    {
        switch (vtol_state) {
            default:
                LogErr() << "Unknown vtol_state enum value: " << static_cast<int>(vtol_state);
    ...
    static rpc::telemetry_server::StatusTextType translateToRpcStatusTextType(const mavsdk::TelemetryServer::StatusTextType& status_text_type)
    {
    ...
    static mavsdk::TelemetryServer::StatusTextType translateFromRpcStatusTextType(const rpc::telemetry_server::StatusTextType status_text_type)
    {
        switch (status_text_type) {
            default:
                LogErr() << "Unknown status_text_type enum value: " << static_cast<int>(status_text_type);
    ...
    static rpc::telemetry_server::LandedState translateToRpcLandedState(const mavsdk::TelemetryServer::LandedState& landed_state)
    {
        switch (landed_state) {
            default:
    ...
    static mavsdk::TelemetryServer::LandedState translateFromRpcLandedState(const rpc::telemetry_server::LandedState landed_state)
    {
        switch (landed_state) {
            default:
                LogErr() << "Unknown landed_state enum value: " << static_cast<int>(landed_state);
    ...
    static std::unique_ptr<rpc::telemetry_server::Position> translateToRpcPosition(const mavsdk::TelemetryServer::Position &position)
    {
    ...
    static mavsdk::TelemetryServer::Position translateFromRpcPosition(const rpc::telemetry_server::Position& position)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::Heading> translateToRpcHeading(const mavsdk::TelemetryServer::Heading &heading)
    {
    ...
    static mavsdk::TelemetryServer::Heading translateFromRpcHeading(const rpc::telemetry_server::Heading& heading)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::Quaternion> translateToRpcQuaternion(const mavsdk::TelemetryServer::Quaternion &quaternion)
    {
    ...
    static mavsdk::TelemetryServer::Quaternion translateFromRpcQuaternion(const rpc::telemetry_server::Quaternion& quaternion)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::EulerAngle> translateToRpcEulerAngle(const mavsdk::TelemetryServer::EulerAngle &euler_angle)
    {
    ...
    static mavsdk::TelemetryServer::EulerAngle translateFromRpcEulerAngle(const rpc::telemetry_server::EulerAngle& euler_angle)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::AngularVelocityBody> translateToRpcAngularVelocityBody(const mavsdk::TelemetryServer::AngularVelocityBody &angular_velocity_body)
    {
    ...
    static mavsdk::TelemetryServer::AngularVelocityBody translateFromRpcAngularVelocityBody(const rpc::telemetry_server::AngularVelocityBody& angular_velocity_body)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::GpsInfo> translateToRpcGpsInfo(const mavsdk::TelemetryServer::GpsInfo &gps_info)
    {
    ...
    static mavsdk::TelemetryServer::GpsInfo translateFromRpcGpsInfo(const rpc::telemetry_server::GpsInfo& gps_info)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::RawGps> translateToRpcRawGps(const mavsdk::TelemetryServer::RawGps &raw_gps)
    {
    ...
    static mavsdk::TelemetryServer::RawGps translateFromRpcRawGps(const rpc::telemetry_server::RawGps& raw_gps)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::Battery> translateToRpcBattery(const mavsdk::TelemetryServer::Battery &battery)
    {
    ...
    static mavsdk::TelemetryServer::Battery translateFromRpcBattery(const rpc::telemetry_server::Battery& battery)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::RcStatus> translateToRpcRcStatus(const mavsdk::TelemetryServer::RcStatus &rc_status)
    {
    ...
    static mavsdk::TelemetryServer::RcStatus translateFromRpcRcStatus(const rpc::telemetry_server::RcStatus& rc_status)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::CellularStatus> translateToRpcCellularStatus(const mavsdk::TelemetryServer::CellularStatus &cellular_status)
    {
    ...
    static mavsdk::TelemetryServer::CellularStatus translateFromRpcCellularStatus(const rpc::telemetry_server::CellularStatus& cellular_status)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::ModemInfo> translateToRpcModemInfo(const mavsdk::TelemetryServer::ModemInfo &modem_info)
    {
        auto rpc_obj = std::make_unique<rpc::telemetry_server::ModemInfo>();
    ...
    static mavsdk::TelemetryServer::ModemInfo translateFromRpcModemInfo(const rpc::telemetry_server::ModemInfo& modem_info)
    {
        mavsdk::TelemetryServer::ModemInfo obj;
    ...
    static std::unique_ptr<rpc::telemetry_server::OnboardComputerStatus> translateToRpcOnboardComputerStatus(const mavsdk::TelemetryServer::OnboardComputerStatus &onboard_computer_status)
    {
        auto rpc_obj = std::make_unique<rpc::telemetry_server::OnboardComputerStatus>();
    ...
    static mavsdk::TelemetryServer::OnboardComputerStatus translateFromRpcOnboardComputerStatus(const rpc::telemetry_server::OnboardComputerStatus& onboard_computer_status)
    {
        mavsdk::TelemetryServer::OnboardComputerStatus obj;
    ...
    static std::unique_ptr<rpc::telemetry_server::ComponentInfoBasic> translateToRpcComponentInfoBasic(const mavsdk::TelemetryServer::ComponentInfoBasic &component_info_basic)
    {
        auto rpc_obj = std::make_unique<rpc::telemetry_server::ComponentInfoBasic>();
    ...
    static mavsdk::TelemetryServer::ComponentInfoBasic translateFromRpcComponentInfoBasic(const rpc::telemetry_server::ComponentInfoBasic& component_info_basic)
    {
        mavsdk::TelemetryServer::ComponentInfoBasic obj;
    ...
    static std::unique_ptr<rpc::telemetry_server::StatusText> translateToRpcStatusText(const mavsdk::TelemetryServer::StatusText &status_text)
    {
    ...
    static mavsdk::TelemetryServer::StatusText translateFromRpcStatusText(const rpc::telemetry_server::StatusText& status_text)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::ActuatorControlTarget> translateToRpcActuatorControlTarget(const mavsdk::TelemetryServer::ActuatorControlTarget &actuator_control_target)
    {
    ...
    static mavsdk::TelemetryServer::ActuatorControlTarget translateFromRpcActuatorControlTarget(const rpc::telemetry_server::ActuatorControlTarget& actuator_control_target)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::ActuatorOutputStatus> translateToRpcActuatorOutputStatus(const mavsdk::TelemetryServer::ActuatorOutputStatus &actuator_output_status)
    {
    ...
    static mavsdk::TelemetryServer::ActuatorOutputStatus translateFromRpcActuatorOutputStatus(const rpc::telemetry_server::ActuatorOutputStatus& actuator_output_status)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::Covariance> translateToRpcCovariance(const mavsdk::TelemetryServer::Covariance &covariance)
    {
    ...
    static mavsdk::TelemetryServer::Covariance translateFromRpcCovariance(const rpc::telemetry_server::Covariance& covariance)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::VelocityBody> translateToRpcVelocityBody(const mavsdk::TelemetryServer::VelocityBody &velocity_body)
    {
    ...
    static mavsdk::TelemetryServer::VelocityBody translateFromRpcVelocityBody(const rpc::telemetry_server::VelocityBody& velocity_body)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::PositionBody> translateToRpcPositionBody(const mavsdk::TelemetryServer::PositionBody &position_body)
    {
    ...
    static mavsdk::TelemetryServer::PositionBody translateFromRpcPositionBody(const rpc::telemetry_server::PositionBody& position_body)
    {
    ...
    static rpc::telemetry_server::Odometry::MavFrame translateToRpcMavFrame(const mavsdk::TelemetryServer::Odometry::MavFrame& mav_frame)
    {
        switch (mav_frame) {
            default:
    ...
    static mavsdk::TelemetryServer::Odometry::MavFrame translateFromRpcMavFrame(const rpc::telemetry_server::Odometry::MavFrame mav_frame)
    {
        switch (mav_frame) {
            default:
                LogErr() << "Unknown mav_frame enum value: " << static_cast<int>(mav_frame);
    ...
    static std::unique_ptr<rpc::telemetry_server::Odometry> translateToRpcOdometry(const mavsdk::TelemetryServer::Odometry &odometry)
    {
    ...
    static mavsdk::TelemetryServer::Odometry translateFromRpcOdometry(const rpc::telemetry_server::Odometry& odometry)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::DistanceSensor> translateToRpcDistanceSensor(const mavsdk::TelemetryServer::DistanceSensor &distance_sensor)
    {
    ...
    static mavsdk::TelemetryServer::DistanceSensor translateFromRpcDistanceSensor(const rpc::telemetry_server::DistanceSensor& distance_sensor)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::ScaledPressure> translateToRpcScaledPressure(const mavsdk::TelemetryServer::ScaledPressure &scaled_pressure)
    {
    ...
    static mavsdk::TelemetryServer::ScaledPressure translateFromRpcScaledPressure(const rpc::telemetry_server::ScaledPressure& scaled_pressure)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::PositionNed> translateToRpcPositionNed(const mavsdk::TelemetryServer::PositionNed &position_ned)
    {
    ...
    static mavsdk::TelemetryServer::PositionNed translateFromRpcPositionNed(const rpc::telemetry_server::PositionNed& position_ned)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::VelocityNed> translateToRpcVelocityNed(const mavsdk::TelemetryServer::VelocityNed &velocity_ned)
    {
    ...
    static mavsdk::TelemetryServer::VelocityNed translateFromRpcVelocityNed(const rpc::telemetry_server::VelocityNed& velocity_ned)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::PositionVelocityNed> translateToRpcPositionVelocityNed(const mavsdk::TelemetryServer::PositionVelocityNed &position_velocity_ned)
    {
    ...
    static mavsdk::TelemetryServer::PositionVelocityNed translateFromRpcPositionVelocityNed(const rpc::telemetry_server::PositionVelocityNed& position_velocity_ned)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::GroundTruth> translateToRpcGroundTruth(const mavsdk::TelemetryServer::GroundTruth &ground_truth)
    {
    ...
    static mavsdk::TelemetryServer::GroundTruth translateFromRpcGroundTruth(const rpc::telemetry_server::GroundTruth& ground_truth)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::FixedwingMetrics> translateToRpcFixedwingMetrics(const mavsdk::TelemetryServer::FixedwingMetrics &fixedwing_metrics)
    {
    ...
    static mavsdk::TelemetryServer::FixedwingMetrics translateFromRpcFixedwingMetrics(const rpc::telemetry_server::FixedwingMetrics& fixedwing_metrics)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::AccelerationFrd> translateToRpcAccelerationFrd(const mavsdk::TelemetryServer::AccelerationFrd &acceleration_frd)
    {
    ...
    static mavsdk::TelemetryServer::AccelerationFrd translateFromRpcAccelerationFrd(const rpc::telemetry_server::AccelerationFrd& acceleration_frd)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::AngularVelocityFrd> translateToRpcAngularVelocityFrd(const mavsdk::TelemetryServer::AngularVelocityFrd &angular_velocity_frd)
    {
    ...
    static mavsdk::TelemetryServer::AngularVelocityFrd translateFromRpcAngularVelocityFrd(const rpc::telemetry_server::AngularVelocityFrd& angular_velocity_frd)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::MagneticFieldFrd> translateToRpcMagneticFieldFrd(const mavsdk::TelemetryServer::MagneticFieldFrd &magnetic_field_frd)
    {
    ...
    static mavsdk::TelemetryServer::MagneticFieldFrd translateFromRpcMagneticFieldFrd(const rpc::telemetry_server::MagneticFieldFrd& magnetic_field_frd)
    {
    ...
    static std::unique_ptr<rpc::telemetry_server::Imu> translateToRpcImu(const mavsdk::TelemetryServer::Imu &imu)
    {
    ...
    static rpc::telemetry_server::TelemetryServerResult::Result translateToRpcResult(const mavsdk::TelemetryServer::Result& result)
    {
        switch (result) {
            default:
    ...
    static mavsdk::TelemetryServer::Result translateFromRpcResult(const rpc::telemetry_server::TelemetryServerResult::Result result)
    {
        switch (result) {
            default:
                LogErr() << "Unknown result enum value: " << static_cast<int>(result);
        ...
        rpc::telemetry_server::PublishPositionResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_position(translateFromRpcPosition(request->position()), translateFromRpcVelocityNed(request->velocity_ned()), translateFromRpcHeading(request->heading()));
        ...
        rpc::telemetry_server::PublishHomeResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_home(translateFromRpcPosition(request->home()));
        ...
        rpc::telemetry_server::PublishSysStatusResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_sys_status(translateFromRpcBattery(request->battery()), request->rc_receiver_status(), request->gyro_status(), request->accel_status(), request->mag_status(), request->gps_status());
        ...
        rpc::telemetry_server::PublishExtendedSysStateResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_extended_sys_state(translateFromRpcVtolState(request->vtol_state()), translateFromRpcLandedState(request->landed_state()));
        ...
        rpc::telemetry_server::PublishRawGpsResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_raw_gps(translateFromRpcRawGps(request->raw_gps()), translateFromRpcGpsInfo(request->gps_info()));
        ...
        rpc::telemetry_server::PublishBatteryResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_battery(translateFromRpcBattery(request->battery()));
        ...
        rpc::telemetry_server::PublishCellularStatusResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_cellular_status(translateFromRpcCellularStatus(request->cellular_status()));
    ...
    grpc::Status PublishModemInfo(
        grpc::ServerContext* /* context */,
        const rpc::telemetry_server::PublishModemInfoRequest* request,
        rpc::telemetry_server::PublishModemInfoResponse* response) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        if (request == nullptr) {
            LogWarn() << "PublishModemInfo sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        auto result = _lazy_plugin.maybe_plugin()->publish_modem_info(translateFromRpcModemInfo(request->modem_info()));
    ...
    grpc::Status PublishOnboardComputerStatus(
        grpc::ServerContext* /* context */,
        const rpc::telemetry_server::PublishOnboardComputerStatusRequest* request,
        rpc::telemetry_server::PublishOnboardComputerStatusResponse* response) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        if (request == nullptr) {
            LogWarn() << "PublishOnboardComputerStatus sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        auto result = _lazy_plugin.maybe_plugin()->publish_onboard_computer_status(translateFromRpcOnboardComputerStatus(request->obc_status()));
    ...
    grpc::Status PublishComponentInfoBasic(
        grpc::ServerContext* /* context */,
        const rpc::telemetry_server::PublishComponentInfoBasicRequest* request,
        rpc::telemetry_server::PublishComponentInfoBasicResponse* response) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        if (request == nullptr) {
            LogWarn() << "PublishComponentInfoBasic sent with a null request! Ignoring...";
            return grpc::Status::OK;
        }
            
        
        auto result = _lazy_plugin.maybe_plugin()->publish_component_info_basic(translateFromRpcComponentInfoBasic(request->component_info_basic()));
        ...
        rpc::telemetry_server::PublishStatusTextResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_status_text(translateFromRpcStatusText(request->status_text()));
        ...
        rpc::telemetry_server::PublishOdometryResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_odometry(translateFromRpcOdometry(request->odometry()));
        ...
        rpc::telemetry_server::PublishPositionVelocityNedResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_position_velocity_ned(translateFromRpcPositionVelocityNed(request->position_velocity_ned()));
        ...
        rpc::telemetry_server::PublishGroundTruthResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_ground_truth(translateFromRpcGroundTruth(request->ground_truth()));
        ...
        rpc::telemetry_server::PublishScaledImuResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_scaled_imu(translateFromRpcImu(request->imu()));
        ...
        rpc::telemetry_server::PublishRawImuResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_raw_imu(translateFromRpcImu(request->imu()));

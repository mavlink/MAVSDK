...
#include "camera_trigger_server/camera_trigger_server_service_impl.h"
...
public:
    GrpcServer(Mavsdk& mavsdk) :
        ...
        _camera_trigger_server_lazy_plugin(mavsdk),
        _camera_trigger_server_service(_camera_trigger_server_lazy_plugin),
...
private:
    ...
    LazyPlugin<CameraTriggerServer> _camera_trigger_server_lazy_plugin;
    CameraTriggerServerServiceImpl<> _camera_trigger_server_service;

...
class PlayTuneRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::mavsdk::rpc::tune::TuneDescription* release_tune_description();
...
class PlayTuneResponse final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::mavsdk::rpc::tune::TuneResult* release_tune_result();
...
inline void PlayTuneRequest::set_allocated_tune_description(::mavsdk::rpc::tune::TuneDescription* tune_description) {
  ...
  if (tune_description) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::mavsdk::rpc::tune::TuneDescription>::GetOwningArena(tune_description);
...
inline void PlayTuneResponse::set_allocated_tune_result(::mavsdk::rpc::tune::TuneResult* tune_result) {
  ...
  if (tune_result) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::mavsdk::rpc::tune::TuneResult>::GetOwningArena(tune_result);
    if (message_arena != submessage_arena) {
...
void TuneResult::set_result_str(ArgT0&& arg0, ArgT... args) {

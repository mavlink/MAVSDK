...
enum TuneResult_Result : int {
  ...
  TuneResult_Result_TuneResult_Result_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  TuneResult_Result_TuneResult_Result_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};

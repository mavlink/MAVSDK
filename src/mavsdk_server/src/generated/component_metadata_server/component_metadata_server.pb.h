...
#ifndef component_5fmetadata_5fserver_2fcomponent_5fmetadata_5fserver_2eproto_2epb_2eh
#define component_5fmetadata_5fserver_2fcomponent_5fmetadata_5fserver_2eproto_2epb_2eh
...
{
    return ::google::protobuf::internal::NameOfDenseEnum<MetadataType_descriptor, 0, 2>(
...
class SetMetadataResponse final : public ::google::protobuf::internal::ZeroFieldsBase
/* @@protoc_insertion_point(class_definition:mavsdk.rpc.component_metadata_server.SetMetadataResponse)
 */
{
public:
    ...
    void operator delete(SetMetadataResponse* msg, std::destroying_delete_t)
    {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(SetMetadataResponse));
    }
#endif

    template<typename = void>
    explicit PROTOBUF_CONSTEXPR
        SetMetadataResponse(::google::protobuf::internal::ConstantInitialized);

    inline SetMetadataResponse(const SetMetadataResponse& from) : SetMetadataResponse(nullptr, from)
    {}
    inline SetMetadataResponse(SetMetadataResponse&& from) noexcept :
        SetMetadataResponse(nullptr, std::move(from))
    {}
    ...
    static const SetMetadataResponse& default_instance() { return *internal_default_instance(); }
    ...
    friend void swap(SetMetadataResponse& a, SetMetadataResponse& b) { a.Swap(&b); }
    ...
    SetMetadataResponse* New(::google::protobuf::Arena* arena = nullptr) const
    {
        return ::google::protobuf::internal::ZeroFieldsBase::DefaultConstruct<SetMetadataResponse>(
            arena);
    }
...
protected:
    ...
    SetMetadataResponse(::google::protobuf::Arena* arena, SetMetadataResponse&& from) noexcept :
        SetMetadataResponse(arena)
    {
        *this = ::std::move(from);
    }
...
private:
    ...
    struct Impl_ {
        ...
        inline explicit Impl_(
            ...
            ::google::protobuf::Arena* arena,
            const Impl_& from,
            const SetMetadataResponse& from_msg);
...
/* @@protoc_insertion_point(class_definition:mavsdk.rpc.component_metadata_server.Metadata) */ {
public:
    ...
    static const Metadata& default_instance() { return *internal_default_instance(); }
...
protected:
    ...
    Metadata(::google::protobuf::Arena* arena, Metadata&& from) noexcept : Metadata(arena)
    {
        *this = ::std::move(from);
    }
    const ::google::protobuf::internal::ClassData* GetClassData() const PROTOBUF_FINAL;
...
class SetMetadataRequest final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:mavsdk.rpc.component_metadata_server.SetMetadataRequest)
 */
{
public:
    inline SetMetadataRequest() : SetMetadataRequest(nullptr) {}
    ~SetMetadataRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(SetMetadataRequest* msg, std::destroying_delete_t)
    {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(SetMetadataRequest));
    }
#endif

    template<typename = void>
    explicit PROTOBUF_CONSTEXPR
        SetMetadataRequest(::google::protobuf::internal::ConstantInitialized);

    inline SetMetadataRequest(const SetMetadataRequest& from) : SetMetadataRequest(nullptr, from) {}
    inline SetMetadataRequest(SetMetadataRequest&& from) noexcept :
        SetMetadataRequest(nullptr, std::move(from))
    {}
    ...
    static const SetMetadataRequest& default_instance() { return *internal_default_instance(); }
    static inline const SetMetadataRequest* internal_default_instance()
    {
        return reinterpret_cast<const SetMetadataRequest*>(&_SetMetadataRequest_default_instance_);
    }
    static constexpr int kIndexInFileMessages = 0;
    friend void swap(SetMetadataRequest& a, SetMetadataRequest& b) { a.Swap(&b); }
    ...
    SetMetadataRequest* New(::google::protobuf::Arena* arena = nullptr) const
    {
        return ::google::protobuf::Message::DefaultConstruct<SetMetadataRequest>(arena);
    }
    using ::google::protobuf::Message::CopyFrom;
    void CopyFrom(const SetMetadataRequest& from);
    using ::google::protobuf::Message::MergeFrom;
    void MergeFrom(const SetMetadataRequest& from) { SetMetadataRequest::MergeImpl(*this, from); }
...
protected:
    ...
    SetMetadataRequest(::google::protobuf::Arena* arena, SetMetadataRequest&& from) noexcept :
        SetMetadataRequest(arena)
    {
        *this = ::std::move(from);
    }
    const ::google::protobuf::internal::ClassData* GetClassData() const PROTOBUF_FINAL;
...
private:
    ...
    struct Impl_ {
        ...
        inline explicit Impl_(
            ...
            ::google::protobuf::Arena* arena,
            const Impl_& from,
            const SetMetadataRequest& from_msg);
        ::google::protobuf::RepeatedPtrField<::mavsdk::rpc::component_metadata_server::Metadata>
            metadata_;
        ::google::protobuf::internal::CachedSize _cached_size_;
        PROTOBUF_TSAN_DECLARE_MEMBER
...
inline ::mavsdk::rpc::component_metadata_server::Metadata*
SetMetadataRequest::mutable_metadata(int index) ABSL_ATTRIBUTE_LIFETIME_BOUND
{
...
SetMetadataRequest::mutable_metadata() ABSL_ATTRIBUTE_LIFETIME_BOUND
{
    // @@protoc_insertion_point(field_mutable_list:mavsdk.rpc.component_metadata_server.SetMetadataRequest.metadata)
    ::google::protobuf::internal::TSanWrite(&_impl_);
    return _internal_mutable_metadata();
}
inline const ::mavsdk::rpc::component_metadata_server::Metadata&
SetMetadataRequest::metadata(int index) const ABSL_ATTRIBUTE_LIFETIME_BOUND
{
...
inline ::mavsdk::rpc::component_metadata_server::Metadata*
SetMetadataRequest::add_metadata() ABSL_ATTRIBUTE_LIFETIME_BOUND
{
    ::google::protobuf::internal::TSanWrite(&_impl_);
...
SetMetadataRequest::metadata() const ABSL_ATTRIBUTE_LIFETIME_BOUND
{
...
inline void
Metadata::_internal_set_type(::mavsdk::rpc::component_metadata_server::MetadataType value)
{
    ::google::protobuf::internal::TSanWrite(&_impl_);
    _impl_.type_ = value;
}
...
inline const std::string& Metadata::json_metadata() const ABSL_ATTRIBUTE_LIFETIME_BOUND
{
...
inline PROTOBUF_ALWAYS_INLINE void Metadata::set_json_metadata(Arg_&& arg, Args_... args)
{
    ::google::protobuf::internal::TSanWrite(&_impl_);
...
GetEnumDescriptor<::mavsdk::rpc::component_metadata_server::MetadataType>()
{
...
#endif // component_5fmetadata_5fserver_2fcomponent_5fmetadata_5fserver_2eproto_2epb_2eh

...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    SetMetadataResponseDefaultTypeInternal _SetMetadataResponse_default_instance_;

inline constexpr Metadata::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept :
    json_metadata_(
...
inline constexpr SetMetadataRequest::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept :
    metadata_{},
    _cached_size_{0}
{}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    SetMetadataRequestDefaultTypeInternal _SetMetadataRequest_default_instance_;
} // namespace component_metadata_server
} // namespace rpc
} // namespace mavsdk
...
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_component_5fmetadata_5fserver_2fcomponent_5fmetadata_5fserver_2eproto =
        nullptr;
const ::uint32_t TableStruct_component_5fmetadata_5fserver_2fcomponent_5fmetadata_5fserver_2eproto::
    offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ~0u, // no _has_bits_
        PROTOBUF_FIELD_OFFSET(
            ::mavsdk::rpc::component_metadata_server::SetMetadataRequest, _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ...
        ~0u, // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(
            ::mavsdk::rpc::component_metadata_server::SetMetadataRequest, _impl_.metadata_),
        ~0u, // no _has_bits_
        PROTOBUF_FIELD_OFFSET(
            ::mavsdk::rpc::component_metadata_server::SetMetadataResponse, _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ~0u, // no _weak_field_map_
        ~0u, // no _inlined_string_donated_
        ...
        ~0u, // no _has_bits_
        PROTOBUF_FIELD_OFFSET(
            ::mavsdk::rpc::component_metadata_server::Metadata, _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ~0u, // no _weak_field_map_
        ~0u, // no _inlined_string_donated_
        ...
        PROTOBUF_FIELD_OFFSET(
            ::mavsdk::rpc::component_metadata_server::Metadata, _impl_.json_metadata_),
};
...
static const ::_pbi::DescriptorTable* const
    descriptor_table_component_5fmetadata_5fserver_2fcomponent_5fmetadata_5fserver_2eproto_deps[1] =
        {
...
inline PROTOBUF_NDEBUG_INLINE SetMetadataRequest::Impl_::Impl_(
    ...
    const Impl_& from,
    const ::mavsdk::rpc::component_metadata_server::SetMetadataRequest& from_msg) :
    metadata_{visibility, arena, from.metadata_},
    _cached_size_{0}
{}

SetMetadataRequest::SetMetadataRequest(
    ::google::protobuf::Arena* arena, const SetMetadataRequest& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    :
    ::google::protobuf::Message(arena, _class_data_.base())
{
...
inline void*
SetMetadataRequest::PlacementNew_(const void*, void* mem, ::google::protobuf::Arena* arena)
{
...
constexpr auto SetMetadataRequest::InternalNewImpl_()
{
    constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
        PROTOBUF_FIELD_OFFSET(SetMetadataRequest, _impl_.metadata_) +
            decltype(SetMetadataRequest::_impl_.metadata_)::InternalGetArenaOffset(
    ...
    if (arena_bits.has_value()) {
        ...
        return ::google::protobuf::internal::MessageCreator(
            &SetMetadataRequest::PlacementNew_,
...
const ::google::protobuf::internal::ClassDataFull SetMetadataRequest::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        ...
        ::google::protobuf::Message::GetClearImpl<SetMetadataRequest>(),
        &SetMetadataRequest::ByteSizeLong,
    ...
    SetMetadataRequest::_table_ = {
        {
            ...
            ::_pbi::TcParser::GetTable<
                ::mavsdk::rpc::component_metadata_server::SetMetadataRequest>(), // to_prefetch
    ...
    ::uint8_t* target, ::google::protobuf::io::EpsCopyOutputStream* stream) const
{
    ...
    // repeated .mavsdk.rpc.component_metadata_server.Metadata metadata = 1;
    for (unsigned i = 0, n = static_cast<unsigned>(this_._internal_metadata_size()); i < n; i++) {
...
void SetMetadataRequest::MergeImpl(
...
SetMetadataResponse::SetMetadataResponse(
    ::google::protobuf::Arena* arena, const SetMetadataResponse& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    :
    ::google::protobuf::internal::ZeroFieldsBase(arena, _class_data_.base())
{
...
inline void*
SetMetadataResponse::PlacementNew_(const void*, void* mem, ::google::protobuf::Arena* arena)
{
...
{
    return ::google::protobuf::internal::MessageCreator::ZeroInit(
        sizeof(SetMetadataResponse), alignof(SetMetadataResponse));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull SetMetadataResponse::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        ...
        ::google::protobuf::internal::ZeroFieldsBase::GetClearImpl<SetMetadataResponse>(),
        &SetMetadataResponse::ByteSizeLong,
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::mavsdk::rpc::component_metadata_server::SetMetadataResponse>(), // to_prefetch
#endif // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
...
inline PROTOBUF_NDEBUG_INLINE Metadata::Impl_::Impl_(
    ...
    ::google::protobuf::Arena* arena,
    const Impl_& from,
    const ::mavsdk::rpc::component_metadata_server::Metadata& from_msg) :
    json_metadata_(arena, from.json_metadata_),
    _cached_size_{0}
{}

Metadata::Metadata(::google::protobuf::Arena* arena, const Metadata& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    :
    ::google::protobuf::Message(arena, _class_data_.base())
{
...
inline void* Metadata::PlacementNew_(const void*, void* mem, ::google::protobuf::Arena* arena)
{
...
constexpr auto Metadata::InternalNewImpl_()
{
    return ::google::protobuf::internal::MessageCreator::CopyInit(
        sizeof(Metadata), alignof(Metadata));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &Metadata::SharedDtor,
        ::google::protobuf::Message::GetClearImpl<Metadata>(),
        &Metadata::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<1, 2, 0, 67, 2>
    Metadata::_table_ = {
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::mavsdk::rpc::component_metadata_server::Metadata>(), // to_prefetch
#endif // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
            ...
            {::_pbi::TcParser::
                 SingularVarintNoZag1<::uint32_t, offsetof(Metadata, _impl_.type_), 63>(),
        ...
        {{
            ...
            // string json_metadata = 2;
            {PROTOBUF_FIELD_OFFSET(Metadata, _impl_.json_metadata_),
             0,
             0,

...
enum ComponentInformationResult_Result : int {
  ...
  ComponentInformationResult_Result_ComponentInformationResult_Result_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ComponentInformationResult_Result_ComponentInformationResult_Result_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class AccessFloatParamsRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mavsdk.rpc.component_information.AccessFloatParamsRequest) */ {
 public:
  inline AccessFloatParamsRequest() : AccessFloatParamsRequest(nullptr) {}
  ~AccessFloatParamsRequest() override;
  explicit constexpr AccessFloatParamsRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline AccessFloatParamsRequest* New() const final {
    return new AccessFloatParamsRequest();
  }

  AccessFloatParamsRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<AccessFloatParamsRequest>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const AccessFloatParamsRequest& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AccessFloatParamsRequest* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
...
class AccessFloatParamsResponse final :
 ...
 public:
  ...
  explicit constexpr AccessFloatParamsResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline AccessFloatParamsResponse* New() const final {
    return new AccessFloatParamsResponse();
  }

  AccessFloatParamsResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  PROTOBUF_MUST_USE_RESULT ::mavsdk::rpc::component_information::ComponentInformationResult* release_component_information_result();
...
class SubscribeFloatParamRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mavsdk.rpc.component_information.SubscribeFloatParamRequest) */ {
 public:
...
class FloatParamResponse final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::mavsdk::rpc::component_information::FloatParamUpdate* release_param_update();
...
class ComponentInformationResult final :
 ...
 public:
  ...
  explicit constexpr ComponentInformationResult(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline ComponentInformationResult* New() const final {
    return new ComponentInformationResult();
  }

  ComponentInformationResult* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline void AccessFloatParamsResponse::set_allocated_component_information_result(::mavsdk::rpc::component_information::ComponentInformationResult* component_information_result) {
  ...
  if (component_information_result) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::mavsdk::rpc::component_information::ComponentInformationResult>::GetOwningArena(component_information_result);
...
inline void FloatParamResponse::set_allocated_param_update(::mavsdk::rpc::component_information::FloatParamUpdate* param_update) {
  ...
  if (param_update) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::mavsdk::rpc::component_information::FloatParamUpdate>::GetOwningArena(param_update);
    if (message_arena != submessage_arena) {

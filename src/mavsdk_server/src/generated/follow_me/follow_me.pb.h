...
enum FollowMeResult_Result : int {
  ...
  FollowMeResult_Result_FollowMeResult_Result_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  FollowMeResult_Result_FollowMeResult_Result_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool FollowMeResult_Result_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, FollowMeResult_Result* value) {
...
inline void SetConfigResponse::unsafe_arena_set_allocated_follow_me_result(
    ::mavsdk::rpc::follow_me::FollowMeResult* follow_me_result) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(follow_me_result_);
  }
...
void FollowMeResult::set_result_str(ArgT0&& arg0, ArgT... args) {

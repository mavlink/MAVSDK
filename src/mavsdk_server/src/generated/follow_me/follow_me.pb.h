...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_follow_5fme_2ffollow_5fme_2eproto_metadata_getter(int index);
namespace mavsdk {
namespace rpc {
namespace follow_me {
class Config;
...
class Config PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_follow_5fme_2ffollow_5fme_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class TargetLocation PROTOBUF_FINAL :
...
class SetConfigRequest PROTOBUF_FINAL :
...
class SetConfigResponse PROTOBUF_FINAL :
...
class SetTargetLocationRequest PROTOBUF_FINAL :
...
class SetTargetLocationResponse PROTOBUF_FINAL :
...
class GetLastLocationRequest PROTOBUF_FINAL :
...
class GetLastLocationResponse PROTOBUF_FINAL :
...
class FollowMeResult PROTOBUF_FINAL :
...
inline void SetConfigResponse::set_allocated_follow_me_result(::mavsdk::rpc::follow_me::FollowMeResult* follow_me_result) {
  ...
  if (follow_me_result) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(follow_me_result);
    if (message_arena != submessage_arena) {

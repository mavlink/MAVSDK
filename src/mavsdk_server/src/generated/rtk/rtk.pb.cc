...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 1, 0, 36, 2>
    RtcmData::_table_ = {
        {
            0, // no _has_bits_
            0, // no _extensions_
        ...
        {{
            // string data = 1;
            {::_pbi::TcParser::FastUS1, {10, 63, 0, PROTOBUF_FIELD_OFFSET(RtcmData, _impl_.data_)}},
        }},
        {{65535, 65535}},
        {{
            // string data = 1;
            {PROTOBUF_FIELD_OFFSET(RtcmData, _impl_.data_),
             0,
             0,

...
class SendStatusTextRequest final :
 ...
 public:
  ...
  inline SendStatusTextRequest* New() const final {
    return new SendStatusTextRequest();
  }
...
class SendStatusTextResponse final :
 ...
 public:
  ...
  inline SendStatusTextResponse* New() const final {
    return new SendStatusTextResponse();
  }
  ...
  PROTOBUF_MUST_USE_RESULT ::mavsdk::rpc::server_utility::ServerUtilityResult* release_server_utility_result();
...
inline void SendStatusTextResponse::set_allocated_server_utility_result(::mavsdk::rpc::server_utility::ServerUtilityResult* server_utility_result) {
  ...
  if (server_utility_result) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::mavsdk::rpc::server_utility::ServerUtilityResult>::GetOwningArena(server_utility_result);

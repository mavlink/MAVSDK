...
#ifndef mavsdk_5foptions_2eproto_2epb_2eh
#define mavsdk_5foptions_2eproto_2epb_2eh
...
template<typename T> const std::string& AsyncType_Name(T value)
{
    static_assert(
        std::is_same<T, AsyncType>::value || std::is_integral<T>::value,
        "Incorrect type passed to AsyncType_Name().");
    return AsyncType_Name(static_cast<AsyncType>(value));
}
template<> inline const std::string& AsyncType_Name(AsyncType value)
{
    return ::google::protobuf::internal::NameOfDenseEnum<AsyncType_descriptor, 0, 2>(
...
extern ::google::protobuf::internal::ExtensionIdentifier<
    ::google::protobuf::FieldOptions,
    ::google::protobuf::internal::PrimitiveTypeTraits<double>,
    1,
    false>
    epsilon;
...
extern ::google::protobuf::internal::ExtensionIdentifier<
    ...
    ::google::protobuf::internal::
        EnumTypeTraits<::mavsdk::options::AsyncType, ::mavsdk::options::AsyncType_IsValid>,
    14,
    false>
    async_type;
...
template<> inline const EnumDescriptor* GetEnumDescriptor<::mavsdk::options::AsyncType>()
{
...
#endif // mavsdk_5foptions_2eproto_2epb_2eh

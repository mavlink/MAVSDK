...
::grpc::Status TelemetryServerService::Stub::PublishCellularStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishCellularStatusRequest& request, ::mavsdk::rpc::telemetry_server::PublishCellularStatusResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::mavsdk::rpc::telemetry_server::PublishCellularStatusRequest, ::mavsdk::rpc::telemetry_server::PublishCellularStatusResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_PublishCellularStatus_, context, request, response);
}

void TelemetryServerService::Stub::async::PublishCellularStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishCellularStatusRequest* request, ::mavsdk::rpc::telemetry_server::PublishCellularStatusResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::mavsdk::rpc::telemetry_server::PublishCellularStatusRequest, ::mavsdk::rpc::telemetry_server::PublishCellularStatusResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PublishCellularStatus_, context, request, response, std::move(f));
}

void TelemetryServerService::Stub::async::PublishCellularStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishCellularStatusRequest* request, ::mavsdk::rpc::telemetry_server::PublishCellularStatusResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_PublishCellularStatus_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::mavsdk::rpc::telemetry_server::PublishCellularStatusResponse>* TelemetryServerService::Stub::PrepareAsyncPublishCellularStatusRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::telemetry_server::PublishCellularStatusRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::mavsdk::rpc::telemetry_server::PublishCellularStatusResponse, ::mavsdk::rpc::telemetry_server::PublishCellularStatusRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_PublishCellularStatus_, context, request);
}
...
TelemetryServerService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< TelemetryServerService::Service, ::mavsdk::rpc::telemetry_server::PublishCellularStatusRequest, ::mavsdk::rpc::telemetry_server::PublishCellularStatusResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](TelemetryServerService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::mavsdk::rpc::telemetry_server::PublishCellularStatusRequest* req,
             ::mavsdk::rpc::telemetry_server::PublishCellularStatusResponse* resp) {
               return service->PublishCellularStatus(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(

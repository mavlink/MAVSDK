...
enum ShellResult_Result : int {
  ...
  ShellResult_Result_ShellResult_Result_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ShellResult_Result_ShellResult_Result_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
void SendRequest::set_command(ArgT0&& arg0, ArgT... args) {
 ...
 command_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());

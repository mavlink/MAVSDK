...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_shell_2fshell_2eproto_metadata_getter(int index);
namespace mavsdk {
namespace rpc {
namespace shell {
...
class SendRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_shell_2fshell_2eproto_metadata_getter(kIndexInFileMessages);
  }

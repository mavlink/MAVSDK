...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_log_5ffiles_2flog_5ffiles_2eproto_metadata_getter(int index);
namespace mavsdk {
namespace rpc {
namespace log_files {
...
class GetEntriesRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_log_5ffiles_2flog_5ffiles_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class GetEntriesResponse PROTOBUF_FINAL :
...
class SubscribeDownloadLogFileRequest PROTOBUF_FINAL :
...
class DownloadLogFileResponse PROTOBUF_FINAL :
...
class LogFilesResult PROTOBUF_FINAL :

...
enum LogFilesResult_Result : int {
  ...
  LogFilesResult_Result_LogFilesResult_Result_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  LogFilesResult_Result_LogFilesResult_Result_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class DownloadLogFileRequest final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR DownloadLogFileRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  DownloadLogFileRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {

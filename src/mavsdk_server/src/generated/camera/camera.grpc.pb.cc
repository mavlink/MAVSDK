...
static const char* CameraService_method_names[] = {
  ...
  "/mavsdk.rpc.camera.CameraService/GetStatus",
...
CameraService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_SubscribeStatus_(CameraService_method_names[15], options.suffix_for_stats(),::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_GetStatus_(CameraService_method_names[16], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status CameraService::Stub::GetStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest& request, ::mavsdk::rpc::camera::GetStatusResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::mavsdk::rpc::camera::GetStatusRequest, ::mavsdk::rpc::camera::GetStatusResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetStatus_, context, request, response);
}

void CameraService::Stub::async::GetStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest* request, ::mavsdk::rpc::camera::GetStatusResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::mavsdk::rpc::camera::GetStatusRequest, ::mavsdk::rpc::camera::GetStatusResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetStatus_, context, request, response, std::move(f));
}

void CameraService::Stub::async::GetStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest* request, ::mavsdk::rpc::camera::GetStatusResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::mavsdk::rpc::camera::GetStatusResponse>* CameraService::Stub::PrepareAsyncGetStatusRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::mavsdk::rpc::camera::GetStatusResponse, ::mavsdk::rpc::camera::GetStatusRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetStatus_, context, request);
}

::grpc::ClientAsyncResponseReader< ::mavsdk::rpc::camera::GetStatusResponse>* CameraService::Stub::AsyncGetStatusRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
CameraService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< CameraService::Service, ::mavsdk::rpc::camera::GetStatusRequest, ::mavsdk::rpc::camera::GetStatusResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](CameraService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::mavsdk::rpc::camera::GetStatusRequest* req,
             ::mavsdk::rpc::camera::GetStatusResponse* resp) {
...
::grpc::Status CameraService::Service::GetStatus(::grpc::ServerContext* context, const ::mavsdk::rpc::camera::GetStatusRequest* request, ::mavsdk::rpc::camera::GetStatusResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");

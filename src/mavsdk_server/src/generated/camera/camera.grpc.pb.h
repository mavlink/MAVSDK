 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    //
    // Get camera status.
    virtual ::grpc::Status GetStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest& request, ::mavsdk::rpc::camera::GetStatusResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::mavsdk::rpc::camera::GetStatusResponse>> AsyncGetStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::mavsdk::rpc::camera::GetStatusResponse>>(AsyncGetStatusRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::mavsdk::rpc::camera::GetStatusResponse>> PrepareAsyncGetStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::mavsdk::rpc::camera::GetStatusResponse>>(PrepareAsyncGetStatusRaw(context, request, cq));
    }
    //
    ...
    class async_interface {
     public:
      ...
      //
      // Get camera status.
      virtual void GetStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest* request, ::mavsdk::rpc::camera::GetStatusResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest* request, ::mavsdk::rpc::camera::GetStatusResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      //
      // Get the list of current camera settings.
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::mavsdk::rpc::camera::GetStatusResponse>* AsyncGetStatusRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::mavsdk::rpc::camera::GetStatusResponse>* PrepareAsyncGetStatusRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status GetStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest& request, ::mavsdk::rpc::camera::GetStatusResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::mavsdk::rpc::camera::GetStatusResponse>> AsyncGetStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::mavsdk::rpc::camera::GetStatusResponse>>(AsyncGetStatusRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::mavsdk::rpc::camera::GetStatusResponse>> PrepareAsyncGetStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::mavsdk::rpc::camera::GetStatusResponse>>(PrepareAsyncGetStatusRaw(context, request, cq));
    }
    ...
    class async final :
     ...
     public:
      ...
      void GetStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest* request, ::mavsdk::rpc::camera::GetStatusResponse* response, std::function<void(::grpc::Status)>) override;
      void GetStatus(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest* request, ::mavsdk::rpc::camera::GetStatusResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::mavsdk::rpc::camera::GetStatusResponse>* AsyncGetStatusRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::mavsdk::rpc::camera::GetStatusResponse>* PrepareAsyncGetStatusRaw(::grpc::ClientContext* context, const ::mavsdk::rpc::camera::GetStatusRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    //
    // Get camera status.
    virtual ::grpc::Status GetStatus(::grpc::ServerContext* context, const ::mavsdk::rpc::camera::GetStatusRequest* request, ::mavsdk::rpc::camera::GetStatusResponse* response);
    //
    // Get the list of current camera settings.
  ...
  class WithAsyncMethod_GetStatus : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetStatus(::grpc::ServerContext* /*context*/, const ::mavsdk::rpc::camera::GetStatusRequest* /*request*/, ::mavsdk::rpc::camera::GetStatusResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestGetStatus(::grpc::ServerContext* context, ::mavsdk::rpc::camera::GetStatusRequest* request, ::grpc::ServerAsyncResponseWriter< ::mavsdk::rpc::camera::GetStatusResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithCallbackMethod_GetStatus() {
      ::grpc::Service::MarkMethodCallback(16,
          new ::grpc::internal::CallbackUnaryHandler< ::mavsdk::rpc::camera::GetStatusRequest, ::mavsdk::rpc::camera::GetStatusResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::mavsdk::rpc::camera::GetStatusRequest* request, ::mavsdk::rpc::camera::GetStatusResponse* response) { return this->GetStatus(context, request, response); }));}
    void SetMessageAllocatorFor_GetStatus(
        ::grpc::MessageAllocator< ::mavsdk::rpc::camera::GetStatusRequest, ::mavsdk::rpc::camera::GetStatusResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(16);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::mavsdk::rpc::camera::GetStatusRequest, ::mavsdk::rpc::camera::GetStatusResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* GetStatus(
      ::grpc::CallbackServerContext* /*context*/, const ::mavsdk::rpc::camera::GetStatusRequest* /*request*/, ::mavsdk::rpc::camera::GetStatusResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_GetStatus() {
      ::grpc::Service::MarkMethodStreamed(16,
        new ::grpc::internal::StreamedUnaryHandler<
          ::mavsdk::rpc::camera::GetStatusRequest, ::mavsdk::rpc::camera::GetStatusResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::mavsdk::rpc::camera::GetStatusRequest, ::mavsdk::rpc::camera::GetStatusResponse>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedGetStatus(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::mavsdk::rpc::camera::GetStatusRequest,::mavsdk::rpc::camera::GetStatusResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>

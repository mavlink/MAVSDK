...
class SubscribeConnectionStateRequest final :
 ...
 public:
  ...
  ~SubscribeConnectionStateRequest() override;
  ...
  inline SubscribeConnectionStateRequest* New() const final {
    return new SubscribeConnectionStateRequest();
  }
...
class ConnectionStateResponse final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::mavsdk::rpc::core::ConnectionState* release_connection_state();
...
class SetMavlinkTimeoutRequest final :
 ...
 public:
  ...
  inline SetMavlinkTimeoutRequest* New() const final {
    return new SetMavlinkTimeoutRequest();
  }
...
class SetMavlinkTimeoutResponse final :
 ...
 public:
  ...
  ~SetMavlinkTimeoutResponse() override;
  ...
  inline SetMavlinkTimeoutResponse* New() const final {
    return new SetMavlinkTimeoutResponse();
  }
...
inline void ConnectionStateResponse::set_allocated_connection_state(::mavsdk::rpc::core::ConnectionState* connection_state) {
  ...
  if (connection_state) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::mavsdk::rpc::core::ConnectionState>::GetOwningArena(connection_state);

...
enum ManualControlResult_Result : int {
  ...
  ManualControlResult_Result_ManualControlResult_Result_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ManualControlResult_Result_ManualControlResult_Result_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};

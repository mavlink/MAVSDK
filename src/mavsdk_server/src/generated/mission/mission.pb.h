...
enum MissionItem_CameraAction : int {
  ...
  MissionItem_CameraAction_MissionItem_CameraAction_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  MissionItem_CameraAction_MissionItem_CameraAction_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
constexpr MissionResult_Result MissionResult_Result_Result_MAX = MissionResult_Result_RESULT_INT_MESSAGES_NOT_SUPPORTED;
...
class MissionResult final :
 ...
 public:
  ...
  static constexpr Result RESULT_PROTOCOL_ERROR =
    MissionResult_Result_RESULT_PROTOCOL_ERROR;

...
inline constexpr TransponderResult::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept :
    result_str_(
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    TransponderResultDefaultTypeInternal _TransponderResult_default_instance_;
template<typename>
PROTOBUF_CONSTEXPR
SubscribeTransponderRequest::SubscribeTransponderRequest(::_pbi::ConstantInitialized)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    :
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    SubscribeTransponderRequestDefaultTypeInternal _SubscribeTransponderRequest_default_instance_;

inline constexpr SetRateTransponderRequest::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept :
    rate_hz_{0},
    _cached_size_{0}
{}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    SetRateTransponderRequestDefaultTypeInternal _SetRateTransponderRequest_default_instance_;

inline constexpr AdsbVehicle::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept :
    callsign_(
        &::google::protobuf::internal::fixed_address_empty_string, ::_pbi::ConstantInitialized()),
    latitude_deg_{0},
    icao_address_{0u},
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    AdsbVehicleDefaultTypeInternal _AdsbVehicle_default_instance_;

inline constexpr TransponderResponse::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept :
    _cached_size_{0},
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    TransponderResponseDefaultTypeInternal _TransponderResponse_default_instance_;

inline constexpr SetRateTransponderResponse::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept :
    _cached_size_{0},
...
template<typename>
PROTOBUF_CONSTEXPR
    SetRateTransponderResponse::SetRateTransponderResponse(::_pbi::ConstantInitialized)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    :
    ::google::protobuf::Message(_class_data_.base()),
#else // PROTOBUF_CUSTOM_VTABLE
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    SetRateTransponderResponseDefaultTypeInternal _SetRateTransponderResponse_default_instance_;
} // namespace transponder
} // namespace rpc
} // namespace mavsdk
static const ::_pb::EnumDescriptor*
    file_level_enum_descriptors_transponder_2ftransponder_2eproto[3];
...
const ::uint32_t
    TableStruct_transponder_2ftransponder_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(
            ::mavsdk::rpc::transponder::SubscribeTransponderRequest, _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ...
        ~0u, // no _has_bits_
        PROTOBUF_FIELD_OFFSET(
            ::mavsdk::rpc::transponder::SetRateTransponderRequest, _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ~0u, // no _weak_field_map_
        ~0u, // no _inlined_string_donated_
        ...
        ~0u, // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(
            ::mavsdk::rpc::transponder::SetRateTransponderRequest, _impl_.rate_hz_),
        PROTOBUF_FIELD_OFFSET(
            ::mavsdk::rpc::transponder::SetRateTransponderResponse, _impl_._has_bits_),
        PROTOBUF_FIELD_OFFSET(
            ::mavsdk::rpc::transponder::SetRateTransponderResponse, _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ~0u, // no _weak_field_map_
        ~0u, // no _inlined_string_donated_
        ...
        ~0u, // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(
            ::mavsdk::rpc::transponder::SetRateTransponderResponse, _impl_.transponder_result_),
        0,
        ~0u, // no _has_bits_
        ...
        PROTOBUF_FIELD_OFFSET(
            ::mavsdk::rpc::transponder::AdsbVehicle, _impl_.horizontal_velocity_m_s_),
        PROTOBUF_FIELD_OFFSET(
            ::mavsdk::rpc::transponder::AdsbVehicle, _impl_.vertical_velocity_m_s_),
...
const char
    descriptor_table_protodef_transponder_2ftransponder_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
...
inline void*
SubscribeTransponderRequest::PlacementNew_(const void*, void* mem, ::google::protobuf::Arena* arena)
{
...
constexpr auto SubscribeTransponderRequest::InternalNewImpl_()
{
    return ::google::protobuf::internal::MessageCreator::ZeroInit(
        sizeof(SubscribeTransponderRequest), alignof(SubscribeTransponderRequest));
}
PROTOBUF_CONSTINIT
...
const ::google::protobuf::internal::ClassDataFull SubscribeTransponderRequest::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        ...
        ::google::protobuf::internal::ZeroFieldsBase::GetClearImpl<SubscribeTransponderRequest>(),
        &SubscribeTransponderRequest::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 0, 0, 0, 2>
    SubscribeTransponderRequest::_table_ = {
        {
            0, // no _has_bits_
            0, // no _extensions_
            0,
            ...
            ::_pbi::TcParser::GetTable<
                ::mavsdk::rpc::transponder::SubscribeTransponderRequest>(), // to_prefetch
...
inline PROTOBUF_NDEBUG_INLINE TransponderResponse::Impl_::Impl_(
    ...
    const Impl_& from,
    const ::mavsdk::rpc::transponder::TransponderResponse& from_msg) :
    _has_bits_{from._has_bits_},
    _cached_size_{0}
{}

TransponderResponse::TransponderResponse(
    ::google::protobuf::Arena* arena, const TransponderResponse& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    :
    ::google::protobuf::Message(arena, _class_data_.base())
{
    ...
    ::google::protobuf::Message(arena)
{
    ...
    _impl_.transponder_ =
        (cached_has_bits & 0x00000001u) ?
            ::google::protobuf::Message::CopyConstruct<::mavsdk::rpc::transponder::AdsbVehicle>(
...
inline void*
TransponderResponse::PlacementNew_(const void*, void* mem, ::google::protobuf::Arena* arena)
{
...
{
    return ::google::protobuf::internal::MessageCreator::ZeroInit(
        sizeof(TransponderResponse), alignof(TransponderResponse));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull TransponderResponse::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        ...
        ::google::protobuf::Message::GetClearImpl<TransponderResponse>(),
        &TransponderResponse::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 1, 1, 0, 2>
    TransponderResponse::_table_ = {
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::mavsdk::rpc::transponder::TransponderResponse>(), // to_prefetch
#endif // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
        ...
        {{
            // .mavsdk.rpc.transponder.AdsbVehicle transponder = 1;
            {PROTOBUF_FIELD_OFFSET(TransponderResponse, _impl_.transponder_),
    ...
    ::uint8_t* target, ::google::protobuf::io::EpsCopyOutputStream* stream) const
{
    ...
    if (cached_has_bits & 0x00000001u) {
        target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
            1,
            *this_._impl_.transponder_,
            this_._impl_.transponder_->GetCachedSize(),
            target,
            stream);
    }
...
void TransponderResponse::MergeImpl(
...
inline void*
SetRateTransponderRequest::PlacementNew_(const void*, void* mem, ::google::protobuf::Arena* arena)
{
...
{
    return ::google::protobuf::internal::MessageCreator::ZeroInit(
        sizeof(SetRateTransponderRequest), alignof(SetRateTransponderRequest));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull SetRateTransponderRequest::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        ...
        ::google::protobuf::Message::GetClearImpl<SetRateTransponderRequest>(),
        &SetRateTransponderRequest::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 1, 0, 0, 2>
    SetRateTransponderRequest::_table_ = {
        {
            0, // no _has_bits_
            0, // no _extensions_
            1,
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::mavsdk::rpc::transponder::SetRateTransponderRequest>(), // to_prefetch
#endif // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
            // double rate_hz = 1;
        ...
        {{
            // double rate_hz = 1;
            {PROTOBUF_FIELD_OFFSET(SetRateTransponderRequest, _impl_.rate_hz_),
             0,
             0,
    ...
    ::uint8_t* target, ::google::protobuf::io::EpsCopyOutputStream* stream) const
{
    ...
    if (::absl::bit_cast<::uint64_t>(this_._internal_rate_hz()) != 0) {
        ...
        target = ::_pbi::WireFormatLite::WriteDoubleToArray(1, this_._internal_rate_hz(), target);
    }
...
void SetRateTransponderRequest::MergeImpl(
    ::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg)
{
...
inline PROTOBUF_NDEBUG_INLINE SetRateTransponderResponse::Impl_::Impl_(
    ...
    ::google::protobuf::Arena* arena,
    const Impl_& from,
    const ::mavsdk::rpc::transponder::SetRateTransponderResponse& from_msg) :
    _has_bits_{from._has_bits_},
    _cached_size_{0}
{}
...
inline void*
SetRateTransponderResponse::PlacementNew_(const void*, void* mem, ::google::protobuf::Arena* arena)
{
...
{
    return ::google::protobuf::internal::MessageCreator::ZeroInit(
        sizeof(SetRateTransponderResponse), alignof(SetRateTransponderResponse));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull SetRateTransponderResponse::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        ...
        ::google::protobuf::Message::GetClearImpl<SetRateTransponderResponse>(),
        &SetRateTransponderResponse::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 1, 1, 0, 2>
    SetRateTransponderResponse::_table_ = {
        {
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::mavsdk::rpc::transponder::SetRateTransponderResponse>(), // to_prefetch
#endif // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
            ...
            {::_pbi::TcParser::FastMtS1,
             {10,
              0,
              0,
              PROTOBUF_FIELD_OFFSET(SetRateTransponderResponse, _impl_.transponder_result_)}},
        }},
        {{65535, 65535}},
        {{
            // .mavsdk.rpc.transponder.TransponderResult transponder_result = 1;
    ...
    ::uint8_t* target, ::google::protobuf::io::EpsCopyOutputStream* stream) const
{
    ...
    if (cached_has_bits & 0x00000001u) {
        target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
            1,
            *this_._impl_.transponder_result_,
            this_._impl_.transponder_result_->GetCachedSize(),
            target,
            stream);
    }
...
void SetRateTransponderResponse::MergeImpl(
    ::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg)
{
    ...
    if (cached_has_bits & 0x00000001u) {
        ...
        if (_this->_impl_.transponder_result_ == nullptr) {
            _this->_impl_.transponder_result_ = ::google::protobuf::Message::CopyConstruct<
                ::mavsdk::rpc::transponder::TransponderResult>(
                arena, *from._impl_.transponder_result_);
        } else {
...
inline PROTOBUF_NDEBUG_INLINE AdsbVehicle::Impl_::Impl_(
    ...
    ::google::protobuf::Arena* arena,
    const Impl_& from,
    const ::mavsdk::rpc::transponder::AdsbVehicle& from_msg) :
    callsign_(arena, from.callsign_),
    _cached_size_{0}
{}

AdsbVehicle::AdsbVehicle(::google::protobuf::Arena* arena, const AdsbVehicle& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    :
    ::google::protobuf::Message(arena, _class_data_.base())
{
    ...
    ::google::protobuf::Message(arena)
{
    ...
    ::memcpy(
        ...
        reinterpret_cast<const char*>(&from._impl_) + offsetof(Impl_, latitude_deg_),
        offsetof(Impl_, tslc_s_) - offsetof(Impl_, latitude_deg_) + sizeof(Impl_::tslc_s_));
...
inline void* AdsbVehicle::PlacementNew_(const void*, void* mem, ::google::protobuf::Arena* arena)
{
...
constexpr auto AdsbVehicle::InternalNewImpl_()
{
    return ::google::protobuf::internal::MessageCreator::CopyInit(
        sizeof(AdsbVehicle), alignof(AdsbVehicle));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull AdsbVehicle::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        ...
        ::google::protobuf::Message::GetClearImpl<AdsbVehicle>(),
        &AdsbVehicle::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<4, 12, 0, 59, 2>
    AdsbVehicle::_table_ = {
        {
            0, // no _has_bits_
            0, // no _extensions_
        ...
        {{
            ...
            {::_pbi::TcParser::SingularVarintNoZag1<
                 ::uint32_t,
                 offsetof(AdsbVehicle, _impl_.icao_address_),
                 63>(),
            ...
            {::_pbi::TcParser::SingularVarintNoZag1<
                 ::uint32_t,
                 offsetof(AdsbVehicle, _impl_.altitude_type_),
                 63>(),
            ...
            {::_pbi::TcParser::SingularVarintNoZag1<
                 ::uint32_t,
                 offsetof(AdsbVehicle, _impl_.emitter_type_),
                 63>(),
            ...
            // uint32 squawk = 13;
            {::_pbi::TcParser::
                 SingularVarintNoZag1<::uint32_t, offsetof(AdsbVehicle, _impl_.squawk_), 63>(),
             {104, 63, 0, PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.squawk_)}},
            // uint32 tslc_s = 14;
            {::_pbi::TcParser::
                 SingularVarintNoZag1<::uint32_t, offsetof(AdsbVehicle, _impl_.tslc_s_), 63>(),
        ...
        {{
            // uint32 icao_address = 1;
            {PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.icao_address_),
             0,
             0,
            ...
            {PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.latitude_deg_),
             ...
             (0 | ::_fl::kFcSingular | ::_fl::kDouble)},
            // double longitude_deg = 3;
            {PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.longitude_deg_),
             0,
             0,
             (0 | ::_fl::kFcSingular | ::_fl::kDouble)},
            // .mavsdk.rpc.transponder.AdsbAltitudeType altitude_type = 4;
            {PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.altitude_type_),
             0,
             0,
             (0 | ::_fl::kFcSingular | ::_fl::kOpenEnum)},
            // float absolute_altitude_m = 5;
            {PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.absolute_altitude_m_),
             0,
             0,
             (0 | ::_fl::kFcSingular | ::_fl::kFloat)},
            // float heading_deg = 6;
            {PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.heading_deg_),
             0,
             0,
             (0 | ::_fl::kFcSingular | ::_fl::kFloat)},
            // float horizontal_velocity_m_s = 7;
            {PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.horizontal_velocity_m_s_),
             0,
             0,
             (0 | ::_fl::kFcSingular | ::_fl::kFloat)},
            // float vertical_velocity_m_s = 8;
            {PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.vertical_velocity_m_s_),
             0,
             0,
             (0 | ::_fl::kFcSingular | ::_fl::kFloat)},
            // string callsign = 9;
            {PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.callsign_),
             0,
             0,
             (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
            // .mavsdk.rpc.transponder.AdsbEmitterType emitter_type = 10;
            {PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.emitter_type_),
             0,
             0,
             (0 | ::_fl::kFcSingular | ::_fl::kOpenEnum)},
            // uint32 squawk = 13;
            {PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.squawk_),
             0,
             0,
             (0 | ::_fl::kFcSingular | ::_fl::kUInt32)},
            // uint32 tslc_s = 14;
    ...
    ::uint8_t* target, ::google::protobuf::io::EpsCopyOutputStream* stream) const
{
    ...
    if (this_._internal_icao_address() != 0) {
        target = stream->EnsureSpace(target);
        target =
            ::_pbi::WireFormatLite::WriteUInt32ToArray(1, this_._internal_icao_address(), target);
    }
    ...
    if (this_._internal_altitude_type() != 0) {
        target = stream->EnsureSpace(target);
        target =
            ::_pbi::WireFormatLite::WriteEnumToArray(4, this_._internal_altitude_type(), target);
    }
    ...
    if (::absl::bit_cast<::uint32_t>(this_._internal_heading_deg()) != 0) {
        target = stream->EnsureSpace(target);
        target =
            ::_pbi::WireFormatLite::WriteFloatToArray(6, this_._internal_heading_deg(), target);
    }
    ...
    if (this_._internal_emitter_type() != 0) {
        target = stream->EnsureSpace(target);
        target =
            ::_pbi::WireFormatLite::WriteEnumToArray(10, this_._internal_emitter_type(), target);
    }

    // uint32 squawk = 13;
    if (this_._internal_squawk() != 0) {
        target = stream->EnsureSpace(target);
        target = ::_pbi::WireFormatLite::WriteUInt32ToArray(13, this_._internal_squawk(), target);
    }

    // uint32 tslc_s = 14;
    if (this_._internal_tslc_s() != 0) {
        target = stream->EnsureSpace(target);
        target = ::_pbi::WireFormatLite::WriteUInt32ToArray(14, this_._internal_tslc_s(), target);
    }
...
::size_t AdsbVehicle::ByteSizeLong() const
{
    ...
    ::_pbi::Prefetch5LinesFrom7Lines(&this_);
    {
        ...
        // uint32 icao_address = 1;
        if (this_._internal_icao_address() != 0) {
            total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this_._internal_icao_address());
        }
        // .mavsdk.rpc.transponder.AdsbAltitudeType altitude_type = 4;
        if (this_._internal_altitude_type() != 0) {
        ...
        // .mavsdk.rpc.transponder.AdsbEmitterType emitter_type = 10;
        if (this_._internal_emitter_type() != 0) {
            total_size += 1 + ::_pbi::WireFormatLite::EnumSize(this_._internal_emitter_type());
        }
        // uint32 squawk = 13;
        if (this_._internal_squawk() != 0) {
            total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this_._internal_squawk());
        }
        // uint32 tslc_s = 14;
        if (this_._internal_tslc_s() != 0) {
            total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this_._internal_tslc_s());
        }
    }
    return this_.MaybeComputeUnknownFieldsSize(total_size, &this_._impl_._cached_size_);
}

void AdsbVehicle::MergeImpl(
    ::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg)
{
...
void AdsbVehicle::InternalSwap(AdsbVehicle* PROTOBUF_RESTRICT other)
{
    ...
    ::google::protobuf::internal::memswap<
        PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.tslc_s_) + sizeof(AdsbVehicle::_impl_.tslc_s_) -
        PROTOBUF_FIELD_OFFSET(AdsbVehicle, _impl_.latitude_deg_)>(
        reinterpret_cast<char*>(&_impl_.latitude_deg_),
...
inline PROTOBUF_NDEBUG_INLINE TransponderResult::Impl_::Impl_(
    ...
    ::google::protobuf::Arena* arena,
    const Impl_& from,
    const ::mavsdk::rpc::transponder::TransponderResult& from_msg) :
    result_str_(arena, from.result_str_),
    _cached_size_{0}
{}

TransponderResult::TransponderResult(
    ::google::protobuf::Arena* arena, const TransponderResult& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    :
    ::google::protobuf::Message(arena, _class_data_.base())
{
...
inline void*
TransponderResult::PlacementNew_(const void*, void* mem, ::google::protobuf::Arena* arena)
{
...
{
    return ::google::protobuf::internal::MessageCreator::CopyInit(
        sizeof(TransponderResult), alignof(TransponderResult));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull TransponderResult::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        ...
        ::google::protobuf::Message::GetClearImpl<TransponderResult>(),
        &TransponderResult::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<1, 2, 0, 59, 2>
    TransponderResult::_table_ = {
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::mavsdk::rpc::transponder::TransponderResult>(), // to_prefetch
#endif // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
            // string result_str = 2;
            ...
            {::_pbi::TcParser::SingularVarintNoZag1<
                 ::uint32_t,
                 offsetof(TransponderResult, _impl_.result_),
                 63>(),
        ...
        {{
            // .mavsdk.rpc.transponder.TransponderResult.Result result = 1;
            {PROTOBUF_FIELD_OFFSET(TransponderResult, _impl_.result_),
             0,
             0,
             (0 | ::_fl::kFcSingular | ::_fl::kOpenEnum)},
            // string result_str = 2;
            {PROTOBUF_FIELD_OFFSET(TransponderResult, _impl_.result_str_),
             0,
             0,
             (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
        }},
...
void TransponderResult::MergeImpl(
    ::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg)
{

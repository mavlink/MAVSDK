...
enum TransponderResult_Result : int {
  ...
  TransponderResult_Result_TransponderResult_Result_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  TransponderResult_Result_TransponderResult_Result_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class AdsbVehicle final :
 ...
 public:
  ...
  // .mavsdk.rpc.transponder.AdsbAltitudeType altitude_type = 15;
...
inline bool TransponderResponse::_internal_has_transponder() const {
  return this != internal_default_instance() && _impl_.transponder_ != nullptr;
}
...
inline void TransponderResponse::clear_transponder() {
  if (GetArenaForAllocation() == nullptr && _impl_.transponder_ != nullptr) {
...
inline bool SetRateTransponderResponse::_internal_has_transponder_result() const {
  return this != internal_default_instance() && _impl_.transponder_result_ != nullptr;
}
...
inline void SetRateTransponderResponse::clear_transponder_result() {
  if (GetArenaForAllocation() == nullptr && _impl_.transponder_result_ != nullptr) {
...
// float altitude_m = 5;
inline void AdsbVehicle::clear_altitude_m() {
  _impl_.altitude_m_ = 0;
}
inline float AdsbVehicle::_internal_altitude_m() const {
  return _impl_.altitude_m_;
}
inline float AdsbVehicle::altitude_m() const {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.transponder.AdsbVehicle.altitude_m)
  return _internal_altitude_m();
}
inline void AdsbVehicle::_internal_set_altitude_m(float value) {
  
  _impl_.altitude_m_ = value;
}
inline void AdsbVehicle::set_altitude_m(float value) {
  _internal_set_altitude_m(value);
  // @@protoc_insertion_point(field_set:mavsdk.rpc.transponder.AdsbVehicle.altitude_m)
}

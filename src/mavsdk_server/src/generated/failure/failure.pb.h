...
class InjectResponse final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::mavsdk::rpc::failure::FailureResult* release_failure_result();
...
inline void InjectResponse::set_allocated_failure_result(::mavsdk::rpc::failure::FailureResult* failure_result) {
  ...
  if (failure_result) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::mavsdk::rpc::failure::FailureResult>::GetOwningArena(failure_result);
...
void FailureResult::set_result_str(ArgT0&& arg0, ArgT... args) {

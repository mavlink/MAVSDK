...
inline std::string* ListDirectoryResponse::add_paths() ABSL_ATTRIBUTE_LIFETIME_BOUND
{
    ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline const std::string&
ListDirectoryResponse::paths(int index) const ABSL_ATTRIBUTE_LIFETIME_BOUND
{
    // @@protoc_insertion_point(field_get:mavsdk.rpc.ftp.ListDirectoryResponse.paths)
    return _internal_paths().Get(index);
}
inline std::string* ListDirectoryResponse::mutable_paths(int index) ABSL_ATTRIBUTE_LIFETIME_BOUND
{
...
template<typename Arg_, typename... Args_>
inline void ListDirectoryResponse::set_paths(int index, Arg_&& value, Args_... args)
{
    ::google::protobuf::internal::AssignToString(
        *_internal_mutable_paths()->Mutable(index), std::forward<Arg_>(value), args...);
    // @@protoc_insertion_point(field_set:mavsdk.rpc.ftp.ListDirectoryResponse.paths)
}
template<typename Arg_, typename... Args_>
inline void ListDirectoryResponse::add_paths(Arg_&& value, Args_... args)
{
    ::google::protobuf::internal::TSanWrite(&_impl_);
    ::google::protobuf::internal::AddToRepeatedPtrField(
        *_internal_mutable_paths(), std::forward<Arg_>(value), args...);

...
ManualControl::ManualControl(std::shared_ptr<System> system) : PluginBase(), _impl{new ManualControlImpl(system)} {}

ManualControl::ManualControl(SystemImpl* system_impl) : PluginBase(), _impl{new ManualControlImpl(system_impl)} {}

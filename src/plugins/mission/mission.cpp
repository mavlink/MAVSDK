...
void Mission::import_qgroundcontrol_mission_async(std::string qgc_plan_path, const ImportQgroundcontrolMissionCallback callback)
{
...
std::pair<Mission::Result, Mission::MissionPlan> Mission::import_qgroundcontrol_mission(std::string qgc_plan_path) const
{

...
public:
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::FlightMode const& flight_mode);
    ...
    /**
     * @brief Equal operator to compare two `TelemetryServer::GpsGlobalOrigin` objects.
     *
     * @return `true` if items are equal.
     */
    friend bool operator==(const TelemetryServer::GpsGlobalOrigin& lhs, const TelemetryServer::GpsGlobalOrigin& rhs);

    /**
     * @brief Stream operator to print information about a `TelemetryServer::GpsGlobalOrigin`.
     *
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, TelemetryServer::GpsGlobalOrigin const& gps_global_origin);
     ...
     */
    void publish_position_async(Position position, VelocityNed velocity_ned, const ResultCallback callback);
     ...
     *
     * This function is non-blocking. See 'publish_position_velocity_ned' for the blocking counterpart.
     */
    void publish_position_velocity_ned_async(PositionVelocityNed position_velocity_ned, const ResultCallback callback);
     ...
     * @brief Publish to 'position velocity' updates.
     *
     * This function is blocking. See 'publish_position_velocity_ned_async' for the non-blocking counterpart.
     *
     * @return Result of request.
     */
     ...
     * @brief Publish to 'HealthAllOk' updates.
     *
     * This function is blocking. See 'publish_health_all_ok_async' for the non-blocking counterpart.
     *
     * @return Result of request.
     */
     ...
     * @brief Publish to 'unix epoch time' updates.
     *
     * This function is blocking. See 'publish_unix_epoch_time_async' for the non-blocking counterpart.
     *
     * @return Result of request.
     */
    ...
    */
     ...
     * @return Result of request.
     */
    std::pair<Result, TelemetryServer::GpsGlobalOrigin> get_gps_global_origin() const;

...
using GpsGlobalOrigin = TelemetryServer::GpsGlobalOrigin;



TelemetryServer::TelemetryServer(System& system) : PluginBase(), _impl{std::make_unique<TelemetryServerImpl>(system)} {}

TelemetryServer::TelemetryServer(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<TelemetryServerImpl>(system)} {}

TelemetryServer::~TelemetryServer() {}



void TelemetryServer::publish_position_async(Position position, VelocityNed velocity_ned, const ResultCallback callback)
{
...
TelemetryServer::Result TelemetryServer::publish_position(Position position, VelocityNed velocity_ned) const
{
...
void TelemetryServer::publish_raw_gps_async(RawGps raw_gps, GpsInfo gps_info, const ResultCallback callback)
{
...
void TelemetryServer::publish_flight_mode_async(FlightMode flight_mode, const ResultCallback callback)
{
...
void TelemetryServer::publish_status_text_async(StatusText status_text, const ResultCallback callback)
{
...
void TelemetryServer::publish_position_velocity_ned_async(PositionVelocityNed position_velocity_ned, const ResultCallback callback)
{
...
void TelemetryServer::publish_ground_truth_async(GroundTruth ground_truth, const ResultCallback callback)
{
...
void TelemetryServer::publish_health_all_ok_async(bool is_health_all_ok, const ResultCallback callback)
{
...
void TelemetryServer::get_gps_global_origin_async(const GetGpsGlobalOriginCallback callback)
{
...
std::pair<TelemetryServer::Result, TelemetryServer::GpsGlobalOrigin> TelemetryServer::get_gps_global_origin() const
{
...
bool operator==(const TelemetryServer::GpsGlobalOrigin& lhs, const TelemetryServer::GpsGlobalOrigin& rhs)
{
    return
        ((std::isnan(rhs.latitude_deg) && std::isnan(lhs.latitude_deg)) || rhs.latitude_deg == lhs.latitude_deg) &&
        ((std::isnan(rhs.longitude_deg) && std::isnan(lhs.longitude_deg)) || rhs.longitude_deg == lhs.longitude_deg) &&
...
std::ostream& operator<<(std::ostream& str, TelemetryServer::GpsGlobalOrigin const& gps_global_origin)
{
    str << std::setprecision(15);

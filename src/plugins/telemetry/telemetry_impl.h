...
public:
    ...
    Telemetry::Result set_rate_vfr_hud(double rate_hz);
    ...
    void set_rate_vfr_hud_async(double rate_hz, Telemetry::result_callback_t callback);
    ...
    void vfr_hud_async(Telemetry::vfr_hud_callback_t& callback);
...
private:
    ...
    void process_vfr_hud(const mavlink_message_t& message);
    ...
    Telemetry::vfr_hud_callback_t _vfr_hud_subscription{nullptr};

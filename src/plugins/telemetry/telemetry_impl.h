...
public:
    ...
    Telemetry::Result set_rate_fixed_wing_metrics(double rate_hz);
    ...
    void set_rate_fixed_wing_metrics_async(double rate_hz, Telemetry::result_callback_t callback);
    ...
    Telemetry::FixedwingMetrics get_fixed_wing_metrics() const;
    ...
    void fixed_wing_metrics_async(Telemetry::fixed_wing_metrics_callback_t& callback);
...
private:
    ...
    void set_fixed_wing_metrics(Telemetry::FixedwingMetrics fixed_wing_metrics);
    ...
    void process_fixed_wing_metrics(const mavlink_message_t& message);
    ...
    mutable std::mutex _fixed_wing_metrics_mutex{};
    Telemetry::FixedwingMetrics _fixed_wing_metrics{NAN, NAN, NAN};
    ...
    Telemetry::fixed_wing_metrics_callback_t _fixed_wing_metrics_subscription{nullptr};

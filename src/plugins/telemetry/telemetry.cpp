...
Telemetry::Telemetry(std::shared_ptr<System> system) : PluginBase(), _impl{new TelemetryImpl(system)} {}

Telemetry::Telemetry(SystemImpl* system_impl) : PluginBase(), _impl{new TelemetryImpl(system_impl)} {}

...
public:
    ...
    MOCK_CONST_METHOD1(
        subscribe_video_stream_info, void(Camera::subscribe_video_stream_info_callback_t)){};
    ...
    MOCK_CONST_METHOD1(
        subscribe_current_settings, void(Camera::subscribe_current_settings_callback_t)){};
    MOCK_CONST_METHOD1(

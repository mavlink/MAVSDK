...
public:
    ...
    std::pair<ParamServer::Result, int32_t> get_param_int(std::string name);

    ParamServer::Result set_param_int(std::string name, int32_t value);

    std::pair<ParamServer::Result, float> get_param_float(std::string name);

    ParamServer::Result set_param_float(std::string name, float value);

    ParamServer::AllParams get_all_params();

...
MissionRaw::MissionRaw(std::shared_ptr<System> system) : PluginBase(), _impl{new MissionRawImpl(system)} {}

MissionRaw::MissionRaw(SystemImpl* system_impl) : PluginBase(), _impl{new MissionRawImpl(system_impl)} {}

...
private:
    ...
    Avoidance::WaypointsTrajectory get_trajectory_representation_waypoints() const;
    ...
    Avoidance::WaypointsTrajectory _trajectory_representation_waypoints {};

    Avoidance::trajectory_representation_waypoints_callback_t _trajectory_representation_waypoints_subscription{nullptr};

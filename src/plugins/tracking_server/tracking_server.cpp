...
TrackingServer::TrackingServer(std::shared_ptr<System> system) : PluginBase(), _impl{new TrackingServerImpl(system)} {}

TrackingServer::TrackingServer(SystemImpl* system_impl) : PluginBase(), _impl{new TrackingServerImpl(system_impl)} {}

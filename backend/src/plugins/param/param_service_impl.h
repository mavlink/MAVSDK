...
public:
    ...
    grpc::Status 
    GetIntParam(grpc::ServerContext * /* context */,
    ...
    grpc::Status 
    SetIntParam(grpc::ServerContext * /* context */,
                ...
                rpc::param::SetIntParamResponse *response) override
    {
        if (request != nullptr) {
            ...
            const auto param_result = _param.set_param_int(requested_param_name, requested_param_value);

            if (response != nullptr) {
                auto *rpc_param_result = new rpc::param::ParamResult();
                rpc_param_result->set_result(static_cast<rpc::param::ParamResult::Result>(param_result));
    ...
    grpc::Status 
    GetFloatParam(grpc::ServerContext * /* context */,
    ...
    grpc::Status 
    SetFloatParam(grpc::ServerContext * /* context */,
                ...
                rpc::param::SetFloatParamResponse *response) override
    {
        if (request != nullptr) {
            ...
            const auto param_result = _param.set_param_float(requested_param_name, requested_param_value);

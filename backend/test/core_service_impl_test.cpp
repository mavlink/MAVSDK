...
void
CoreServiceImplTest::checkPluginIsRunning(const std::string plugin_name)
{
...
std::future<void>
CoreServiceImplTest::subscribeDiscoverAsync(std::vector<uint64_t> &uuids)
{
...
std::future<void>
CoreServiceImplTest::subscribeTimeoutAsync(int *stream_count)
{

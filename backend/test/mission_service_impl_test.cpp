...
std::future<void>
MissionServiceImplUploadTest::uploadMissionAndSaveParams(
...
std::shared_ptr<UploadMissionRequest>
MissionServiceImplUploadTest::generateUploadRequest(
...
MissionServiceImplUploadTest::generateListOfOneItem()
{
    std::vector<std::shared_ptr<dc::MissionItem>> mission_items;
...
void
MissionServiceImplUploadTest::checkItemsAreUploadedCorrectly(
    std::vector<std::shared_ptr<dc::MissionItem>> &mission_items)
{
    auto request = generateUploadRequest(mission_items);
...
std::future<void>
MissionServiceImplStartTest::startMissionAndSaveParams(
...
void
MissionServiceImplIsFinishedTest::checkReturnsCorrectFinishedStatus(
...
std::future<void>
MissionServiceImplPauseTest::pauseMissionAndSaveParams(

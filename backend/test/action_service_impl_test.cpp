...
std::string
armAndGetTranslatedResult(const dronecore::ActionResult arm_result)
{
    MockAction action;
...
std::string
disarmAndGetTranslatedResult(dronecore::ActionResult disarm_result)
{
    MockAction action;
...
std::string
takeoffAndGetTranslatedResult(const dronecore::ActionResult takeoff_result)
{
    MockAction action;
...
std::string
landAndGetTranslatedResult(const dronecore::ActionResult land_result)
{
    MockAction action;
...
std::string
killAndGetTranslatedResult(const dronecore::ActionResult kill_result)
{
    MockAction action;
...
std::string
returnToLaunchAndGetTranslatedResult(const dronecore::ActionResult rtl_result)
{
    MockAction action;

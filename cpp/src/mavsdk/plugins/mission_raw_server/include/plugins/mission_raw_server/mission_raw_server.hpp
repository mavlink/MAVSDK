...
public:
     ...
     */
    friend MAVSDK_PUBLIC bool operator==(const MissionRawServer::MissionItem& lhs, const MissionRawServer::MissionItem& rhs);
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, MissionRawServer::MissionItem const& mission_item);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const MissionRawServer::MissionPlan& lhs, const MissionRawServer::MissionPlan& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, MissionRawServer::MissionPlan const& mission_plan);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const MissionRawServer::MissionProgress& lhs, const MissionRawServer::MissionProgress& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, MissionRawServer::MissionProgress const& mission_progress);
    ...
    /**
     * @brief Convert `MissionRawServer::Result` to string.
     *
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(MissionRawServer::Result const& result);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, MissionRawServer::Result const& result);
     ...
     */
    CurrentItemChangedHandle subscribe_current_item_changed(const CurrentItemChangedCallback& callback);

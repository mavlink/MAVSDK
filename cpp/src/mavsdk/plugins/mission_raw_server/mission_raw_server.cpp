...
MissionRawServer::MissionRawServer(std::shared_ptr<ServerComponent> server_component) : ServerPluginBase(), _impl{std::make_unique<MissionRawServerImpl>(server_component)} {}
...
MissionRawServer::IncomingMissionHandle MissionRawServer::subscribe_incoming_mission(const IncomingMissionCallback& callback)
{
...
MissionRawServer::CurrentItemChangedHandle MissionRawServer::subscribe_current_item_changed(const CurrentItemChangedCallback& callback)
{
...
MissionRawServer::ClearAllHandle MissionRawServer::subscribe_clear_all(const ClearAllCallback& callback)
{
...
MAVSDK_PUBLIC bool operator==(const MissionRawServer::MissionItem& lhs, const MissionRawServer::MissionItem& rhs)
{
    return
        (rhs.seq == lhs.seq) &&
        (rhs.frame == lhs.frame) &&
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, MissionRawServer::MissionItem const& mission_item)
{
...
MAVSDK_PUBLIC bool operator==(const MissionRawServer::MissionPlan& lhs, const MissionRawServer::MissionPlan& rhs)
{
    return
        (rhs.mission_items == lhs.mission_items);
}

MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, MissionRawServer::MissionPlan const& mission_plan)
{
    str << std::setprecision(15);
    str << "mission_plan:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const MissionRawServer::MissionProgress& lhs, const MissionRawServer::MissionProgress& rhs)
{
    return
        (rhs.current == lhs.current) &&
        (rhs.total == lhs.total);
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, MissionRawServer::MissionProgress const& mission_progress)
{
    str << std::setprecision(15);

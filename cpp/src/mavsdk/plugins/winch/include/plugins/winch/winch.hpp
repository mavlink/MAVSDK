...
public:
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Winch::WinchAction const& winch_action);
     ...
     */
    friend MAVSDK_PUBLIC bool operator==(const Winch::StatusFlags& lhs, const Winch::StatusFlags& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Winch::StatusFlags const& status_flags);

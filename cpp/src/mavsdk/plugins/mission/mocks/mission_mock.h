...
class MockMission {
public:
    MOCK_CONST_METHOD2(upload_mission_async, void(Mission::MissionPlan&, Mission::ResultCallback)) {
    };
    ...
    MOCK_CONST_METHOD2(set_current_mission_item_async, void(int current, Mission::ResultCallback)) {
    };

...
public:
     ...
     */
    friend MAVSDK_PUBLIC std::string_view to_string(Mission::MissionItem::CameraAction const& camera_action);
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Mission::MissionItem::CameraAction const& camera_action);
     ...
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(Mission::MissionItem::VehicleAction const& vehicle_action);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Mission::MissionItem::VehicleAction const& vehicle_action);
     ...
     */
    friend MAVSDK_PUBLIC bool operator==(const Mission::MissionItem& lhs, const Mission::MissionItem& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Mission::MissionItem const& mission_item);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Mission::MissionPlan& lhs, const Mission::MissionPlan& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Mission::MissionPlan const& mission_plan);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Mission::MissionProgress& lhs, const Mission::MissionProgress& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Mission::MissionProgress const& mission_progress);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Mission::ProgressData& lhs, const Mission::ProgressData& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Mission::ProgressData const& progress_data);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Mission::ProgressDataOrMission& lhs, const Mission::ProgressDataOrMission& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Mission::ProgressDataOrMission const& progress_data_or_mission);

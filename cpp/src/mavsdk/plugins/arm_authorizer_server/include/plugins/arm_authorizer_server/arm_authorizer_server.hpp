...
public:
     ...
     */
    friend MAVSDK_PUBLIC std::string_view to_string(ArmAuthorizerServer::RejectionReason const& rejection_reason);
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ArmAuthorizerServer::RejectionReason const& rejection_reason);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ArmAuthorizerServer::Result const& result);
     ...
     */
    Result reject_arm_authorization(bool temporarily, RejectionReason reason, int32_t extra_info) const;

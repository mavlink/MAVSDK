...
ArmAuthorizerServer::Result ArmAuthorizerServer::accept_arm_authorization(int32_t valid_time_s) const
{
...
ArmAuthorizerServer::Result ArmAuthorizerServer::reject_arm_authorization(bool temporarily, RejectionReason reason, int32_t extra_info) const
{

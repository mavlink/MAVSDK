...
std::ostream& operator<<(std::ostream& str, FollowMe::Config::FollowAltitudeMode const& follow_altitude_mode)
{
...
{
    return
        ((std::isnan(rhs.follow_height_m) && std::isnan(lhs.follow_height_m)) || rhs.follow_height_m == lhs.follow_height_m) &&
        ...
        ((std::isnan(rhs.max_tangential_vel_m_s) && std::isnan(lhs.max_tangential_vel_m_s)) || rhs.max_tangential_vel_m_s == lhs.max_tangential_vel_m_s) &&
        ((std::isnan(rhs.follow_angle_deg) && std::isnan(lhs.follow_angle_deg)) || rhs.follow_angle_deg == lhs.follow_angle_deg);
}

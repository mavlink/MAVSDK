...
public:
     ...
     */
    friend MAVSDK_PUBLIC std::string_view to_string(FollowMe::Config::FollowAltitudeMode const& follow_altitude_mode);
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, FollowMe::Config::FollowAltitudeMode const& follow_altitude_mode);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, FollowMe::Config const& config);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const FollowMe::TargetLocation& lhs, const FollowMe::TargetLocation& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, FollowMe::TargetLocation const& target_location);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, FollowMe::Result const& result);

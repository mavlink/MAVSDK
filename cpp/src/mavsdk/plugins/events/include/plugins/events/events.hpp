...
public:
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Events::LogLevel const& log_level);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Events::HealthAndArmingCheckProblem& lhs, const Events::HealthAndArmingCheckProblem& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Events::HealthAndArmingCheckProblem const& health_and_arming_check_problem);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Events::HealthAndArmingCheckMode& lhs, const Events::HealthAndArmingCheckMode& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Events::HealthAndArmingCheckMode const& health_and_arming_check_mode);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Events::HealthComponentReport& lhs, const Events::HealthComponentReport& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Events::HealthComponentReport const& health_component_report);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Events::HealthAndArmingCheckReport& lhs, const Events::HealthAndArmingCheckReport& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Events::HealthAndArmingCheckReport const& health_and_arming_check_report);

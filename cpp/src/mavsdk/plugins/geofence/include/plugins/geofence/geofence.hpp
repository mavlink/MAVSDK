...
public:
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Geofence::FenceType const& fence_type);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Geofence::Polygon& lhs, const Geofence::Polygon& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Geofence::Polygon const& polygon);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Geofence::Circle const& circle);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Geofence::GeofenceData& lhs, const Geofence::GeofenceData& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Geofence::GeofenceData const& geofence_data);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Geofence::Result const& result);

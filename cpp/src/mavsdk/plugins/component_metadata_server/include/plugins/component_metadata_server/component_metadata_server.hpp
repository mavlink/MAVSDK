...
public:
     ...
     */
    friend MAVSDK_PUBLIC std::string_view to_string(ComponentMetadataServer::MetadataType const& metadata_type);
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ComponentMetadataServer::MetadataType const& metadata_type);
     ...
     */
    friend MAVSDK_PUBLIC bool operator==(const ComponentMetadataServer::Metadata& lhs, const ComponentMetadataServer::Metadata& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ComponentMetadataServer::Metadata const& metadata);

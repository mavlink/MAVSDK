...
ComponentMetadataServer::ComponentMetadataServer(std::shared_ptr<ServerComponent> server_component) : ServerPluginBase(), _impl{std::make_unique<ComponentMetadataServerImpl>(server_component)} {}
...
bool operator==(const ComponentMetadataServer::Metadata& lhs, const ComponentMetadataServer::Metadata& rhs)
{
    return
        (rhs.type == lhs.type) &&
...
std::ostream& operator<<(std::ostream& str, ComponentMetadataServer::MetadataType const& metadata_type)
{

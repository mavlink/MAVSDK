...
LogStreaming::LogStreaming(System& system) : PluginBase(), _impl{std::make_unique<LogStreamingImpl>(system)} {}

LogStreaming::LogStreaming(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<LogStreamingImpl>(system)} {}
...
LogStreaming::LogStreamingRawHandle LogStreaming::subscribe_log_streaming_raw(const LogStreamingRawCallback& callback)
{

...
public:
     ...
     */
    friend MAVSDK_PUBLIC bool operator==(const LogStreaming::LogStreamingRaw& lhs, const LogStreaming::LogStreamingRaw& rhs);
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, LogStreaming::LogStreamingRaw const& log_streaming_raw);
    ...
    /**
     * @brief Convert `LogStreaming::Result` to string.
     *
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(LogStreaming::Result const& result);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, LogStreaming::Result const& result);

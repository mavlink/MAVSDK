...
ComponentMetadata::ComponentMetadata(System& system) : PluginBase(), _impl{std::make_unique<ComponentMetadataImpl>(system)} {}

ComponentMetadata::ComponentMetadata(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<ComponentMetadataImpl>(system)} {}
...
ComponentMetadata::MetadataAvailableHandle ComponentMetadata::subscribe_metadata_available(const MetadataAvailableCallback& callback)
{
...
std::pair<ComponentMetadata::Result, ComponentMetadata::MetadataData> ComponentMetadata::get_metadata(uint32_t compid, MetadataType metadata_type) const
{
...
bool operator==(const ComponentMetadata::MetadataData& lhs, const ComponentMetadata::MetadataData& rhs)
{
    return
...
bool operator==(const ComponentMetadata::MetadataUpdate& lhs, const ComponentMetadata::MetadataUpdate& rhs)
{
    return
...
std::ostream& operator<<(std::ostream& str, ComponentMetadata::MetadataUpdate const& metadata_update)
{
    str << std::setprecision(15);
    str << "metadata_update:" << '\n'
        << "{\n";

...
public:
     ...
     */
    friend std::ostream& operator<<(std::ostream& str, ComponentMetadata::MetadataType const& metadata_type);
     ...
     */
    friend bool operator==(const ComponentMetadata::MetadataData& lhs, const ComponentMetadata::MetadataData& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, ComponentMetadata::MetadataData const& metadata_data);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const ComponentMetadata::MetadataUpdate& lhs, const ComponentMetadata::MetadataUpdate& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, ComponentMetadata::MetadataUpdate const& metadata_update);

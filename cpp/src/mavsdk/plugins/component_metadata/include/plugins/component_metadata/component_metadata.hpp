...
class System;class ComponentMetadataImpl;
...
public:
     ...
     */
    friend MAVSDK_PUBLIC std::string_view to_string(ComponentMetadata::MetadataType const& metadata_type);
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ComponentMetadata::MetadataType const& metadata_type);
     ...
     */
    friend MAVSDK_PUBLIC bool operator==(const ComponentMetadata::MetadataData& lhs, const ComponentMetadata::MetadataData& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ComponentMetadata::MetadataData const& metadata_data);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ComponentMetadata::Result const& result);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const ComponentMetadata::MetadataUpdate& lhs, const ComponentMetadata::MetadataUpdate& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ComponentMetadata::MetadataUpdate const& metadata_update);
    ...
    /**
     * @brief Request metadata from a specific component. This is used to start requesting metadata from a component.
    ...
    /**
     * @brief Request metadata from the autopilot component. This is used to start requesting metadata from the autopilot.
     * The metadata can later be accessed via subscription (see below) or GetMetadata.
     *
     * This function is blocking.
     *
    ...
    /**
     * @brief Access metadata. This can be used if you know the metadata is available already, otherwise use
     ...
     */
    std::pair<Result, ComponentMetadata::MetadataData> get_metadata(uint32_t compid, MetadataType metadata_type) const;

...
class System;class ManualControlImpl;
...
public:
    ...
    /**
     * @brief Convert `ManualControl::Result` to string.
     *
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(ManualControl::Result const& result);
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ManualControl::Result const& result);

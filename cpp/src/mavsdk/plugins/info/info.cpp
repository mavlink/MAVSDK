...
Info::FlightInformationHandle Info::subscribe_flight_information(const FlightInformationCallback& callback)
{
...
std::ostream& operator<<(std::ostream& str, Info::Version::FlightSoftwareVersionType const& flight_software_version_type)
{

...
public:
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Info::FlightInfo const& flight_info);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Info::Identification& lhs, const Info::Identification& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Info::Identification const& identification);
     ...
     */
    friend MAVSDK_PUBLIC std::string_view to_string(Info::Version::FlightSoftwareVersionType const& flight_software_version_type);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Info::Version::FlightSoftwareVersionType const& flight_software_version_type);
        ...
        FlightSoftwareVersionType flight_sw_version_type{}; /**< @brief Flight software version type */
    };

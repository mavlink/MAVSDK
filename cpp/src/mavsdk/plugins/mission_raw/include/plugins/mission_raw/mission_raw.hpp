...
public:
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const MissionRaw::MissionItem& lhs, const MissionRaw::MissionItem& rhs);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const MissionRaw::MissionImportData& lhs, const MissionRaw::MissionImportData& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, MissionRaw::MissionImportData const& mission_import_data);
    ...
    */
     ...
     * @return Result of request.
     */
    std::pair<Result, MissionRaw::MissionImportData> import_mission_planner_mission(std::string mission_planner_path) const;
     ...
     * @return Result of request.
     */
    std::pair<Result, MissionRaw::MissionImportData> import_mission_planner_mission_from_string(std::string mission_planner_mission) const;

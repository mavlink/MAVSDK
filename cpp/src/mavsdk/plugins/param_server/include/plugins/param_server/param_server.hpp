...
public:
     ...
     */
    friend MAVSDK_PUBLIC bool operator==(const ParamServer::IntParam& lhs, const ParamServer::IntParam& rhs);
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ParamServer::IntParam const& int_param);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const ParamServer::FloatParam& lhs, const ParamServer::FloatParam& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ParamServer::FloatParam const& float_param);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const ParamServer::CustomParam& lhs, const ParamServer::CustomParam& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ParamServer::CustomParam const& custom_param);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const ParamServer::AllParams& lhs, const ParamServer::AllParams& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ParamServer::AllParams const& all_params);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ParamServer::Result const& result);

...
public:
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Param::ProtocolVersion const& protocol_version);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Param::IntParam const& int_param);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Param::FloatParam& lhs, const Param::FloatParam& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Param::FloatParam const& float_param);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Param::CustomParam& lhs, const Param::CustomParam& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Param::CustomParam const& custom_param);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Param::AllParams const& all_params);

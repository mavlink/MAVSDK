...
Action::Result Action::set_gps_global_origin(double latitude_deg, double longitude_deg, float absolute_altitude_m) const
{
...
Action::Result Action::set_home(bool use_current_location, double latitude_deg, double longitude_deg, float absolute_altitude_m) const
{
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Action::OrbitYawBehavior const& orbit_yaw_behavior)
{

...
MavlinkDirect::MavlinkDirect(System& system) : PluginBase(), _impl{std::make_unique<MavlinkDirectImpl>(system)} {}

MavlinkDirect::MavlinkDirect(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<MavlinkDirectImpl>(system)} {}
...
MavlinkDirect::MessageHandle MavlinkDirect::subscribe_message(std::string message_name, const MessageCallback& callback)
{

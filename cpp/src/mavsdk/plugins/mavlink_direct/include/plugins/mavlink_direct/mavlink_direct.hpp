...
class System;class MavlinkDirectImpl;
...
public:
     ...
     */
    friend MAVSDK_PUBLIC bool operator==(const MavlinkDirect::MavlinkMessage& lhs, const MavlinkDirect::MavlinkMessage& rhs);
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, MavlinkDirect::MavlinkMessage const& mavlink_message);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, MavlinkDirect::Result const& result);

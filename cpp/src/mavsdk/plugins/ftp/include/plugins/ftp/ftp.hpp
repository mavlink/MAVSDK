...
public:
     ...
     */
    friend MAVSDK_PUBLIC bool operator==(const Ftp::ListDirectoryData& lhs, const Ftp::ListDirectoryData& rhs);
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Ftp::ListDirectoryData const& list_directory_data);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Ftp::ProgressData& lhs, const Ftp::ProgressData& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Ftp::ProgressData const& progress_data);
    ...
    /**
     * @brief Convert `Ftp::Result` to string.
     *
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(Ftp::Result const& result);

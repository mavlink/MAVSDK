...
public:
    ...
    /**
     * @brief Convert `CameraServer::CameraFeedback` to string.
     *
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(CameraServer::CameraFeedback const& camera_feedback);
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::CameraFeedback const& camera_feedback);
    ...
    /**
     * @brief Convert `CameraServer::Mode` to string.
     *
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(CameraServer::Mode const& mode);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::Mode const& mode);
    ...
    struct Information {
        ...
        bool image_in_video_mode_supported{}; /**< @brief Camera supports taking images while in video mode */
        bool video_in_image_mode_supported{}; /**< @brief Camera supports recording video while in image mode */
    };
     ...
     */
    friend MAVSDK_PUBLIC bool operator==(const CameraServer::Information& lhs, const CameraServer::Information& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::Information const& information);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const CameraServer::VideoStreaming& lhs, const CameraServer::VideoStreaming& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::VideoStreaming const& video_streaming);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const CameraServer::Position& lhs, const CameraServer::Position& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::Position const& position);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const CameraServer::Quaternion& lhs, const CameraServer::Quaternion& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::Quaternion const& quaternion);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const CameraServer::CaptureInfo& lhs, const CameraServer::CaptureInfo& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::CaptureInfo const& capture_info);
    ...
    /**
     * @brief Convert `CameraServer::Result` to string.
     *
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(CameraServer::Result const& result);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::Result const& result);
    ...
    /**
     * @brief Convert `CameraServer::StorageStatus` to string.
     *
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(CameraServer::StorageInformation::StorageStatus const& storage_status);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::StorageInformation::StorageStatus const& storage_status);
    ...
    /**
     * @brief Convert `CameraServer::StorageType` to string.
     *
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(CameraServer::StorageInformation::StorageType const& storage_type);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::StorageInformation::StorageType const& storage_type);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const CameraServer::StorageInformation& lhs, const CameraServer::StorageInformation& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::StorageInformation const& storage_information);
    ...
    /**
     * @brief Convert `CameraServer::ImageStatus` to string.
     *
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(CameraServer::CaptureStatus::ImageStatus const& image_status);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::CaptureStatus::ImageStatus const& image_status);
    ...
    /**
     * @brief Convert `CameraServer::VideoStatus` to string.
     *
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(CameraServer::CaptureStatus::VideoStatus const& video_status);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::CaptureStatus::VideoStatus const& video_status);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const CameraServer::CaptureStatus& lhs, const CameraServer::CaptureStatus& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::CaptureStatus const& capture_status);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const CameraServer::TrackPoint& lhs, const CameraServer::TrackPoint& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::TrackPoint const& track_point);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const CameraServer::TrackRectangle& lhs, const CameraServer::TrackRectangle& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::TrackRectangle const& track_rectangle);
     ...
     */
    TrackingPointCommandHandle subscribe_tracking_point_command(const TrackingPointCommandCallback& callback);
     ...
     */
    TrackingRectangleCommandHandle subscribe_tracking_rectangle_command(const TrackingRectangleCommandCallback& callback);
     ...
     */
    TrackingOffCommandHandle subscribe_tracking_off_command(const TrackingOffCommandCallback& callback);

...
public:
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const CameraServer::TrackPoint& lhs, const CameraServer::TrackPoint& rhs);
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const CameraServer::TrackRectangle& lhs, const CameraServer::TrackRectangle& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, CameraServer::TrackRectangle const& track_rectangle);

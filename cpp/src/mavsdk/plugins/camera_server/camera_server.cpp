...
CameraServer::Result CameraServer::respond_take_photo(CameraFeedback take_photo_feedback, CaptureInfo capture_info) const
{
...
CameraServer::StartVideoHandle CameraServer::subscribe_start_video(const StartVideoCallback& callback)
{
...
CameraServer::StartVideoStreamingHandle CameraServer::subscribe_start_video_streaming(const StartVideoStreamingCallback& callback)
{
...
CameraServer::Result CameraServer::respond_start_video_streaming(CameraFeedback start_video_streaming_feedback) const
{
...
CameraServer::StopVideoStreamingHandle CameraServer::subscribe_stop_video_streaming(const StopVideoStreamingCallback& callback)
{
...
CameraServer::Result CameraServer::respond_stop_video_streaming(CameraFeedback stop_video_streaming_feedback) const
{
...
CameraServer::StorageInformationHandle CameraServer::subscribe_storage_information(const StorageInformationCallback& callback)
{
...
CameraServer::Result CameraServer::respond_storage_information(CameraFeedback storage_information_feedback, StorageInformation storage_information) const
{
...
CameraServer::CaptureStatusHandle CameraServer::subscribe_capture_status(const CaptureStatusCallback& callback)
{
...
CameraServer::Result CameraServer::respond_capture_status(CameraFeedback capture_status_feedback, CaptureStatus capture_status) const
{
...
CameraServer::FormatStorageHandle CameraServer::subscribe_format_storage(const FormatStorageCallback& callback)
{
...
CameraServer::Result CameraServer::respond_format_storage(CameraFeedback format_storage_feedback) const
{
...
CameraServer::ResetSettingsHandle CameraServer::subscribe_reset_settings(const ResetSettingsCallback& callback)
{
...
CameraServer::Result CameraServer::respond_reset_settings(CameraFeedback reset_settings_feedback) const
{
...
CameraServer::ZoomInStartHandle CameraServer::subscribe_zoom_in_start(const ZoomInStartCallback& callback)
{
...
CameraServer::Result CameraServer::respond_zoom_in_start(CameraFeedback zoom_in_start_feedback) const
{
...
CameraServer::ZoomOutStartHandle CameraServer::subscribe_zoom_out_start(const ZoomOutStartCallback& callback)
{
...
CameraServer::Result CameraServer::respond_zoom_out_start(CameraFeedback zoom_out_start_feedback) const
{
...
CameraServer::TrackingPointCommandHandle CameraServer::subscribe_tracking_point_command(const TrackingPointCommandCallback& callback)
{
...
CameraServer::TrackingRectangleCommandHandle CameraServer::subscribe_tracking_rectangle_command(const TrackingRectangleCommandCallback& callback)
{
...
CameraServer::TrackingOffCommandHandle CameraServer::subscribe_tracking_off_command(const TrackingOffCommandCallback& callback)
{
...
CameraServer::Result CameraServer::respond_tracking_point_command(CameraFeedback stop_video_feedback) const
{
...
CameraServer::Result CameraServer::respond_tracking_rectangle_command(CameraFeedback stop_video_feedback) const
{
...
CameraServer::Result CameraServer::respond_tracking_off_command(CameraFeedback stop_video_feedback) const
{
...
{
    return
        (rhs.has_rtsp_server == lhs.has_rtsp_server) &&
        (rhs.rtsp_uri == lhs.rtsp_uri);
}
...
std::ostream& operator<<(std::ostream& str, CameraServer::StorageInformation::StorageStatus const& storage_status)
{
...
std::ostream& operator<<(std::ostream& str, CameraServer::StorageInformation::StorageType const& storage_type)
{
    switch (storage_type) {
...
bool operator==(const CameraServer::StorageInformation& lhs, const CameraServer::StorageInformation& rhs)
{
    return
        ...
        ((std::isnan(rhs.read_speed_mib_s) && std::isnan(lhs.read_speed_mib_s)) || rhs.read_speed_mib_s == lhs.read_speed_mib_s) &&
        ((std::isnan(rhs.write_speed_mib_s) && std::isnan(lhs.write_speed_mib_s)) || rhs.write_speed_mib_s == lhs.write_speed_mib_s);
}

std::ostream& operator<<(std::ostream& str, CameraServer::StorageInformation const& storage_information)
{
    str << std::setprecision(15);
...
std::ostream& operator<<(std::ostream& str, CameraServer::CaptureStatus::ImageStatus const& image_status)
{
    switch (image_status) {
...
std::ostream& operator<<(std::ostream& str, CameraServer::CaptureStatus::VideoStatus const& video_status)
{
    switch (video_status) {
...
{
    return
        ((std::isnan(rhs.image_interval_s) && std::isnan(lhs.image_interval_s)) || rhs.image_interval_s == lhs.image_interval_s) &&
        ((std::isnan(rhs.recording_time_s) && std::isnan(lhs.recording_time_s)) || rhs.recording_time_s == lhs.recording_time_s) &&
        ((std::isnan(rhs.available_capacity_mib) && std::isnan(lhs.available_capacity_mib)) || rhs.available_capacity_mib == lhs.available_capacity_mib) &&
        (rhs.image_status == lhs.image_status) &&
        (rhs.video_status == lhs.video_status) &&
...
{
    return
        ((std::isnan(rhs.point_x) && std::isnan(lhs.point_x)) || rhs.point_x == lhs.point_x) &&
...
{
    return
        ((std::isnan(rhs.top_left_corner_x) && std::isnan(lhs.top_left_corner_x)) || rhs.top_left_corner_x == lhs.top_left_corner_x) &&
        ((std::isnan(rhs.top_left_corner_y) && std::isnan(lhs.top_left_corner_y)) || rhs.top_left_corner_y == lhs.top_left_corner_y) &&
        ((std::isnan(rhs.bottom_right_corner_x) && std::isnan(lhs.bottom_right_corner_x)) || rhs.bottom_right_corner_x == lhs.bottom_right_corner_x) &&
        ((std::isnan(rhs.bottom_right_corner_y) && std::isnan(lhs.bottom_right_corner_y)) || rhs.bottom_right_corner_y == lhs.bottom_right_corner_y);
}

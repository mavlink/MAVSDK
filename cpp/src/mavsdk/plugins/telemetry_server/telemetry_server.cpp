...
TelemetryServer::Result TelemetryServer::publish_distance_sensor(DistanceSensor distance_sensor) const
{
...
TelemetryServer::Result TelemetryServer::publish_attitude(EulerAngle angle, AngularVelocityBody angular_velocity) const
{
...
TelemetryServer::Result TelemetryServer::publish_visual_flight_rules_hud(FixedwingMetrics fixed_wing_metrics) const
{
...
bool operator==(const TelemetryServer::FixedwingMetrics& lhs, const TelemetryServer::FixedwingMetrics& rhs)
{
    return
        ...
        ((std::isnan(rhs.groundspeed_m_s) && std::isnan(lhs.groundspeed_m_s)) || rhs.groundspeed_m_s == lhs.groundspeed_m_s) &&
        ((std::isnan(rhs.heading_deg) && std::isnan(lhs.heading_deg)) || rhs.heading_deg == lhs.heading_deg) &&
        ((std::isnan(rhs.absolute_altitude_m) && std::isnan(lhs.absolute_altitude_m)) || rhs.absolute_altitude_m == lhs.absolute_altitude_m);
}

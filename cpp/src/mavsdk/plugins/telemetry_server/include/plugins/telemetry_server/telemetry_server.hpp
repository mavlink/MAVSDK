...
public:
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::FixType const& fix_type);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::VtolState const& vtol_state);
     ...
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(TelemetryServer::StatusTextType const& status_text_type);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::StatusTextType const& status_text_type);
     ...
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(TelemetryServer::LandedState const& landed_state);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::LandedState const& landed_state);
     ...
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::Position& lhs, const TelemetryServer::Position& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::Position const& position);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::Heading& lhs, const TelemetryServer::Heading& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::Heading const& heading);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::Quaternion& lhs, const TelemetryServer::Quaternion& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::Quaternion const& quaternion);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::EulerAngle& lhs, const TelemetryServer::EulerAngle& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::EulerAngle const& euler_angle);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::AngularVelocityBody& lhs, const TelemetryServer::AngularVelocityBody& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::AngularVelocityBody const& angular_velocity_body);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::GpsInfo& lhs, const TelemetryServer::GpsInfo& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::GpsInfo const& gps_info);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::RawGps& lhs, const TelemetryServer::RawGps& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::RawGps const& raw_gps);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::Battery& lhs, const TelemetryServer::Battery& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::Battery const& battery);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::RcStatus& lhs, const TelemetryServer::RcStatus& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::RcStatus const& rc_status);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::StatusText& lhs, const TelemetryServer::StatusText& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::StatusText const& status_text);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::ActuatorControlTarget& lhs, const TelemetryServer::ActuatorControlTarget& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::ActuatorControlTarget const& actuator_control_target);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::ActuatorOutputStatus& lhs, const TelemetryServer::ActuatorOutputStatus& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::ActuatorOutputStatus const& actuator_output_status);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::Covariance& lhs, const TelemetryServer::Covariance& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::Covariance const& covariance);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::VelocityBody& lhs, const TelemetryServer::VelocityBody& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::VelocityBody const& velocity_body);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::PositionBody& lhs, const TelemetryServer::PositionBody& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::PositionBody const& position_body);
     ...
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(TelemetryServer::Odometry::MavFrame const& mav_frame);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::Odometry::MavFrame const& mav_frame);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::Odometry& lhs, const TelemetryServer::Odometry& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::Odometry const& odometry);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::DistanceSensor& lhs, const TelemetryServer::DistanceSensor& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::DistanceSensor const& distance_sensor);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::ScaledPressure& lhs, const TelemetryServer::ScaledPressure& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::ScaledPressure const& scaled_pressure);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::PositionNed& lhs, const TelemetryServer::PositionNed& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::PositionNed const& position_ned);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::VelocityNed& lhs, const TelemetryServer::VelocityNed& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::VelocityNed const& velocity_ned);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::PositionVelocityNed& lhs, const TelemetryServer::PositionVelocityNed& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::PositionVelocityNed const& position_velocity_ned);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::GroundTruth& lhs, const TelemetryServer::GroundTruth& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::GroundTruth const& ground_truth);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::FixedwingMetrics& lhs, const TelemetryServer::FixedwingMetrics& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::FixedwingMetrics const& fixedwing_metrics);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::AccelerationFrd& lhs, const TelemetryServer::AccelerationFrd& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::AccelerationFrd const& acceleration_frd);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::AngularVelocityFrd& lhs, const TelemetryServer::AngularVelocityFrd& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::AngularVelocityFrd const& angular_velocity_frd);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::MagneticFieldFrd& lhs, const TelemetryServer::MagneticFieldFrd& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::MagneticFieldFrd const& magnetic_field_frd);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const TelemetryServer::Imu& lhs, const TelemetryServer::Imu& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::Imu const& imu);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::Result const& result);

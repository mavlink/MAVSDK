...
class MockTelemetry {
public:
    MOCK_CONST_METHOD1(subscribe_position, Telemetry::PositionHandle(Telemetry::PositionCallback)) {
    };
    ...
    MOCK_CONST_METHOD1(unsubscribe_attitude_quaternion, void(Telemetry::AttitudeQuaternionHandle)) {
    };
    MOCK_CONST_METHOD1(
    ...
    MOCK_CONST_METHOD1(subscribe_odometry, Telemetry::OdometryHandle(Telemetry::OdometryCallback)) {
    };

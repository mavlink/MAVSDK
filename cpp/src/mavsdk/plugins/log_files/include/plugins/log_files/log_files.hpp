...
class System;class LogFilesImpl;
...
public:
     ...
     */
    friend MAVSDK_PUBLIC bool operator==(const LogFiles::ProgressData& lhs, const LogFiles::ProgressData& rhs);
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, LogFiles::ProgressData const& progress_data);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, LogFiles::Result const& result);
    ...
    */
     ...
     */
    void download_log_file_async(Entry entry, std::string path, const DownloadLogFileCallback& callback);

...
public:
     ...
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Calibration::Result const& result);
     ...
     */
    friend MAVSDK_PUBLIC bool operator==(const Calibration::ProgressData& lhs, const Calibration::ProgressData& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Calibration::ProgressData const& progress_data);

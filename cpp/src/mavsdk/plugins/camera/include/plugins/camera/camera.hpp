...
public:
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::PhotosRange const& photos_range);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::Setting const& setting);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Camera::SettingOptions& lhs, const Camera::SettingOptions& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::SettingOptions const& setting_options);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Camera::VideoStreamSettings& lhs, const Camera::VideoStreamSettings& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::VideoStreamSettings const& video_stream_settings);
     ...
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(Camera::VideoStreamInfo::VideoStreamStatus const& video_stream_status);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::VideoStreamInfo::VideoStreamStatus const& video_stream_status);
     ...
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(Camera::VideoStreamInfo::VideoStreamSpectrum const& video_stream_spectrum);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::VideoStreamInfo::VideoStreamSpectrum const& video_stream_spectrum);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Camera::VideoStreamInfo& lhs, const Camera::VideoStreamInfo& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::VideoStreamInfo const& video_stream_info);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Camera::ModeUpdate& lhs, const Camera::ModeUpdate& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::ModeUpdate const& mode_update);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Camera::VideoStreamUpdate& lhs, const Camera::VideoStreamUpdate& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::VideoStreamUpdate const& video_stream_update);
     ...
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(Camera::Storage::StorageStatus const& storage_status);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::Storage::StorageStatus const& storage_status);
     ...
     * @return A string representation of the enum.
     */
    friend MAVSDK_PUBLIC std::string_view to_string(Camera::Storage::StorageType const& storage_type);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::Storage::StorageType const& storage_type);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::Storage const& storage);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Camera::StorageUpdate& lhs, const Camera::StorageUpdate& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::StorageUpdate const& storage_update);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Camera::CurrentSettingsUpdate& lhs, const Camera::CurrentSettingsUpdate& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::CurrentSettingsUpdate const& current_settings_update);
    ...
    struct PossibleSettingOptionsUpdate {
        ...
        int32_t component_id{}; /**< @brief Component ID */
        std::vector<SettingOptions> setting_options{}; /**< @brief List of settings that can be changed */
    };
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Camera::PossibleSettingOptionsUpdate& lhs, const Camera::PossibleSettingOptionsUpdate& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::PossibleSettingOptionsUpdate const& possible_setting_options_update);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::Position const& position);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Camera::Quaternion& lhs, const Camera::Quaternion& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::Quaternion const& quaternion);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Camera::EulerAngle& lhs, const Camera::EulerAngle& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::EulerAngle const& euler_angle);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Camera::CaptureInfo& lhs, const Camera::CaptureInfo& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::CaptureInfo const& capture_info);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Camera::Information& lhs, const Camera::Information& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::Information const& information);
     ...
     * @return `true` if items are equal.
     */
    friend MAVSDK_PUBLIC bool operator==(const Camera::CameraList& lhs, const Camera::CameraList& rhs);
     ...
     * @return A reference to the stream.
     */
    friend MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::CameraList const& camera_list);
     ...
     */
    void start_photo_interval_async(int32_t component_id, float interval_s, const ResultCallback callback);
    ...
    */
     ...
     */
    void list_photos_async(int32_t component_id, PhotosRange photos_range, const ListPhotosCallback callback);
     ...
     * @return Result of request.
     */
    std::pair<Result, std::vector<Camera::CaptureInfo>> list_photos(int32_t component_id, PhotosRange photos_range) const;
     ...
     * @return Result of request.
     */
    std::pair<Result, std::vector<Camera::Setting>> get_current_settings(int32_t component_id) const;
     ...
     * @return Result of request.
     */
    std::pair<Result, std::vector<Camera::SettingOptions>> get_possible_setting_options(int32_t component_id) const;
    ...
    */
     ...
     */
    void get_setting_async(int32_t component_id, Setting setting, const GetSettingCallback callback);
     ...
     */
    void format_storage_async(int32_t component_id, int32_t storage_id, const ResultCallback callback);
     ...
     */
    void track_point_async(int32_t component_id, float point_x, float point_y, float radius, const ResultCallback callback);
     ...
     */
    void track_rectangle_async(int32_t component_id, float top_left_x, float top_left_y, float bottom_right_x, float bottom_right_y, const ResultCallback callback);
     ...
     */
    Result track_rectangle(int32_t component_id, float top_left_x, float top_left_y, float bottom_right_x, float bottom_right_y) const;

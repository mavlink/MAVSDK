...
#ifndef mavlink_5fdirect_5fserver_2fmavlink_5fdirect_5fserver_2eproto_2epb_2eh
#define mavlink_5fdirect_5fserver_2fmavlink_5fdirect_5fserver_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_mavlink_5fdirect_5fserver_2fmavlink_5fdirect_5fserver_2eproto
...
struct TableStruct_mavlink_5fdirect_5fserver_2fmavlink_5fdirect_5fserver_2eproto {
...
class MavlinkDirectServerResult;
struct MavlinkDirectServerResultDefaultTypeInternal;
extern MavlinkDirectServerResultDefaultTypeInternal _MavlinkDirectServerResult_default_instance_;
...
namespace rpc {
namespace mavlink_direct_server {
enum MavlinkDirectServerResult_Result : int {
  MavlinkDirectServerResult_Result_RESULT_UNKNOWN = 0,
  MavlinkDirectServerResult_Result_RESULT_SUCCESS = 1,
  MavlinkDirectServerResult_Result_RESULT_ERROR = 2,
  MavlinkDirectServerResult_Result_RESULT_INVALID_MESSAGE = 3,
  MavlinkDirectServerResult_Result_RESULT_INVALID_FIELD = 4,
  MavlinkDirectServerResult_Result_RESULT_CONNECTION_ERROR = 5,
  MavlinkDirectServerResult_Result_RESULT_NO_SYSTEM = 6,
  MavlinkDirectServerResult_Result_RESULT_TIMEOUT = 7,
  MavlinkDirectServerResult_Result_MavlinkDirectServerResult_Result_INT_MIN_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::min(),
  MavlinkDirectServerResult_Result_MavlinkDirectServerResult_Result_INT_MAX_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::max(),
};

bool MavlinkDirectServerResult_Result_IsValid(int value);
extern const uint32_t MavlinkDirectServerResult_Result_internal_data_[];
constexpr MavlinkDirectServerResult_Result MavlinkDirectServerResult_Result_Result_MIN = static_cast<MavlinkDirectServerResult_Result>(0);
constexpr MavlinkDirectServerResult_Result MavlinkDirectServerResult_Result_Result_MAX = static_cast<MavlinkDirectServerResult_Result>(7);
constexpr int MavlinkDirectServerResult_Result_Result_ARRAYSIZE = 7 + 1;
const ::google::protobuf::EnumDescriptor*
MavlinkDirectServerResult_Result_descriptor();
template <typename T>
const std::string& MavlinkDirectServerResult_Result_Name(T value) {
  static_assert(std::is_same<T, MavlinkDirectServerResult_Result>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to Result_Name().");
  return MavlinkDirectServerResult_Result_Name(static_cast<MavlinkDirectServerResult_Result>(value));
}
template <>
inline const std::string& MavlinkDirectServerResult_Result_Name(MavlinkDirectServerResult_Result value) {
  return ::google::protobuf::internal::NameOfDenseEnum<MavlinkDirectServerResult_Result_descriptor,
                                                 0, 7>(
      static_cast<int>(value));
}
inline bool MavlinkDirectServerResult_Result_Parse(absl::string_view name, MavlinkDirectServerResult_Result* value) {
  return ::google::protobuf::internal::ParseNamedEnum<MavlinkDirectServerResult_Result>(
      MavlinkDirectServerResult_Result_descriptor(), name, value);
}
...
class MavlinkMessage final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:mavsdk.rpc.mavlink_direct_server.MavlinkMessage) */ {
 public:
 ...
 private:
  ...
  friend ::absl::string_view(
      ::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "mavsdk.rpc.mavlink_direct_server.MavlinkMessage"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:mavsdk.rpc.mavlink_direct_server.MavlinkMessage)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
...
class MavlinkDirectServerResult final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult) */ {
 public:
  inline MavlinkDirectServerResult() : MavlinkDirectServerResult(nullptr) {}
  ~MavlinkDirectServerResult() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(MavlinkDirectServerResult* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(MavlinkDirectServerResult));
  }
#endif

  template <typename = void>
  explicit PROTOBUF_CONSTEXPR MavlinkDirectServerResult(
      ::google::protobuf::internal::ConstantInitialized);

  inline MavlinkDirectServerResult(const MavlinkDirectServerResult& from) : MavlinkDirectServerResult(nullptr, from) {}
  inline MavlinkDirectServerResult(MavlinkDirectServerResult&& from) noexcept
      : MavlinkDirectServerResult(nullptr, std::move(from)) {}
  inline MavlinkDirectServerResult& operator=(const MavlinkDirectServerResult& from) {
    CopyFrom(from);
    return *this;
  }
  inline MavlinkDirectServerResult& operator=(MavlinkDirectServerResult&& from) noexcept {
    if (this == &from) return *this;
    if (::google::protobuf::internal::CanMoveWithInternalSwap(GetArena(), from.GetArena())) {
      InternalSwap(&from);
    } else {
  ...
  static const MavlinkDirectServerResult& default_instance() {
    return *internal_default_instance();
  }
  static inline const MavlinkDirectServerResult* internal_default_instance() {
  ...
  void UnsafeArenaSwap(MavlinkDirectServerResult* other) {
    if (other == this) return;
    ABSL_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  MavlinkDirectServerResult* New(::google::protobuf::Arena* arena = nullptr) const {
    return ::google::protobuf::Message::DefaultConstruct<MavlinkDirectServerResult>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const MavlinkDirectServerResult& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const MavlinkDirectServerResult& from) { MavlinkDirectServerResult::MergeImpl(*this, from); }
  ...
  void SharedCtor(::google::protobuf::Arena* arena);
  static void SharedDtor(MessageLite& self);
  void InternalSwap(MavlinkDirectServerResult* other);
 private:
  template <typename T>
  friend ::absl::string_view(
      ::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult"; }

 protected:
  explicit MavlinkDirectServerResult(::google::protobuf::Arena* arena);
  MavlinkDirectServerResult(::google::protobuf::Arena* arena, const MavlinkDirectServerResult& from);
  MavlinkDirectServerResult(::google::protobuf::Arena* arena, MavlinkDirectServerResult&& from) noexcept
      : MavlinkDirectServerResult(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::internal::ClassData* GetClassData() const PROTOBUF_FINAL;
  static void* PlacementNew_(const void*, void* mem,
 ...
 public:
  ::google::protobuf::Metadata GetMetadata() const;
  // nested types ----------------------------------------------------
  using Result = MavlinkDirectServerResult_Result;
  static constexpr Result RESULT_UNKNOWN = MavlinkDirectServerResult_Result_RESULT_UNKNOWN;
  static constexpr Result RESULT_SUCCESS = MavlinkDirectServerResult_Result_RESULT_SUCCESS;
  static constexpr Result RESULT_ERROR = MavlinkDirectServerResult_Result_RESULT_ERROR;
  static constexpr Result RESULT_INVALID_MESSAGE = MavlinkDirectServerResult_Result_RESULT_INVALID_MESSAGE;
  static constexpr Result RESULT_INVALID_FIELD = MavlinkDirectServerResult_Result_RESULT_INVALID_FIELD;
  static constexpr Result RESULT_CONNECTION_ERROR = MavlinkDirectServerResult_Result_RESULT_CONNECTION_ERROR;
  static constexpr Result RESULT_NO_SYSTEM = MavlinkDirectServerResult_Result_RESULT_NO_SYSTEM;
  static constexpr Result RESULT_TIMEOUT = MavlinkDirectServerResult_Result_RESULT_TIMEOUT;
  static inline bool Result_IsValid(int value) {
    return MavlinkDirectServerResult_Result_IsValid(value);
  }
  static constexpr Result Result_MIN = MavlinkDirectServerResult_Result_Result_MIN;
  static constexpr Result Result_MAX = MavlinkDirectServerResult_Result_Result_MAX;
  static constexpr int Result_ARRAYSIZE = MavlinkDirectServerResult_Result_Result_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor* Result_descriptor() {
    return MavlinkDirectServerResult_Result_descriptor();
  }
  template <typename T>
  static inline const std::string& Result_Name(T value) {
    return MavlinkDirectServerResult_Result_Name(value);
  }
  static inline bool Result_Parse(absl::string_view name, Result* value) {
    return MavlinkDirectServerResult_Result_Parse(name, value);
  }
  ...
  void clear_result() ;
  ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult_Result result() const;
  void set_result(::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult_Result value);

  private:
  ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult_Result _internal_result() const;
  void _internal_set_result(::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult_Result value);

  public:
  // @@protoc_insertion_point(class_scope:mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
  ...
  struct Impl_ {
    ...
    inline explicit Impl_(::google::protobuf::internal::InternalVisibility visibility,
                          ::google::protobuf::Arena* arena, const Impl_& from,
                          const MavlinkDirectServerResult& from_msg);
...
class LoadCustomXmlRequest final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlRequest) */ {
 public:
 ...
 private:
  ...
  friend ::absl::string_view(
      ::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "mavsdk.rpc.mavlink_direct_server.LoadCustomXmlRequest"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlRequest)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
...
class SendMessageResponse final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:mavsdk.rpc.mavlink_direct_server.SendMessageResponse) */ {
 public:
 ...
 private:
  ...
  friend ::absl::string_view(
      ::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "mavsdk.rpc.mavlink_direct_server.SendMessageResponse"; }
 ...
 public:
  ...
  // accessors -------------------------------------------------------
  enum : int {
    kMavlinkDirectServerResultFieldNumber = 1,
  };
  // .mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult mavlink_direct_server_result = 1;
  bool has_mavlink_direct_server_result() const;
  void clear_mavlink_direct_server_result() ;
  const ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult& mavlink_direct_server_result() const;
  PROTOBUF_NODISCARD ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* release_mavlink_direct_server_result();
  ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* mutable_mavlink_direct_server_result();
  void set_allocated_mavlink_direct_server_result(::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* value);
  void unsafe_arena_set_allocated_mavlink_direct_server_result(::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* value);
  ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* unsafe_arena_release_mavlink_direct_server_result();

  private:
  const ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult& _internal_mavlink_direct_server_result() const;
  ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* _internal_mutable_mavlink_direct_server_result();

  public:
  // @@protoc_insertion_point(class_scope:mavsdk.rpc.mavlink_direct_server.SendMessageResponse)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::CachedSize _cached_size_;
    ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* mavlink_direct_server_result_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_mavlink_5fdirect_5fserver_2fmavlink_5fdirect_5fserver_2eproto;
...
class SendMessageRequest final
    : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:mavsdk.rpc.mavlink_direct_server.SendMessageRequest) */ {
 public:
 ...
 private:
  ...
  friend ::absl::string_view(
      ::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "mavsdk.rpc.mavlink_direct_server.SendMessageRequest"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:mavsdk.rpc.mavlink_direct_server.SendMessageRequest)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
...
/* @@protoc_insertion_point(class_definition:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlResponse) */ {
 ...
 private:
  ...
  friend ::absl::string_view(
      ::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "mavsdk.rpc.mavlink_direct_server.LoadCustomXmlResponse"; }
 ...
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlResponse)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
...
inline const ::mavsdk::rpc::mavlink_direct_server::MavlinkMessage& SendMessageRequest::_internal_message() const {
...
inline const ::mavsdk::rpc::mavlink_direct_server::MavlinkMessage& SendMessageRequest::message() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.mavlink_direct_server.SendMessageRequest.message)
  return _internal_message();
}
inline void SendMessageRequest::unsafe_arena_set_allocated_message(::mavsdk::rpc::mavlink_direct_server::MavlinkMessage* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:mavsdk.rpc.mavlink_direct_server.SendMessageRequest.message)
}
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkMessage* SendMessageRequest::release_message() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkMessage* SendMessageRequest::unsafe_arena_release_message() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:mavsdk.rpc.mavlink_direct_server.SendMessageRequest.message)
...
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkMessage* SendMessageRequest::_internal_mutable_message() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkMessage* SendMessageRequest::mutable_message() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000001u;
  ::mavsdk::rpc::mavlink_direct_server::MavlinkMessage* _msg = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:mavsdk.rpc.mavlink_direct_server.SendMessageRequest.message)
  return _msg;
}
inline void SendMessageRequest::set_allocated_message(::mavsdk::rpc::mavlink_direct_server::MavlinkMessage* value) {
  ...
  _impl_.message_ = reinterpret_cast<::mavsdk::rpc::mavlink_direct_server::MavlinkMessage*>(value);
  // @@protoc_insertion_point(field_set_allocated:mavsdk.rpc.mavlink_direct_server.SendMessageRequest.message)
}
...
// .mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult mavlink_direct_server_result = 1;
inline bool SendMessageResponse::has_mavlink_direct_server_result() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.mavlink_direct_server_result_ != nullptr);
  return value;
}
inline void SendMessageResponse::clear_mavlink_direct_server_result() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.mavlink_direct_server_result_ != nullptr) _impl_.mavlink_direct_server_result_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult& SendMessageResponse::_internal_mavlink_direct_server_result() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  const ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* p = _impl_.mavlink_direct_server_result_;
  return p != nullptr ? *p : reinterpret_cast<const ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult&>(::mavsdk::rpc::mavlink_direct_server::_MavlinkDirectServerResult_default_instance_);
}
inline const ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult& SendMessageResponse::mavlink_direct_server_result() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.mavlink_direct_server.SendMessageResponse.mavlink_direct_server_result)
  return _internal_mavlink_direct_server_result();
}
inline void SendMessageResponse::unsafe_arena_set_allocated_mavlink_direct_server_result(::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.mavlink_direct_server_result_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:mavsdk.rpc.mavlink_direct_server.SendMessageResponse.mavlink_direct_server_result)
}
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* SendMessageResponse::release_mavlink_direct_server_result() {
  ::google::protobuf::internal::TSanWrite(&_impl_);

  _impl_._has_bits_[0] &= ~0x00000001u;
  ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* released = _impl_.mavlink_direct_server_result_;
  _impl_.mavlink_direct_server_result_ = nullptr;
  if (::google::protobuf::internal::DebugHardenForceCopyInRelease()) {
    auto* old = reinterpret_cast<::google::protobuf::MessageLite*>(released);
    released = ::google::protobuf::internal::DuplicateIfNonNull(released);
    if (GetArena() == nullptr) {
...
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* SendMessageResponse::unsafe_arena_release_mavlink_direct_server_result() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:mavsdk.rpc.mavlink_direct_server.SendMessageResponse.mavlink_direct_server_result)

  _impl_._has_bits_[0] &= ~0x00000001u;
  ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* temp = _impl_.mavlink_direct_server_result_;
  _impl_.mavlink_direct_server_result_ = nullptr;
  return temp;
}
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* SendMessageResponse::_internal_mutable_mavlink_direct_server_result() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.mavlink_direct_server_result_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult>(GetArena());
    _impl_.mavlink_direct_server_result_ = reinterpret_cast<::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult*>(p);
  }
  return _impl_.mavlink_direct_server_result_;
}
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* SendMessageResponse::mutable_mavlink_direct_server_result() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000001u;
  ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* _msg = _internal_mutable_mavlink_direct_server_result();
  // @@protoc_insertion_point(field_mutable:mavsdk.rpc.mavlink_direct_server.SendMessageResponse.mavlink_direct_server_result)
  return _msg;
}
inline void SendMessageResponse::set_allocated_mavlink_direct_server_result(::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete (_impl_.mavlink_direct_server_result_);
  }
...
inline const std::string& LoadCustomXmlRequest::xml_content() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlRequest.xml_content)
...
inline PROTOBUF_ALWAYS_INLINE void LoadCustomXmlRequest::set_xml_content(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlRequest.xml_content)
}
inline std::string* LoadCustomXmlRequest::mutable_xml_content() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ...
  // @@protoc_insertion_point(field_mutable:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlRequest.xml_content)
  return _s;
}
...
inline std::string* LoadCustomXmlRequest::release_xml_content() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlRequest.xml_content)
...
inline void LoadCustomXmlRequest::set_allocated_xml_content(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlRequest.xml_content)
}
...
// .mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult mavlink_direct_server_result = 1;
inline bool LoadCustomXmlResponse::has_mavlink_direct_server_result() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.mavlink_direct_server_result_ != nullptr);
  return value;
}
inline void LoadCustomXmlResponse::clear_mavlink_direct_server_result() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.mavlink_direct_server_result_ != nullptr) _impl_.mavlink_direct_server_result_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult& LoadCustomXmlResponse::_internal_mavlink_direct_server_result() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  const ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* p = _impl_.mavlink_direct_server_result_;
  return p != nullptr ? *p : reinterpret_cast<const ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult&>(::mavsdk::rpc::mavlink_direct_server::_MavlinkDirectServerResult_default_instance_);
}
inline const ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult& LoadCustomXmlResponse::mavlink_direct_server_result() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlResponse.mavlink_direct_server_result)
  return _internal_mavlink_direct_server_result();
}
inline void LoadCustomXmlResponse::unsafe_arena_set_allocated_mavlink_direct_server_result(::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.mavlink_direct_server_result_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlResponse.mavlink_direct_server_result)
}
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* LoadCustomXmlResponse::release_mavlink_direct_server_result() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* LoadCustomXmlResponse::unsafe_arena_release_mavlink_direct_server_result() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlResponse.mavlink_direct_server_result)
...
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* LoadCustomXmlResponse::_internal_mutable_mavlink_direct_server_result() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.mavlink_direct_server_result_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult>(GetArena());
    _impl_.mavlink_direct_server_result_ = reinterpret_cast<::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult*>(p);
...
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* LoadCustomXmlResponse::mutable_mavlink_direct_server_result() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000001u;
  ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* _msg = _internal_mutable_mavlink_direct_server_result();
  // @@protoc_insertion_point(field_mutable:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlResponse.mavlink_direct_server_result)
  return _msg;
}
inline void LoadCustomXmlResponse::set_allocated_mavlink_direct_server_result(::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (message_arena == nullptr) {
    delete (_impl_.mavlink_direct_server_result_);
  ...
  _impl_.mavlink_direct_server_result_ = reinterpret_cast<::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult*>(value);
  // @@protoc_insertion_point(field_set_allocated:mavsdk.rpc.mavlink_direct_server.LoadCustomXmlResponse.mavlink_direct_server_result)
}
...
inline const std::string& MavlinkMessage::message_name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.message_name)
  return _internal_message_name();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void MavlinkMessage::set_message_name(Arg_&& arg,
  ...
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.message_name_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.message_name)
}
inline std::string* MavlinkMessage::mutable_message_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_message_name();
  // @@protoc_insertion_point(field_mutable:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.message_name)
  return _s;
}
...
inline std::string* MavlinkMessage::release_message_name() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.message_name)
  return _impl_.message_name_.Release();
}
inline void MavlinkMessage::set_allocated_message_name(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.message_name)
}
...
inline ::uint32_t MavlinkMessage::system_id() const {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.system_id)
  return _internal_system_id();
}
inline void MavlinkMessage::set_system_id(::uint32_t value) {
  _internal_set_system_id(value);
  // @@protoc_insertion_point(field_set:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.system_id)
}
...
inline ::uint32_t MavlinkMessage::component_id() const {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.component_id)
  return _internal_component_id();
}
inline void MavlinkMessage::set_component_id(::uint32_t value) {
  _internal_set_component_id(value);
  // @@protoc_insertion_point(field_set:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.component_id)
}
...
inline ::uint32_t MavlinkMessage::target_system_id() const {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.target_system_id)
...
inline void MavlinkMessage::set_target_system_id(::uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.target_system_id)
}
...
inline ::uint32_t MavlinkMessage::target_component_id() const {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.target_component_id)
...
inline void MavlinkMessage::set_target_component_id(::uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.target_component_id)
}
...
inline const std::string& MavlinkMessage::fields_json() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.fields_json)
...
inline PROTOBUF_ALWAYS_INLINE void MavlinkMessage::set_fields_json(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.fields_json)
}
inline std::string* MavlinkMessage::mutable_fields_json() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ...
  // @@protoc_insertion_point(field_mutable:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.fields_json)
  return _s;
}
...
inline std::string* MavlinkMessage::release_fields_json() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.fields_json)
...
inline void MavlinkMessage::set_allocated_fields_json(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mavsdk.rpc.mavlink_direct_server.MavlinkMessage.fields_json)
}

// -------------------------------------------------------------------

// MavlinkDirectServerResult

// .mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult.Result result = 1;
inline void MavlinkDirectServerResult::clear_result() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.result_ = 0;
}
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult_Result MavlinkDirectServerResult::result() const {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult.result)
  return _internal_result();
}
inline void MavlinkDirectServerResult::set_result(::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult_Result value) {
  _internal_set_result(value);
  // @@protoc_insertion_point(field_set:mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult.result)
}
inline ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult_Result MavlinkDirectServerResult::_internal_result() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult_Result>(_impl_.result_);
}
inline void MavlinkDirectServerResult::_internal_set_result(::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult_Result value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.result_ = value;
}

// string result_str = 2;
inline void MavlinkDirectServerResult::clear_result_str() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.result_str_.ClearToEmpty();
}
inline const std::string& MavlinkDirectServerResult::result_str() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult.result_str)
  return _internal_result_str();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void MavlinkDirectServerResult::set_result_str(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.result_str_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult.result_str)
}
inline std::string* MavlinkDirectServerResult::mutable_result_str() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_result_str();
  // @@protoc_insertion_point(field_mutable:mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult.result_str)
  return _s;
}
inline const std::string& MavlinkDirectServerResult::_internal_result_str() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.result_str_.Get();
}
inline void MavlinkDirectServerResult::_internal_set_result_str(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.result_str_.Set(value, GetArena());
}
inline std::string* MavlinkDirectServerResult::_internal_mutable_result_str() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.result_str_.Mutable( GetArena());
}
inline std::string* MavlinkDirectServerResult::release_result_str() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult.result_str)
  return _impl_.result_str_.Release();
}
inline void MavlinkDirectServerResult::set_allocated_result_str(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ...
  // @@protoc_insertion_point(field_set_allocated:mavsdk.rpc.mavlink_direct_server.MavlinkDirectServerResult.result_str)
}
...
template <>
struct is_proto_enum<::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult_Result> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult_Result>() {
  return ::mavsdk::rpc::mavlink_direct_server::MavlinkDirectServerResult_Result_descriptor();
}
...
#endif  // mavlink_5fdirect_5fserver_2fmavlink_5fdirect_5fserver_2eproto_2epb_2eh

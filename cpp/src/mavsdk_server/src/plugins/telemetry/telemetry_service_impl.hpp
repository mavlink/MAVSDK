...
public:
    ...
    static rpc::telemetry::BatteryFunction translateToRpcBatteryFunction(const mavsdk::Telemetry::BatteryFunction& battery_function)
    {
    ...
    static mavsdk::Telemetry::BatteryFunction translateFromRpcBatteryFunction(const rpc::telemetry::BatteryFunction battery_function)
    {
        switch (battery_function) {
            default:
                LogErr("Unknown battery_function enum value: {}", static_cast<int>(battery_function));
    ...
    static std::unique_ptr<rpc::telemetry::HomePosition> translateToRpcHomePosition(const mavsdk::Telemetry::HomePosition &home_position)
    {
        ...
        rpc_obj->set_local_north_m(home_position.local_north_m);
            
        
            
        rpc_obj->set_local_east_m(home_position.local_east_m);
            
        
            
        rpc_obj->set_local_down_m(home_position.local_down_m);
        ...
        rpc_obj->set_approach_north_m(home_position.approach_north_m);
            
        
            
        rpc_obj->set_approach_east_m(home_position.approach_east_m);
            
        
            
        rpc_obj->set_approach_down_m(home_position.approach_down_m);
    ...
    static mavsdk::Telemetry::HomePosition translateFromRpcHomePosition(const rpc::telemetry::HomePosition& home_position)
    {
        ...
        obj.local_north_m = home_position.local_north_m();
            
        
            
        obj.local_east_m = home_position.local_east_m();
            
        
            
        obj.local_down_m = home_position.local_down_m();
        ...
        obj.approach_north_m = home_position.approach_north_m();
            
        
            
        obj.approach_east_m = home_position.approach_east_m();
    ...
    static std::unique_ptr<rpc::telemetry::DistanceSensor> translateToRpcDistanceSensor(const mavsdk::Telemetry::DistanceSensor &distance_sensor)
    {
        ...
        rpc_obj->set_allocated_orientation(translateToRpcEulerAngle(distance_sensor.orientation).release());
    ...
    static std::unique_ptr<rpc::telemetry::Wind> translateToRpcWind(const mavsdk::Telemetry::Wind &wind)
    {
    ...
    grpc::Status SubscribeHome(grpc::ServerContext* /* context */, const mavsdk::rpc::telemetry::SubscribeHomeRequest* /* request */, grpc::ServerWriter<rpc::telemetry::HomeResponse>* writer) override
    {
        ...
        const mavsdk::Telemetry::HomeHandle handle = _lazy_plugin.maybe_plugin()->subscribe_home(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::Telemetry::HomePosition home) {
    ...
    grpc::Status SubscribeWind(grpc::ServerContext* /* context */, const mavsdk::rpc::telemetry::SubscribeWindRequest* /* request */, grpc::ServerWriter<rpc::telemetry::WindResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::Telemetry::WindHandle handle = _lazy_plugin.maybe_plugin()->subscribe_wind(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::Telemetry::Wind wind) {

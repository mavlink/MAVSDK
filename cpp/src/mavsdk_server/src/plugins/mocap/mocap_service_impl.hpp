...
public:
    ...
    static std::unique_ptr<rpc::mocap::PositionBody> translateToRpcPositionBody(const mavsdk::Mocap::PositionBody &position_body)
    {
    ...
    static mavsdk::Mocap::PositionBody translateFromRpcPositionBody(const rpc::mocap::PositionBody& position_body)
    {
    ...
    static std::unique_ptr<rpc::mocap::AngleBody> translateToRpcAngleBody(const mavsdk::Mocap::AngleBody &angle_body)
    {
    ...
    static mavsdk::Mocap::AngleBody translateFromRpcAngleBody(const rpc::mocap::AngleBody& angle_body)
    {
    ...
    static std::unique_ptr<rpc::mocap::SpeedBody> translateToRpcSpeedBody(const mavsdk::Mocap::SpeedBody &speed_body)
    {
    ...
    static mavsdk::Mocap::SpeedBody translateFromRpcSpeedBody(const rpc::mocap::SpeedBody& speed_body)
    {
    ...
    static std::unique_ptr<rpc::mocap::SpeedNed> translateToRpcSpeedNed(const mavsdk::Mocap::SpeedNed &speed_ned)
    {
    ...
    static std::unique_ptr<rpc::mocap::AngularVelocityBody> translateToRpcAngularVelocityBody(const mavsdk::Mocap::AngularVelocityBody &angular_velocity_body)
    {
    ...
    static mavsdk::Mocap::AngularVelocityBody translateFromRpcAngularVelocityBody(const rpc::mocap::AngularVelocityBody& angular_velocity_body)
    {
    ...
    static std::unique_ptr<rpc::mocap::Covariance> translateToRpcCovariance(const mavsdk::Mocap::Covariance &covariance)
    {
    ...
    static mavsdk::Mocap::Covariance translateFromRpcCovariance(const rpc::mocap::Covariance& covariance)
    {
    ...
    static std::unique_ptr<rpc::mocap::Quaternion> translateToRpcQuaternion(const mavsdk::Mocap::Quaternion &quaternion)
    {
    ...
    static mavsdk::Mocap::Quaternion translateFromRpcQuaternion(const rpc::mocap::Quaternion& quaternion)
    {
    ...
    static std::unique_ptr<rpc::mocap::VisionPositionEstimate> translateToRpcVisionPositionEstimate(const mavsdk::Mocap::VisionPositionEstimate &vision_position_estimate)
    {
        ...
        rpc_obj->set_allocated_position_body(translateToRpcPositionBody(vision_position_estimate.position_body).release());
                
            
        
            
                
        rpc_obj->set_allocated_angle_body(translateToRpcAngleBody(vision_position_estimate.angle_body).release());
                
            
        
            
                
        rpc_obj->set_allocated_pose_covariance(translateToRpcCovariance(vision_position_estimate.pose_covariance).release());
    ...
    static mavsdk::Mocap::VisionPositionEstimate translateFromRpcVisionPositionEstimate(const rpc::mocap::VisionPositionEstimate& vision_position_estimate)
    {
        ...
        obj.pose_covariance = translateFromRpcCovariance(vision_position_estimate.pose_covariance());
    ...
    static std::unique_ptr<rpc::mocap::VisionSpeedEstimate> translateToRpcVisionSpeedEstimate(const mavsdk::Mocap::VisionSpeedEstimate &vision_speed_estimate)
    {
        ...
        rpc_obj->set_allocated_speed_ned(translateToRpcSpeedNed(vision_speed_estimate.speed_ned).release());
                
            
        
            
                
        rpc_obj->set_allocated_speed_covariance(translateToRpcCovariance(vision_speed_estimate.speed_covariance).release());
    ...
    static mavsdk::Mocap::VisionSpeedEstimate translateFromRpcVisionSpeedEstimate(const rpc::mocap::VisionSpeedEstimate& vision_speed_estimate)
    {
    ...
    static std::unique_ptr<rpc::mocap::AttitudePositionMocap> translateToRpcAttitudePositionMocap(const mavsdk::Mocap::AttitudePositionMocap &attitude_position_mocap)
    {
        ...
        rpc_obj->set_allocated_position_body(translateToRpcPositionBody(attitude_position_mocap.position_body).release());
                
            
        
            
                
        rpc_obj->set_allocated_pose_covariance(translateToRpcCovariance(attitude_position_mocap.pose_covariance).release());
    ...
    static mavsdk::Mocap::AttitudePositionMocap translateFromRpcAttitudePositionMocap(const rpc::mocap::AttitudePositionMocap& attitude_position_mocap)
    {
    ...
    static rpc::mocap::Odometry::MavFrame translateToRpcMavFrame(const mavsdk::Mocap::Odometry::MavFrame& mav_frame)
    {
        switch (mav_frame) {
            default:
    ...
    static mavsdk::Mocap::Odometry::MavFrame translateFromRpcMavFrame(const rpc::mocap::Odometry::MavFrame mav_frame)
    {
        switch (mav_frame) {
            default:
                LogErr("Unknown mav_frame enum value: {}", static_cast<int>(mav_frame));
    ...
    static rpc::mocap::Odometry::MavEstimatorType translateToRpcMavEstimatorType(const mavsdk::Mocap::Odometry::MavEstimatorType& mav_estimator_type)
    {
        switch (mav_estimator_type) {
            default:
                LogErr("Unknown mav_estimator_type enum value: {}", static_cast<int>(mav_estimator_type));
            // FALLTHROUGH
    ...
    static mavsdk::Mocap::Odometry::MavEstimatorType translateFromRpcMavEstimatorType(const rpc::mocap::Odometry::MavEstimatorType mav_estimator_type)
    {
        switch (mav_estimator_type) {
            default:
                LogErr("Unknown mav_estimator_type enum value: {}", static_cast<int>(mav_estimator_type));
    ...
    static std::unique_ptr<rpc::mocap::Odometry> translateToRpcOdometry(const mavsdk::Mocap::Odometry &odometry)
    {
    ...
    static mavsdk::Mocap::Result translateFromRpcResult(const rpc::mocap::MocapResult::Result result)
    {
        switch (result) {
            default:
                LogErr("Unknown result enum value: {}", static_cast<int>(result));
        ...
        rpc::mocap::SetVisionPositionEstimateResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_vision_position_estimate(translateFromRpcVisionPositionEstimate(request->vision_position_estimate()));
        ...
        rpc::mocap::SetVisionSpeedEstimateResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_vision_speed_estimate(translateFromRpcVisionSpeedEstimate(request->vision_speed_estimate()));
        ...
        rpc::mocap::SetAttitudePositionMocapResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_attitude_position_mocap(translateFromRpcAttitudePositionMocap(request->attitude_position_mocap()));
        ...
        rpc::mocap::SetOdometryResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_odometry(translateFromRpcOdometry(request->odometry()));

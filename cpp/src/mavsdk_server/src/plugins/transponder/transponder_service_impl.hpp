...
public:
    ...
    static rpc::transponder::AdsbAltitudeType translateToRpcAdsbAltitudeType(const mavsdk::Transponder::AdsbAltitudeType& adsb_altitude_type)
    {
    ...
    static mavsdk::Transponder::AdsbAltitudeType translateFromRpcAdsbAltitudeType(const rpc::transponder::AdsbAltitudeType adsb_altitude_type)
    {
        switch (adsb_altitude_type) {
            default:
                LogErr("Unknown adsb_altitude_type enum value: {}", static_cast<int>(adsb_altitude_type));
    ...
    grpc::Status SubscribeTransponder(grpc::ServerContext* /* context */, const mavsdk::rpc::transponder::SubscribeTransponderRequest* /* request */, grpc::ServerWriter<rpc::transponder::TransponderResponse>* writer) override
    {
        ...
        const mavsdk::Transponder::TransponderHandle handle = _lazy_plugin.maybe_plugin()->subscribe_transponder(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::Transponder::AdsbVehicle transponder) {

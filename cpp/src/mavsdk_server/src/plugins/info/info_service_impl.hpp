...
public:
    ...
    grpc::Status SubscribeFlightInformation(grpc::ServerContext* /* context */, const mavsdk::rpc::info::SubscribeFlightInformationRequest* /* request */, grpc::ServerWriter<rpc::info::FlightInformationResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::Info::FlightInformationHandle handle = _lazy_plugin.maybe_plugin()->subscribe_flight_information(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::Info::FlightInfo flight_information) {

            rpc::info::FlightInformationResponse rpc_response;
        
            rpc_response.set_allocated_flight_info(translateToRpcFlightInfo(flight_information).release());

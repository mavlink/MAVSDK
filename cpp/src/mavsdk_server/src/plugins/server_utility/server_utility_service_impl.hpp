...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/server_utility/server_utility.proto)
...
public:
    ...
    static rpc::server_utility::StatusTextType translateToRpcStatusTextType(const mavsdk::ServerUtility::StatusTextType& status_text_type)
    {
    ...
    static mavsdk::ServerUtility::StatusTextType translateFromRpcStatusTextType(const rpc::server_utility::StatusTextType status_text_type)
    {
        switch (status_text_type) {
            default:
                LogErr("Unknown status_text_type enum value: {}", static_cast<int>(status_text_type));
    ...
    static rpc::server_utility::ServerUtilityResult::Result translateToRpcResult(const mavsdk::ServerUtility::Result& result)
    {
        switch (result) {
            default:
    ...
    static mavsdk::ServerUtility::Result translateFromRpcResult(const rpc::server_utility::ServerUtilityResult::Result result)
    {
        switch (result) {
            default:
                LogErr("Unknown result enum value: {}", static_cast<int>(result));
        ...
        rpc::server_utility::SendStatusTextResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->send_status_text(translateFromRpcStatusTextType(request->type()), request->text());

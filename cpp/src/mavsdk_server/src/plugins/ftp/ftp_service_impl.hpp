...
public:
    ...
    static mavsdk::Ftp::ListDirectoryData translateFromRpcListDirectoryData(const rpc::ftp::ListDirectoryData& list_directory_data)
    {
    ...
    grpc::Status SubscribeDownload(grpc::ServerContext* /* context */, const mavsdk::rpc::ftp::SubscribeDownloadRequest* request, grpc::ServerWriter<rpc::ftp::DownloadResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin()->download_async(request->remote_file_path(), request->local_dir(), request->use_burst(), 
    ...
    grpc::Status SubscribeUpload(grpc::ServerContext* /* context */, const mavsdk::rpc::ftp::SubscribeUploadRequest* request, grpc::ServerWriter<rpc::ftp::UploadResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin()->upload_async(request->local_file_path(), request->remote_dir(), 
        ...
        rpc::ftp::RenameResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->rename(request->remote_from_path(), request->remote_to_path());
        ...
        rpc::ftp::AreFilesIdenticalResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->are_files_identical(request->local_file_path(), request->remote_file_path());

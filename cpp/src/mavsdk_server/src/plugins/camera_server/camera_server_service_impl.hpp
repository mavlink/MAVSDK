...
template<typename CameraServer = CameraServer, typename LazyServerPlugin = LazyServerPlugin<CameraServer>>
...
public:
    ...
    static rpc::camera_server::CameraFeedback translateToRpcCameraFeedback(const mavsdk::CameraServer::CameraFeedback& camera_feedback)
    {
        switch (camera_feedback) {
            default:
                LogErr("Unknown camera_feedback enum value: {}", static_cast<int>(camera_feedback));
            // FALLTHROUGH
    ...
    static mavsdk::CameraServer::CameraFeedback translateFromRpcCameraFeedback(const rpc::camera_server::CameraFeedback camera_feedback)
    {
        switch (camera_feedback) {
            default:
                LogErr("Unknown camera_feedback enum value: {}", static_cast<int>(camera_feedback));
    ...
    static std::unique_ptr<rpc::camera_server::Information> translateToRpcInformation(const mavsdk::CameraServer::Information &information)
    {
    ...
    static mavsdk::CameraServer::Information translateFromRpcInformation(const rpc::camera_server::Information& information)
    {
    ...
    static std::unique_ptr<rpc::camera_server::VideoStreaming> translateToRpcVideoStreaming(const mavsdk::CameraServer::VideoStreaming &video_streaming)
    {
    ...
    static mavsdk::CameraServer::VideoStreaming translateFromRpcVideoStreaming(const rpc::camera_server::VideoStreaming& video_streaming)
    {
    ...
    static std::unique_ptr<rpc::camera_server::Position> translateToRpcPosition(const mavsdk::CameraServer::Position &position)
    {
    ...
    static mavsdk::CameraServer::Position translateFromRpcPosition(const rpc::camera_server::Position& position)
    {
    ...
    static std::unique_ptr<rpc::camera_server::Quaternion> translateToRpcQuaternion(const mavsdk::CameraServer::Quaternion &quaternion)
    {
    ...
    static mavsdk::CameraServer::Quaternion translateFromRpcQuaternion(const rpc::camera_server::Quaternion& quaternion)
    {
    ...
    static std::unique_ptr<rpc::camera_server::CaptureInfo> translateToRpcCaptureInfo(const mavsdk::CameraServer::CaptureInfo &capture_info)
    {
        ...
        rpc_obj->set_allocated_attitude_quaternion(translateToRpcQuaternion(capture_info.attitude_quaternion).release());
    ...
    static mavsdk::CameraServer::CaptureInfo translateFromRpcCaptureInfo(const rpc::camera_server::CaptureInfo& capture_info)
    {
    ...
    static rpc::camera_server::CameraServerResult::Result translateToRpcResult(const mavsdk::CameraServer::Result& result)
    {
        switch (result) {
            default:
    ...
    static mavsdk::CameraServer::Result translateFromRpcResult(const rpc::camera_server::CameraServerResult::Result result)
    {
        switch (result) {
            default:
                LogErr("Unknown result enum value: {}", static_cast<int>(result));
    ...
    static rpc::camera_server::StorageInformation::StorageStatus translateToRpcStorageStatus(const mavsdk::CameraServer::StorageInformation::StorageStatus& storage_status)
    {
        switch (storage_status) {
            ...
            case mavsdk::CameraServer::StorageInformation::StorageStatus::NotAvailable:
                return rpc::camera_server::StorageInformation_StorageStatus_STORAGE_STATUS_NOT_AVAILABLE;
            case mavsdk::CameraServer::StorageInformation::StorageStatus::Unformatted:
                return rpc::camera_server::StorageInformation_StorageStatus_STORAGE_STATUS_UNFORMATTED;
            case mavsdk::CameraServer::StorageInformation::StorageStatus::Formatted:
                return rpc::camera_server::StorageInformation_StorageStatus_STORAGE_STATUS_FORMATTED;
            case mavsdk::CameraServer::StorageInformation::StorageStatus::NotSupported:
                return rpc::camera_server::StorageInformation_StorageStatus_STORAGE_STATUS_NOT_SUPPORTED;
        }
    }

    static mavsdk::CameraServer::StorageInformation::StorageStatus translateFromRpcStorageStatus(const rpc::camera_server::StorageInformation::StorageStatus storage_status)
    {
        switch (storage_status) {
            default:
                LogErr("Unknown storage_status enum value: {}", static_cast<int>(storage_status));
    ...
    static rpc::camera_server::StorageInformation::StorageType translateToRpcStorageType(const mavsdk::CameraServer::StorageInformation::StorageType& storage_type)
    {
        switch (storage_type) {
            default:
    ...
    static mavsdk::CameraServer::StorageInformation::StorageType translateFromRpcStorageType(const rpc::camera_server::StorageInformation::StorageType storage_type)
    {
        switch (storage_type) {
            default:
                LogErr("Unknown storage_type enum value: {}", static_cast<int>(storage_type));
    ...
    static std::unique_ptr<rpc::camera_server::StorageInformation> translateToRpcStorageInformation(const mavsdk::CameraServer::StorageInformation &storage_information)
    {
        ...
        rpc_obj->set_storage_status(translateToRpcStorageStatus(storage_information.storage_status));
    ...
    static mavsdk::CameraServer::StorageInformation translateFromRpcStorageInformation(const rpc::camera_server::StorageInformation& storage_information)
    {
    ...
    static rpc::camera_server::CaptureStatus::ImageStatus translateToRpcImageStatus(const mavsdk::CameraServer::CaptureStatus::ImageStatus& image_status)
    {
        switch (image_status) {
            default:
            ...
            case mavsdk::CameraServer::CaptureStatus::ImageStatus::CaptureInProgress:
                return rpc::camera_server::CaptureStatus_ImageStatus_IMAGE_STATUS_CAPTURE_IN_PROGRESS;
            ...
            case mavsdk::CameraServer::CaptureStatus::ImageStatus::IntervalInProgress:
                return rpc::camera_server::CaptureStatus_ImageStatus_IMAGE_STATUS_INTERVAL_IN_PROGRESS;
        }
    }

    static mavsdk::CameraServer::CaptureStatus::ImageStatus translateFromRpcImageStatus(const rpc::camera_server::CaptureStatus::ImageStatus image_status)
    {
        switch (image_status) {
            default:
                LogErr("Unknown image_status enum value: {}", static_cast<int>(image_status));
    ...
    static rpc::camera_server::CaptureStatus::VideoStatus translateToRpcVideoStatus(const mavsdk::CameraServer::CaptureStatus::VideoStatus& video_status)
    {
        switch (video_status) {
            default:
            ...
            case mavsdk::CameraServer::CaptureStatus::VideoStatus::CaptureInProgress:
                return rpc::camera_server::CaptureStatus_VideoStatus_VIDEO_STATUS_CAPTURE_IN_PROGRESS;
        }
    }

    static mavsdk::CameraServer::CaptureStatus::VideoStatus translateFromRpcVideoStatus(const rpc::camera_server::CaptureStatus::VideoStatus video_status)
    {
        switch (video_status) {
            default:
                LogErr("Unknown video_status enum value: {}", static_cast<int>(video_status));
    ...
    static std::unique_ptr<rpc::camera_server::CaptureStatus> translateToRpcCaptureStatus(const mavsdk::CameraServer::CaptureStatus &capture_status)
    {
    ...
    static mavsdk::CameraServer::CaptureStatus translateFromRpcCaptureStatus(const rpc::camera_server::CaptureStatus& capture_status)
    {
    ...
    static std::unique_ptr<rpc::camera_server::TrackPoint> translateToRpcTrackPoint(const mavsdk::CameraServer::TrackPoint &track_point)
    {
    ...
    static mavsdk::CameraServer::TrackPoint translateFromRpcTrackPoint(const rpc::camera_server::TrackPoint& track_point)
    {
    ...
    static std::unique_ptr<rpc::camera_server::TrackRectangle> translateToRpcTrackRectangle(const mavsdk::CameraServer::TrackRectangle &track_rectangle)
    {
    ...
    static mavsdk::CameraServer::TrackRectangle translateFromRpcTrackRectangle(const rpc::camera_server::TrackRectangle& track_rectangle)
    {
        ...
        rpc::camera_server::SetInformationResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_information(translateFromRpcInformation(request->information()));
        ...
        rpc::camera_server::SetVideoStreamingResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_video_streaming(translateFromRpcVideoStreaming(request->video_streaming()));
    ...
    grpc::Status SubscribeTakePhoto(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeTakePhotoRequest* /* request */, grpc::ServerWriter<rpc::camera_server::TakePhotoResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::TakePhotoHandle handle = _lazy_plugin.maybe_plugin()->subscribe_take_photo(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const int32_t take_photo) {
        ...
        rpc::camera_server::RespondTakePhotoResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_take_photo(translateFromRpcCameraFeedback(request->take_photo_feedback()), translateFromRpcCaptureInfo(request->capture_info()));
    ...
    grpc::Status SubscribeStartVideo(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeStartVideoRequest* /* request */, grpc::ServerWriter<rpc::camera_server::StartVideoResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::StartVideoHandle handle = _lazy_plugin.maybe_plugin()->subscribe_start_video(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const int32_t start_video) {
        ...
        rpc::camera_server::RespondStartVideoResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_start_video(translateFromRpcCameraFeedback(request->start_video_feedback()));
    ...
    grpc::Status SubscribeStopVideo(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeStopVideoRequest* /* request */, grpc::ServerWriter<rpc::camera_server::StopVideoResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::StopVideoHandle handle = _lazy_plugin.maybe_plugin()->subscribe_stop_video(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const int32_t stop_video) {
        ...
        rpc::camera_server::RespondStopVideoResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_stop_video(translateFromRpcCameraFeedback(request->stop_video_feedback()));
    ...
    grpc::Status SubscribeStartVideoStreaming(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeStartVideoStreamingRequest* /* request */, grpc::ServerWriter<rpc::camera_server::StartVideoStreamingResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::StartVideoStreamingHandle handle = _lazy_plugin.maybe_plugin()->subscribe_start_video_streaming(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const int32_t start_video_streaming) {
        ...
        rpc::camera_server::RespondStartVideoStreamingResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_start_video_streaming(translateFromRpcCameraFeedback(request->start_video_streaming_feedback()));
    ...
    grpc::Status SubscribeStopVideoStreaming(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeStopVideoStreamingRequest* /* request */, grpc::ServerWriter<rpc::camera_server::StopVideoStreamingResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::StopVideoStreamingHandle handle = _lazy_plugin.maybe_plugin()->subscribe_stop_video_streaming(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const int32_t stop_video_streaming) {
        ...
        rpc::camera_server::RespondStopVideoStreamingResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_stop_video_streaming(translateFromRpcCameraFeedback(request->stop_video_streaming_feedback()));
    ...
    grpc::Status SubscribeSetMode(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeSetModeRequest* /* request */, grpc::ServerWriter<rpc::camera_server::SetModeResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::SetModeHandle handle = _lazy_plugin.maybe_plugin()->subscribe_set_mode(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::CameraServer::Mode set_mode) {
    ...
    grpc::Status SubscribeStorageInformation(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeStorageInformationRequest* /* request */, grpc::ServerWriter<rpc::camera_server::StorageInformationResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::StorageInformationHandle handle = _lazy_plugin.maybe_plugin()->subscribe_storage_information(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const int32_t storage_information) {
        ...
        rpc::camera_server::RespondStorageInformationResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_storage_information(translateFromRpcCameraFeedback(request->storage_information_feedback()), translateFromRpcStorageInformation(request->storage_information()));
    ...
    grpc::Status SubscribeCaptureStatus(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeCaptureStatusRequest* /* request */, grpc::ServerWriter<rpc::camera_server::CaptureStatusResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::CaptureStatusHandle handle = _lazy_plugin.maybe_plugin()->subscribe_capture_status(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const int32_t capture_status) {
        ...
        rpc::camera_server::RespondCaptureStatusResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_capture_status(translateFromRpcCameraFeedback(request->capture_status_feedback()), translateFromRpcCaptureStatus(request->capture_status()));
    ...
    grpc::Status SubscribeFormatStorage(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeFormatStorageRequest* /* request */, grpc::ServerWriter<rpc::camera_server::FormatStorageResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::FormatStorageHandle handle = _lazy_plugin.maybe_plugin()->subscribe_format_storage(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const int32_t format_storage) {
        ...
        rpc::camera_server::RespondFormatStorageResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_format_storage(translateFromRpcCameraFeedback(request->format_storage_feedback()));
    ...
    grpc::Status SubscribeResetSettings(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeResetSettingsRequest* /* request */, grpc::ServerWriter<rpc::camera_server::ResetSettingsResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::ResetSettingsHandle handle = _lazy_plugin.maybe_plugin()->subscribe_reset_settings(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const int32_t reset_settings) {
        ...
        rpc::camera_server::RespondResetSettingsResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_reset_settings(translateFromRpcCameraFeedback(request->reset_settings_feedback()));
    ...
    grpc::Status SubscribeZoomInStart(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeZoomInStartRequest* /* request */, grpc::ServerWriter<rpc::camera_server::ZoomInStartResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::ZoomInStartHandle handle = _lazy_plugin.maybe_plugin()->subscribe_zoom_in_start(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const int32_t zoom_in_start) {
        ...
        rpc::camera_server::RespondZoomInStartResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_zoom_in_start(translateFromRpcCameraFeedback(request->zoom_in_start_feedback()));
    ...
    grpc::Status SubscribeZoomOutStart(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeZoomOutStartRequest* /* request */, grpc::ServerWriter<rpc::camera_server::ZoomOutStartResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::ZoomOutStartHandle handle = _lazy_plugin.maybe_plugin()->subscribe_zoom_out_start(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const int32_t zoom_out_start) {
        ...
        rpc::camera_server::RespondZoomOutStartResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_zoom_out_start(translateFromRpcCameraFeedback(request->zoom_out_start_feedback()));
    ...
    grpc::Status SubscribeZoomStop(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeZoomStopRequest* /* request */, grpc::ServerWriter<rpc::camera_server::ZoomStopResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::ZoomStopHandle handle = _lazy_plugin.maybe_plugin()->subscribe_zoom_stop(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const int32_t zoom_stop) {
        ...
        rpc::camera_server::RespondZoomStopResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_zoom_stop(translateFromRpcCameraFeedback(request->zoom_stop_feedback()));
    ...
    grpc::Status SubscribeZoomRange(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeZoomRangeRequest* /* request */, grpc::ServerWriter<rpc::camera_server::ZoomRangeResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::ZoomRangeHandle handle = _lazy_plugin.maybe_plugin()->subscribe_zoom_range(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const float zoom_range) {
        ...
        rpc::camera_server::RespondZoomRangeResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_zoom_range(translateFromRpcCameraFeedback(request->zoom_range_feedback()));
        ...
        rpc::camera_server::SetTrackingRectangleStatusResponse* /* response */) override
    {
        ...
        _lazy_plugin.maybe_plugin()->set_tracking_rectangle_status(translateFromRpcTrackRectangle(request->tracked_rectangle()));
    ...
    grpc::Status SubscribeTrackingPointCommand(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeTrackingPointCommandRequest* /* request */, grpc::ServerWriter<rpc::camera_server::TrackingPointCommandResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::TrackingPointCommandHandle handle = _lazy_plugin.maybe_plugin()->subscribe_tracking_point_command(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::CameraServer::TrackPoint tracking_point_command) {

            rpc::camera_server::TrackingPointCommandResponse rpc_response;
        
            rpc_response.set_allocated_track_point(translateToRpcTrackPoint(tracking_point_command).release());
    ...
    grpc::Status SubscribeTrackingRectangleCommand(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeTrackingRectangleCommandRequest* /* request */, grpc::ServerWriter<rpc::camera_server::TrackingRectangleCommandResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::TrackingRectangleCommandHandle handle = _lazy_plugin.maybe_plugin()->subscribe_tracking_rectangle_command(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::CameraServer::TrackRectangle tracking_rectangle_command) {

            rpc::camera_server::TrackingRectangleCommandResponse rpc_response;
        
            rpc_response.set_allocated_track_rectangle(translateToRpcTrackRectangle(tracking_rectangle_command).release());
    ...
    grpc::Status SubscribeTrackingOffCommand(grpc::ServerContext* /* context */, const mavsdk::rpc::camera_server::SubscribeTrackingOffCommandRequest* /* request */, grpc::ServerWriter<rpc::camera_server::TrackingOffCommandResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::CameraServer::TrackingOffCommandHandle handle = _lazy_plugin.maybe_plugin()->subscribe_tracking_off_command(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const int32_t tracking_off_command) {
        ...
        rpc::camera_server::RespondTrackingPointCommandResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_tracking_point_command(translateFromRpcCameraFeedback(request->stop_video_feedback()));
        ...
        rpc::camera_server::RespondTrackingRectangleCommandResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_tracking_rectangle_command(translateFromRpcCameraFeedback(request->stop_video_feedback()));
        ...
        rpc::camera_server::RespondTrackingOffCommandResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_tracking_off_command(translateFromRpcCameraFeedback(request->stop_video_feedback()));

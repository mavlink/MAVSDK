...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/manual_control/manual_control.proto)
...
public:
    ...
    static rpc::manual_control::ManualControlResult::Result translateToRpcResult(const mavsdk::ManualControl::Result& result)
    {
        switch (result) {
            default:
    ...
    static mavsdk::ManualControl::Result translateFromRpcResult(const rpc::manual_control::ManualControlResult::Result result)
    {
        switch (result) {
            default:
                LogErr("Unknown result enum value: {}", static_cast<int>(result));
        ...
        rpc::manual_control::SetManualControlInputResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_manual_control_input(request->x(), request->y(), request->z(), request->r());

...
public:
    ...
    static rpc::mission::MissionItem::VehicleAction translateToRpcVehicleAction(const mavsdk::Mission::MissionItem::VehicleAction& vehicle_action)
    {
    ...
    static mavsdk::Mission::MissionItem::VehicleAction translateFromRpcVehicleAction(const rpc::mission::MissionItem::VehicleAction vehicle_action)
    {
        switch (vehicle_action) {
            default:
                LogErr("Unknown vehicle_action enum value: {}", static_cast<int>(vehicle_action));
    ...
    grpc::Status SubscribeMissionProgress(grpc::ServerContext* /* context */, const mavsdk::rpc::mission::SubscribeMissionProgressRequest* /* request */, grpc::ServerWriter<rpc::mission::MissionProgressResponse>* writer) override
    {
        ...
        const mavsdk::Mission::MissionProgressHandle handle = _lazy_plugin.maybe_plugin()->subscribe_mission_progress(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::Mission::MissionProgress mission_progress) {

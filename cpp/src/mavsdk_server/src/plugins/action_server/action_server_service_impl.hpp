...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/action_server/action_server.proto)
...
template<typename ActionServer = ActionServer, typename LazyServerPlugin = LazyServerPlugin<ActionServer>>
...
public:
    ...
    static rpc::action_server::FlightMode translateToRpcFlightMode(const mavsdk::ActionServer::FlightMode& flight_mode)
    {
        switch (flight_mode) {
            default:
    ...
    static mavsdk::ActionServer::FlightMode translateFromRpcFlightMode(const rpc::action_server::FlightMode flight_mode)
    {
        switch (flight_mode) {
            default:
                LogErr("Unknown flight_mode enum value: {}", static_cast<int>(flight_mode));
    ...
    static std::unique_ptr<rpc::action_server::AllowableFlightModes> translateToRpcAllowableFlightModes(const mavsdk::ActionServer::AllowableFlightModes &allowable_flight_modes)
    {
    ...
    static mavsdk::ActionServer::AllowableFlightModes translateFromRpcAllowableFlightModes(const rpc::action_server::AllowableFlightModes& allowable_flight_modes)
    {
    ...
    static std::unique_ptr<rpc::action_server::ArmDisarm> translateToRpcArmDisarm(const mavsdk::ActionServer::ArmDisarm &arm_disarm)
    {
    ...
    static mavsdk::ActionServer::ArmDisarm translateFromRpcArmDisarm(const rpc::action_server::ArmDisarm& arm_disarm)
    {
    ...
    static rpc::action_server::ActionServerResult::Result translateToRpcResult(const mavsdk::ActionServer::Result& result)
    {
        switch (result) {
            default:
            ...
            case mavsdk::ActionServer::Result::CommandDeniedLandedStateUnknown:
                return rpc::action_server::ActionServerResult_Result_RESULT_COMMAND_DENIED_LANDED_STATE_UNKNOWN;
            case mavsdk::ActionServer::Result::CommandDeniedNotLanded:
                return rpc::action_server::ActionServerResult_Result_RESULT_COMMAND_DENIED_NOT_LANDED;
            ...
            case mavsdk::ActionServer::Result::VtolTransitionSupportUnknown:
                return rpc::action_server::ActionServerResult_Result_RESULT_VTOL_TRANSITION_SUPPORT_UNKNOWN;
            case mavsdk::ActionServer::Result::NoVtolTransitionSupport:
                return rpc::action_server::ActionServerResult_Result_RESULT_NO_VTOL_TRANSITION_SUPPORT;
    ...
    static mavsdk::ActionServer::Result translateFromRpcResult(const rpc::action_server::ActionServerResult::Result result)
    {
        switch (result) {
            default:
                LogErr("Unknown result enum value: {}", static_cast<int>(result));
            ...
            case rpc::action_server::ActionServerResult_Result_RESULT_COMMAND_DENIED_LANDED_STATE_UNKNOWN:
            ...
            case rpc::action_server::ActionServerResult_Result_RESULT_VTOL_TRANSITION_SUPPORT_UNKNOWN:
    ...
    grpc::Status SubscribeArmDisarm(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeArmDisarmRequest* /* request */, grpc::ServerWriter<rpc::action_server::ArmDisarmResponse>* writer) override
    {
        ...
        const mavsdk::ActionServer::ArmDisarmHandle handle = _lazy_plugin.maybe_plugin()->subscribe_arm_disarm(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](mavsdk::ActionServer::Result result,const mavsdk::ActionServer::ArmDisarm arm_disarm) {
    ...
    grpc::Status SubscribeFlightModeChange(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeFlightModeChangeRequest* /* request */, grpc::ServerWriter<rpc::action_server::FlightModeChangeResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::ActionServer::FlightModeChangeHandle handle = _lazy_plugin.maybe_plugin()->subscribe_flight_mode_change(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](mavsdk::ActionServer::Result result,const mavsdk::ActionServer::FlightMode flight_mode_change) {
    ...
    grpc::Status SubscribeTakeoff(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeTakeoffRequest* /* request */, grpc::ServerWriter<rpc::action_server::TakeoffResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::ActionServer::TakeoffHandle handle = _lazy_plugin.maybe_plugin()->subscribe_takeoff(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](mavsdk::ActionServer::Result result,const bool takeoff) {
    ...
    grpc::Status SubscribeLand(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeLandRequest* /* request */, grpc::ServerWriter<rpc::action_server::LandResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::ActionServer::LandHandle handle = _lazy_plugin.maybe_plugin()->subscribe_land(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](mavsdk::ActionServer::Result result,const bool land) {
    ...
    grpc::Status SubscribeReboot(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeRebootRequest* /* request */, grpc::ServerWriter<rpc::action_server::RebootResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::ActionServer::RebootHandle handle = _lazy_plugin.maybe_plugin()->subscribe_reboot(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](mavsdk::ActionServer::Result result,const bool reboot) {
    ...
    grpc::Status SubscribeShutdown(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeShutdownRequest* /* request */, grpc::ServerWriter<rpc::action_server::ShutdownResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::ActionServer::ShutdownHandle handle = _lazy_plugin.maybe_plugin()->subscribe_shutdown(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](mavsdk::ActionServer::Result result,const bool shutdown) {
    ...
    grpc::Status SubscribeTerminate(grpc::ServerContext* /* context */, const mavsdk::rpc::action_server::SubscribeTerminateRequest* /* request */, grpc::ServerWriter<rpc::action_server::TerminateResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::ActionServer::TerminateHandle handle = _lazy_plugin.maybe_plugin()->subscribe_terminate(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](mavsdk::ActionServer::Result result,const bool terminate) {
        ...
        rpc::action_server::SetArmableResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_armable(request->armable(), request->force_armable());
        ...
        rpc::action_server::SetDisarmableResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_disarmable(request->disarmable(), request->force_disarmable());
        ...
        rpc::action_server::SetAllowableFlightModesResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_allowable_flight_modes(translateFromRpcAllowableFlightModes(request->flight_modes()));
        ...
        rpc::action_server::GetAllowableFlightModesResponse* response) override
    {
        ...
        if (response != nullptr) {
            ...
            response->set_allocated_flight_modes(translateToRpcAllowableFlightModes(result ).release());
             }
        ...
        rpc::action_server::SetFlightModeResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_flight_mode(translateFromRpcFlightMode(request->flight_mode()));
        ...
        rpc::action_server::SetFlightModeInternalResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_flight_mode_internal(translateFromRpcFlightMode(request->flight_mode()));

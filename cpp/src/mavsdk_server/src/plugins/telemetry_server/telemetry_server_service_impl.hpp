...
public:
        ...
        rpc::telemetry_server::PublishDistanceSensorResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_distance_sensor(translateFromRpcDistanceSensor(request->distance_sensor()));
        ...
        rpc::telemetry_server::PublishAttitudeResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_attitude(translateFromRpcEulerAngle(request->angle()), translateFromRpcAngularVelocityBody(request->angular_velocity()));
        ...
        rpc::telemetry_server::PublishVisualFlightRulesHudResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->publish_visual_flight_rules_hud(translateFromRpcFixedwingMetrics(request->fixed_wing_metrics()));

...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/mavlink_direct/mavlink_direct.proto)
...
public:
    ...
    static std::unique_ptr<rpc::mavlink_direct::MavlinkMessage> translateToRpcMavlinkMessage(const mavsdk::MavlinkDirect::MavlinkMessage &mavlink_message)
    {
    ...
    static mavsdk::MavlinkDirect::MavlinkMessage translateFromRpcMavlinkMessage(const rpc::mavlink_direct::MavlinkMessage& mavlink_message)
    {
    ...
    static rpc::mavlink_direct::MavlinkDirectResult::Result translateToRpcResult(const mavsdk::MavlinkDirect::Result& result)
    {
        switch (result) {
            default:
    ...
    static mavsdk::MavlinkDirect::Result translateFromRpcResult(const rpc::mavlink_direct::MavlinkDirectResult::Result result)
    {
        switch (result) {
            default:
                LogErr("Unknown result enum value: {}", static_cast<int>(result));
    ...
    grpc::Status SubscribeMessage(grpc::ServerContext* /* context */, const mavsdk::rpc::mavlink_direct::SubscribeMessageRequest* request, grpc::ServerWriter<rpc::mavlink_direct::MessageResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::MavlinkDirect::MessageHandle handle = _lazy_plugin.maybe_plugin()->subscribe_message(request->message_name(), 
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::MavlinkDirect::MavlinkMessage message) {

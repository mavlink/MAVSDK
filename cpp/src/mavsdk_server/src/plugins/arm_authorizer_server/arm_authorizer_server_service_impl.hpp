...
template<typename ArmAuthorizerServer = ArmAuthorizerServer, typename LazyServerPlugin = LazyServerPlugin<ArmAuthorizerServer>>

class ArmAuthorizerServerServiceImpl final : public rpc::arm_authorizer_server::ArmAuthorizerServerService::Service {
public:
    ...
    void fillResponseWithResult(ResponseType* response, mavsdk::ArmAuthorizerServer::Result& result) const
    {
        auto rpc_result = translateToRpcResult(result);

        auto* rpc_arm_authorizer_server_result = new rpc::arm_authorizer_server::ArmAuthorizerServerResult();
    ...
    static rpc::arm_authorizer_server::RejectionReason translateToRpcRejectionReason(const mavsdk::ArmAuthorizerServer::RejectionReason& rejection_reason)
    {
    ...
    static mavsdk::ArmAuthorizerServer::RejectionReason translateFromRpcRejectionReason(const rpc::arm_authorizer_server::RejectionReason rejection_reason)
    {
        switch (rejection_reason) {
            default:
                LogErr("Unknown rejection_reason enum value: {}", static_cast<int>(rejection_reason));
    ...
    static rpc::arm_authorizer_server::ArmAuthorizerServerResult::Result translateToRpcResult(const mavsdk::ArmAuthorizerServer::Result& result)
    {
        switch (result) {
            default:
    ...
    static mavsdk::ArmAuthorizerServer::Result translateFromRpcResult(const rpc::arm_authorizer_server::ArmAuthorizerServerResult::Result result)
    {
        switch (result) {
            default:
                LogErr("Unknown result enum value: {}", static_cast<int>(result));
    ...
    grpc::Status SubscribeArmAuthorization(grpc::ServerContext* /* context */, const mavsdk::rpc::arm_authorizer_server::SubscribeArmAuthorizationRequest* /* request */, grpc::ServerWriter<rpc::arm_authorizer_server::ArmAuthorizationResponse>* writer) override
    {
        ...
        const mavsdk::ArmAuthorizerServer::ArmAuthorizationHandle handle = _lazy_plugin.maybe_plugin()->subscribe_arm_authorization(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const uint32_t arm_authorization) {
        ...
        rpc::arm_authorizer_server::AcceptArmAuthorizationResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->accept_arm_authorization(request->valid_time_s());
        ...
        rpc::arm_authorizer_server::RejectArmAuthorizationResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->reject_arm_authorization(request->temporarily(), translateFromRpcRejectionReason(request->reason()), request->extra_info());

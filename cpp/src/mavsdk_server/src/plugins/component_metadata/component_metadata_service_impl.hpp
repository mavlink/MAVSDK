...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/component_metadata/component_metadata.proto)
...
template<typename ComponentMetadata = ComponentMetadata, typename LazyPlugin = LazyPlugin<ComponentMetadata>>

class ComponentMetadataServiceImpl final : public rpc::component_metadata::ComponentMetadataService::Service {
public:
    ...
    void fillResponseWithResult(ResponseType* response, mavsdk::ComponentMetadata::Result& result) const
    {
        auto rpc_result = translateToRpcResult(result);

        auto* rpc_component_metadata_result = new rpc::component_metadata::ComponentMetadataResult();
    ...
    static rpc::component_metadata::MetadataType translateToRpcMetadataType(const mavsdk::ComponentMetadata::MetadataType& metadata_type)
    {
    ...
    static mavsdk::ComponentMetadata::MetadataType translateFromRpcMetadataType(const rpc::component_metadata::MetadataType metadata_type)
    {
        switch (metadata_type) {
            default:
                LogErr("Unknown metadata_type enum value: {}", static_cast<int>(metadata_type));
    ...
    static std::unique_ptr<rpc::component_metadata::MetadataData> translateToRpcMetadataData(const mavsdk::ComponentMetadata::MetadataData &metadata_data)
    {
    ...
    static mavsdk::ComponentMetadata::MetadataData translateFromRpcMetadataData(const rpc::component_metadata::MetadataData& metadata_data)
    {
    ...
    static rpc::component_metadata::ComponentMetadataResult::Result translateToRpcResult(const mavsdk::ComponentMetadata::Result& result)
    {
        switch (result) {
            default:
            ...
            case mavsdk::ComponentMetadata::Result::ConnectionError:
                return rpc::component_metadata::ComponentMetadataResult_Result_RESULT_CONNECTION_ERROR;
    ...
    static mavsdk::ComponentMetadata::Result translateFromRpcResult(const rpc::component_metadata::ComponentMetadataResult::Result result)
    {
        switch (result) {
            default:
                LogErr("Unknown result enum value: {}", static_cast<int>(result));
    ...
    static std::unique_ptr<rpc::component_metadata::MetadataUpdate> translateToRpcMetadataUpdate(const mavsdk::ComponentMetadata::MetadataUpdate &metadata_update)
    {
    ...
    static mavsdk::ComponentMetadata::MetadataUpdate translateFromRpcMetadataUpdate(const rpc::component_metadata::MetadataUpdate& metadata_update)
    {
    ...
    grpc::Status SubscribeMetadataAvailable(grpc::ServerContext* /* context */, const mavsdk::rpc::component_metadata::SubscribeMetadataAvailableRequest* /* request */, grpc::ServerWriter<rpc::component_metadata::MetadataAvailableResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        const mavsdk::ComponentMetadata::MetadataAvailableHandle handle = _lazy_plugin.maybe_plugin()->subscribe_metadata_available(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex, &handle](const mavsdk::ComponentMetadata::MetadataUpdate metadata_available) {

            rpc::component_metadata::MetadataAvailableResponse rpc_response;
        
            rpc_response.set_allocated_data(translateToRpcMetadataUpdate(metadata_available).release());
        ...
        rpc::component_metadata::GetMetadataResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->get_metadata(request->compid(), translateFromRpcMetadataType(request->metadata_type()));

...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/component_metadata_server/component_metadata_server.proto)
...
template<typename ComponentMetadataServer = ComponentMetadataServer, typename LazyServerPlugin = LazyServerPlugin<ComponentMetadataServer>>

class ComponentMetadataServerServiceImpl final : public rpc::component_metadata_server::ComponentMetadataServerService::Service {
public:
    ...
    static rpc::component_metadata_server::MetadataType translateToRpcMetadataType(const mavsdk::ComponentMetadataServer::MetadataType& metadata_type)
    {
    ...
    static mavsdk::ComponentMetadataServer::MetadataType translateFromRpcMetadataType(const rpc::component_metadata_server::MetadataType metadata_type)
    {
        switch (metadata_type) {
            default:
                LogErr("Unknown metadata_type enum value: {}", static_cast<int>(metadata_type));
    ...
    static std::unique_ptr<rpc::component_metadata_server::Metadata> translateToRpcMetadata(const mavsdk::ComponentMetadataServer::Metadata &metadata)
    {
    ...
    static mavsdk::ComponentMetadataServer::Metadata translateFromRpcMetadata(const rpc::component_metadata_server::Metadata& metadata)
    {
